 ...
 */
#define xdc_target__isaCompatible_sparc  1

/*
 *  ======== xdc_target__isa_sparc ========
 *  This macro identifies the specific target ISA for which we are being
 *  compiled.
 */
#define xdc_target__isa_sparc  1
...
#define  xdc_target__sizeof_LDouble 16
