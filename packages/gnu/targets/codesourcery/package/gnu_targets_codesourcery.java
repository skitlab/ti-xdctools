...
public class gnu_targets_codesourcery
{
    ...
    void GCArmv5T$$OBJECTS()
    {
        ...
        om.bind("gnu.targets.codesourcery.GCArmv5T.Command", om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.codesourcery"));
        om.bind("gnu.targets.codesourcery.GCArmv5T.Options", om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"));
    }
    ...
    void GCArmv6$$OBJECTS()
    {
        ...
        om.bind("gnu.targets.codesourcery.GCArmv6.Command", om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.codesourcery"));
        om.bind("gnu.targets.codesourcery.GCArmv6.Options", om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"));
    }
    ...
    void GCArmv5T$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "gnu/targets/codesourcery/GCArmv5T.xs");
        om.bind("gnu.targets.codesourcery.GCArmv5T$$capsule", cap);
        ...
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"), Global.newObject("prefix", "-fPIC -Wunused", "suffix", "-Dfar= "), "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"), Global.newObject("prefix", "", "suffix", "-lstdc++ -L$(rootDir)/$(GCCTARG)/lib"), "wh");
        ...
        if (fxn != null) om.bind("gnu.targets.codesourcery.GCArmv5T$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("gnu.targets.codesourcery.GCArmv5T$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("gnu.targets.codesourcery.GCArmv5T$$module$validate", true);
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("genConstCustom", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genConstCustom", "gnu.targets.codesourcery"), fxn);
                fxn = Global.get(cap, "genVisibleData");
                if (fxn != null) po.addFxn("genVisibleData", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genVisibleData", "gnu.targets.codesourcery"), fxn);
                fxn = Global.get(cap, "genVisibleFxns");
                if (fxn != null) po.addFxn("genVisibleFxns", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genVisibleFxns", "gnu.targets.codesourcery"), fxn);
                fxn = Global.get(cap, "genVisibleLibFxns");
                if (fxn != null) po.addFxn("genVisibleLibFxns", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genVisibleLibFxns", "gnu.targets.codesourcery"), fxn);
    }
    ...
    void GCArmv6$$TYPES()
    {
        ...
        po.addFld("CYGWIN", $$T_Bool, true, "rh");
        po.addFld("stdInclude", $$T_Str, "gnu/targets/codesourcery/std.h", "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.codesourcery"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-march=armv6"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.codesourcery"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -x assembler", "opts", "-march=armv6"), "rh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"), Global.newObject("prefix", "-fPIC -Wunused", "suffix", "-Dfar= "), "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"), Global.newObject("prefix", "", "suffix", "-lstdc++ -L$(rootDir)/$(GCCTARG)/lib"), "wh");
    ...
    void GCArmv5T$$SINGLETONS()
    {
        ...
        vo.bind("$capsule", om.findStrict("gnu.targets.codesourcery.GCArmv5T$$capsule", "gnu.targets.codesourcery"));
        ...
        vo.bind("Command", om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.codesourcery"));
        tdefs.add(om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.codesourcery"));
        vo.bind("Options", om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"));
        tdefs.add(om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.codesourcery"));
