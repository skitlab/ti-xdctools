...
public class gnu_targets
{
    ...
    void Sparc$$OBJECTS()
    {
        ...
        om.bind("gnu.targets.Sparc.Command", om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"));
        om.bind("gnu.targets.Sparc.Options", om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"));
    }
    ...
    void MVArm9$$OBJECTS()
    {
        ...
        om.bind("gnu.targets.MVArm9.Command", om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"));
        om.bind("gnu.targets.MVArm9.Options", om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"));
    }
    ...
    void UCArm9$$OBJECTS()
    {
        ...
        om.bind("gnu.targets.UCArm9.Command", om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"));
        om.bind("gnu.targets.UCArm9.Options", om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"));
    }
    ...
    void ITarget$$TYPES()
    {
        ...
        po.init("gnu.targets.ITarget.Module", om.findStrict("xdc.bld.ITarget2.Module", "gnu.targets"));
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"), Global.newObject("cmd", "$(rootDir)/$(GCCTARG)/bin/ar", "opts", "cr"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME)", "opts", ""), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", ""), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -x assembler", "opts", ""), "rh");
    ...
    void Sparc$$TYPES()
    {
        ...
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"), Global.newObject("cmd", "$(rootDir)/bin/gcc -c -MD -MF $@.dep", "opts", "-B$(rootDir)/lib/gcc/$(GCCTARG)/$(GCCVERS)/ -B$(rootDir)/lib/gcc-lib/$(GCCTARG)/$(GCCVERS)/"), "rh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"), Global.newObject("prefix", "-fPIC -m32 -Wunused", "suffix", "-Dfar="), "wh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets"), Global.newObject("cmd", "$(rootDir)/bin/gcc -c -x assembler", "opts", "-B$(rootDir)/lib/gcc/$(GCCTARG)/$(GCCVERS)/ -B$(rootDir)/lib/gcc-lib/$(GCCTARG)/$(GCCVERS)/"), "rh");
        ...
        po.addFld("stdTypes", (Proto)om.findStrict("xdc.bld.ITarget.StdTypes", "gnu.targets"), Global.newObject("t_IArg", Global.newObject("size", 4L, "align", 4L), "t_Char", Global.newObject("size", 1L, "align", 1L), "t_Double", Global.newObject("size", 8L, "align", 8L), "t_Float", Global.newObject("size", 4L, "align", 4L), "t_Fxn", Global.newObject("size", 4L, "align", 4L), "t_Int", Global.newObject("size", 4L, "align", 4L), "t_Int8", Global.newObject("size", 1L, "align", 1L), "t_Int16", Global.newObject("size", 2L, "align", 2L), "t_Int32", Global.newObject("size", 4L, "align", 4L), "t_Int64", Global.newObject("size", 8L, "align", 8L), "t_Long", Global.newObject("size", 4L, "align", 4L), "t_LDouble", Global.newObject("size", 16L, "align", 8L), "t_LLong", Global.newObject("size", 8L, "align", 8L), "t_Ptr", Global.newObject("size", 4L, "align", 4L), "t_Short", Global.newObject("size", 2L, "align", 2L), "t_Size", Global.newObject("size", 4L, "align", 4L)), "rh");
    ...
    void MVArm9$$TYPES()
    {
        ...
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"), Global.newObject("prefix", "-fPIC -Wunused", "suffix", "-Dfar= "), "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"), Global.newObject("prefix", "", "suffix", "-Wl,-Map=$(XDCCFGDIR)/$@.map -lstdc++ -L$(rootDir)/$(GCCTARG)/lib"), "wh");
    ...
    void UCArm9$$TYPES()
    {
        ...
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"), Global.newObject("prefix", "-Wunused", "suffix", "-Dfar= "), "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets"), Global.newObject("prefix", "-static", "suffix", "-Wl,-Map=$(XDCCFGDIR)/$@.map -L$(rootDir)/lib"), "wh");
        po.addFld("versionMap", new Proto.Map($$T_Str), Global.newArray(new Object[]{Global.newArray(new Object[]{"gcc3.2", "1,0,3.2,0"})}), "wh");
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "gnu.targets")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-g", "defs", "-D_DEBUG_=1"), "linkOpts", "-g")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-O2 -ffunction-sections -fdata-sections"), "linkOpts", "-Wl,--gc-sections")})}), "wh");
        po.addFld("stdTypes", (Proto)om.findStrict("xdc.bld.ITarget.StdTypes", "gnu.targets"), Global.newObject("t_IArg", Global.newObject("size", 4L, "align", 4L), "t_Char", Global.newObject("size", 1L, "align", 1L), "t_Double", Global.newObject("size", 8L, "align", 4L), "t_Float", Global.newObject("size", 4L, "align", 4L), "t_Fxn", Global.newObject("size", 4L, "align", 4L), "t_Int", Global.newObject("size", 4L, "align", 4L), "t_Int8", Global.newObject("size", 1L, "align", 1L), "t_Int16", Global.newObject("size", 2L, "align", 2L), "t_Int32", Global.newObject("size", 4L, "align", 4L), "t_Int64", Global.newObject("size", 8L, "align", 4L), "t_Long", Global.newObject("size", 4L, "align", 4L), "t_LDouble", Global.newObject("size", 8L, "align", 4L), "t_LLong", Global.newObject("size", 8L, "align", 4L), "t_Ptr", Global.newObject("size", 4L, "align", 4L), "t_Short", Global.newObject("size", 2L, "align", 2L), "t_Size", Global.newObject("size", 4L, "align", 4L)), "rh");
        fxn = Global.get(cap, "module$use");
