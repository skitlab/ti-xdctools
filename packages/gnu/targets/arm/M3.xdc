 ...
 *
 */
metaonly module M3 inherits gnu.targets.ITarget {
    ...
    override config string platform     = "ti.platforms.stellaris:LM3S9B90";
    ...
    override readonly config ITarget2.Command cc = {
        ...
        opts: "-mcpu=cortex-m3 -mthumb -mabi=aapcs -mapcs "
    };
