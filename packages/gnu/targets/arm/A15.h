 ...
 */
#define xdc_target__isaCompatible_v7A  1
#define xdc_target__isaCompatible_v7A15  1

/*
 *  ======== xdc_target__isa_v7A15 ========
 *  This macro identifies the specific target ISA for which we are being
 *  compiled.
 */
#define xdc_target__isa_v7A15  1
