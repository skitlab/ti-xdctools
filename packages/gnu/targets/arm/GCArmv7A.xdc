 ...
 *
 */
metaonly module GCArmv7A inherits gnu.targets.ITarget {
    override readonly config string name                = "GCArmv7A";   
    override readonly config string os                  = "Linux";      
    override readonly config string suffix              = "v7A";
     ...
     *  ======== compatibleSuffixes ========
     */
    override config String compatibleSuffixes[] = ["v6", "v5T", "470MV", "v5t"];
