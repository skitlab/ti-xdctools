...
/*!
 *  ======== A9.xdc ========
 *  Embedded Cortex A9, little endian, bare metal target
 *
 *  This module defines an embedded bare metal target on Cortex A9. The target
 *  generates code compatible with the "v7A" architecture.
 *
 */
metaonly module A9 inherits gnu.targets.ITarget {
    override readonly config string name                = "A9"; 
    override readonly config string suffix              = "a9g";
    override readonly config string isa                 = "v7A9";
    ...
    override readonly config ITarget2.Command cc = {
        ...
        opts: "-mcpu=cortex-a9 -mfpu=neon -mfloat-abi=softfp"
    };
