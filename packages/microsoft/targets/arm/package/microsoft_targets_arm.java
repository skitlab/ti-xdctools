...
public class microsoft_targets_arm
{
    ...
    void WinCE$$OBJECTS()
    {
        ...
        om.bind("microsoft.targets.arm.WinCE.Command", om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"));
        om.bind("microsoft.targets.arm.WinCE.Options", om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets.arm"));
    ...
    void WinCE$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"), Global.newObject("cmd", "$(rootDir)/sdk/bin/i386/arm/link.exe -lib -nologo", "opts", "-ignore:4001"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"), Global.newObject("cmd", "$(rootDir)/sdk/bin/i386/arm/cl.exe -nologo -c", "opts", "-Gy -GF -D_CRT_SECURE_NO_DEPRECATE -D_USE_32BIT_TIME_T -DUNICODE  -D_UNICODE -DUNDER_CE=600 -D_WIN32_WCE=0x600 -DWIN32 -DSTRICT -DARM -DARMV4I  -D_ARM_ -DINTERNATIONAL -DINTLMSG_CODEPAGE=1252 -Zc:wchar_t- -Zc:forScope- -wd4867 -wd4430 -MT -U_MT -W3 /GR- -QRarch4T -DTHUMBSUPPORT -QRimplicit-import- -QRinterwork-return /GS"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"), Global.newObject("cmd", "$(rootDir)/sdk/bin/i386/arm/armasm.exe -nologo", "opts", "-arch 4T"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"), Global.newObject("cmd", "$(rootDir)/sdk/bin/i386/arm/link -nologo", "opts", "-base:0x00010000 -MERGE:.rdata=.text -MERGE:.astart=.text -align:4096 -ignore:4001,4070,4078,4086,4089,4096,4099,4108,4229 /STACK:65536,4096 /LARGEADDRESSAWARE -incremental:no /opt:ref -SUBSYSTEM:WINDOWSCE,6.00"), "rh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets.arm"), Global.newObject("prefix", "", "suffix", ""), "wh");
        po.addFld("includeOpts", $$T_Str, " ", "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets.arm"), Global.newObject("prefix", "-stack:65536,4096", "suffix", "-map:$(XDCCFGDIR)/$@.map -pdb:$(XDCCFGDIR)/$@.pdb -nodefaultlib"), "wh");
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("genConstCustom", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genConstCustom", "microsoft.targets.arm"), fxn);
                fxn = Global.get(cap, "genVisibleData");
                if (fxn != null) po.addFxn("genVisibleData", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genVisibleData", "microsoft.targets.arm"), fxn);
                fxn = Global.get(cap, "genVisibleFxns");
                if (fxn != null) po.addFxn("genVisibleFxns", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genVisibleFxns", "microsoft.targets.arm"), fxn);
                fxn = Global.get(cap, "genVisibleLibFxns");
                if (fxn != null) po.addFxn("genVisibleLibFxns", (Proto.Fxn)om.findStrict("xdc.bld.ITarget2$$genVisibleLibFxns", "microsoft.targets.arm"), fxn);
    ...
    void WinCE$$SINGLETONS()
    {
        ...
        vo.bind("Command", om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"));
        tdefs.add(om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets.arm"));
        vo.bind("Options", om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets.arm"));
        tdefs.add(om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets.arm"));
