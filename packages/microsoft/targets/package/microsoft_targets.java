...
public class microsoft_targets
{
    ...
    void VC98$$OBJECTS()
    {
        ...
        om.bind("microsoft.targets.VC98.Command", om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"));
        om.bind("microsoft.targets.VC98.Options", om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets"));
    }
    ...
    void ITarget$$TYPES()
    {
        ...
        po.init("microsoft.targets.ITarget.Module", om.findStrict("xdc.bld.ITarget2.Module", "microsoft.targets"));
    ...
    void VC98$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/vc98/bin/lib", "opts", "-nologo"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/vc98/bin/cl.exe -nologo -c", "opts", "-W3 -Zp1 -DWIN32 -D_DLL -D_AFXDLL -DEXPORT=\"\""), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/vc98/bin/cl.exe -nologo -c", "opts", ""), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/vc98/bin/link -nologo", "opts", ""), "rh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets"), Global.newObject("prefix", "-G5 -Ob1 -Gs -GX", "suffix", "-Dfar= "), "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "microsoft.targets"), Global.newObject("prefix", "-libpath:$(rootDir)/vc98/lib -libpath:$(rootDir)/vc98/mfc/lib", "suffix", "-map:$(XDCCFGDIR)/$@.map -pdb:$(XDCCFGDIR)/$@.pdb -machine:ix86 -nodefaultlib -incremental:no"), "wh");
    ...
    void Win32$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/$(compilerDir)/bin/lib.exe -nologo", "opts", ""), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/$(compilerDir)/bin/cl.exe -nologo -c", "opts", "-Zp1 -W3 -DWIN32 -D_DLL -D_AFXDLL -DEXPORT=\"\""), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/$(compilerDir)/bin/ml -c", "opts", "-nologo"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "microsoft.targets"), Global.newObject("cmd", "$(rootDir)/$(compilerDir)/bin/link", "opts", "-nologo"), "rh");
