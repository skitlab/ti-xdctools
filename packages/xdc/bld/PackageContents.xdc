...
metaonly module PackageContents {
     ...
     *          that the syntax of this string may be target dependent.
     *
     *  @field(tcopts)  This string contains options passed to `tconf`
     ...
     *          elements of the `argumants[]` array are formed from the white
    ...
    struct Attrs {
        ...
        String  tcopts;     /*! tconf options, deprecated */
