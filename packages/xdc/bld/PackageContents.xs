...
function addConfiguration (name, target, platform, acfgAttrs)
{
    function close(pkg)
    {
        ...
        /* we need this because addExecutable() calls us */
        if (this.acfg.attrs.cfgScript != null
            && this.acfg.attrs.cfgScript.match(/\.tcf$/) != null) {
            /* tell _gen that not to make this configuration */
            this.acfg.$private.legacyTcf = true;
        }
    }
