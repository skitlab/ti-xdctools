...
metaonly interface ITarget {
     ...
     *  see {@link xdc.bld.Executable#Attrs}.  It is also not included if the
     ...
     *  module or Java class that implements the ?? interface.  This
     *  interface is used to extract information from the object files
