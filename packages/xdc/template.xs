...
xdc.$$Template.prototype.genFile = function(outFileName, thisObj, args, clobber)
{
    ...
    var pdir;
    if ((pdir = ofile.getParent()) != null) {
	(new java.io.File(pdir)).mkdirs();
    }
    ...
    var out = new Packages.xdc.services.global.Out(bos);
    try {
...
/*
 *  @(#) xdc; 1, 1, 1,401; 11-3-2012 15:18:56; /db/ztree/library/trees/xdc/xdc-y44x/src/packages/
 */
