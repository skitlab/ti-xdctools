...
metaonly module Program {
    ...
    /*!
     *  ======== TreeNode ========
     *  Node for the generic TREE_TABLE view.
     */
     ...
     *  is given an oppportunity to initialize the status-reporting mechanisms
     ...
     *
     *  ROV maintains a table of all errors, warnings, etc. encountered while processing
     *  views. This table is cleared on each call to clear cache (e.g., at each 
     *  breakpoint).
     */
