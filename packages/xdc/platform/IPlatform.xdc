...
instance:
     ...
     *			"".
     *
     *  @param(args)	deprecated parameter that should not be used in
...
/*
 *  @(#) xdc.platform; 1, 0, 1, 0,395; 11-3-2012 15:19:05; /db/ztree/library/trees/xdc/xdc-y44x/src/packages/
 */
