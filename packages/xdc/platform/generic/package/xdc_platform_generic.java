...
public class xdc_platform_generic
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.platform.generic.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("xdc.platform.generic.Platform$$create", new Proto.Fxn(om.findStrict("xdc.platform.generic.Platform.Module", "xdc.platform.generic"), om.findStrict("xdc.platform.generic.Platform.Instance", "xdc.platform.generic"), 3, 2, false));
        ...
        sb.append("xdc$platform$generic$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("xdc.platform.generic.Platform$$construct", new Proto.Fxn(om.findStrict("xdc.platform.generic.Platform.Module", "xdc.platform.generic"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("xdc.platform.generic.Platform.Params", "xdc.platform.generic"), Global.newObject());
        sb = new StringBuilder();
        sb.append("xdc$platform$generic$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['xdc.platform.generic.Platform'];\n");
