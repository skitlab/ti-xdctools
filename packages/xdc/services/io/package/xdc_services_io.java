...
public class xdc_services_io
{
    ...
    void File$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.services.io.File.Object", new Proto.Str(po, true));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'debug/Doss.lib',\n");
            sb.append("'release/Doss.lib',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['debug/Doss.lib', {target: 'microsoft.targets.VC98', suffix: '86'}],\n");
