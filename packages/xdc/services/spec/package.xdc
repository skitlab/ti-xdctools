 ...
 *      - `{@link ./doc-files/javadoc/xdc/services/spec/Pkg.html [Pkg]}`
  *       Package related information available from a package's `$spec`
 *        property.
...
/*
 *  @(#) xdc.services.spec; 1, 0, 0, 0,393; 11-3-2012 15:19:24; /db/ztree/library/trees/xdc/xdc-y44x/src/packages/
 */
