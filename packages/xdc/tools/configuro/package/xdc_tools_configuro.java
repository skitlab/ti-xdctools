...
public class xdc_tools_configuro
{
    ...
    void Main$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.tools.configuro.Main.Object", new Proto.Str(po, true));
    ...
    void Main$$TYPES()
    {
        ...
        po.addFld("hasTconf", $$T_Bool, false, "wh");
        po.addFld("bios5Incs", $$T_Bool, false, "wh");
