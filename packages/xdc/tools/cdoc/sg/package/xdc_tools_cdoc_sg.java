...
public class xdc_tools_cdoc_sg
{
    ...
    void Main$$FUNCTIONS()
    {
        ...
        // fxn Main.main
        fxn = (Proto.Fxn)om.bind("xdc.tools.cdoc.sg.Main$$main", new Proto.Fxn(om.findStrict("xdc.tools.cdoc.sg.Main.Module", "xdc.tools.cdoc.sg"), null, 0, -1, false));
    }
    ...
    void Main$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                po.addFxn("main", (Proto.Fxn)om.findStrict("xdc.tools.cdoc.sg.Main$$main", "xdc.tools.cdoc.sg"), Global.get(cap, "main"));
    }
    ...
    void $$SINGLETONS()
    {
        pkgP.init("xdc.tools.cdoc.sg.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "xdc.tools.cdoc.sg"));
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("xdc.tools.cdoc.sg.Main", "xdc.tools.cdoc.sg"));
