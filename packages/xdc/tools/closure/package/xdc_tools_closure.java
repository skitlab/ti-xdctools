...
public class xdc_tools_closure
{
    ...
    void Main$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.tools.closure.Main.Object", new Proto.Str(po, true));
    ...
    void Main$$TYPES()
    {
        ...
        po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{"[-v] [-f] [-i pkg1 [-i pkg2 ...]] [-d dst_dir] package_base_dir"}), "wh");
