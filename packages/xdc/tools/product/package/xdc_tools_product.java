...
public class xdc_tools_product
{
    ...
    void IProduct$$TYPES()
    {
        ...
        po.addFld("targetArr", new Proto.Arr((Proto)om.findStrict("xdc.tools.product.IProduct.Target", "xdc.tools.product"), false), $$DEFAULT, "wh");
        ...
        po.init("xdc.tools.product.IProduct.Target", null);
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("deviceNamePattern", $$T_Str, $$UNDEF, "w");
                po.addFld("deviceFamilyPattern", $$T_Str, $$UNDEF, "w");
                po.addFld("compilerOptsPattern", $$T_Str, $$UNDEF, "w");
                po.addFld("packageName", $$T_Str, $$UNDEF, "w");
                po.addFld("baseTargetName", $$T_Str, $$UNDEF, "w");
