...
public class xdc_cfg
{
    ...
    void SourceDir$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.cfg.SourceDir.Object", new Proto.Str(po, true));
    ...
    void Program$$FUNCTIONS()
    {
        ...
        // fxn Program.freezeRomConfig2
        fxn = (Proto.Fxn)om.bind("xdc.cfg.Program$$freezeRomConfig2", new Proto.Fxn(om.findStrict("xdc.cfg.Program.Module", "xdc.cfg"), null, 0, -1, false));
        // fxn Program.freezeRomParams
        fxn = (Proto.Fxn)om.bind("xdc.cfg.Program$$freezeRomParams", new Proto.Fxn(om.findStrict("xdc.cfg.Program.Module", "xdc.cfg"), null, 0, -1, false));
        ...
        fxn = (Proto.Fxn)om.bind("xdc.cfg.Program$$frozenRomConfig", new Proto.Fxn(om.findStrict("xdc.cfg.Program.Module", "xdc.cfg"), $$T_Bool, 2, 2, false));
                fxn.addArg(0, "modName", $$T_Str, $$UNDEF);
                fxn.addArg(1, "cfgName", $$T_Str, $$UNDEF);
        // fxn Program.frozenRomConfig2
        fxn = (Proto.Fxn)om.bind("xdc.cfg.Program$$frozenRomConfig2", new Proto.Fxn(om.findStrict("xdc.cfg.Program.Module", "xdc.cfg"), null, 0, -1, false));
    }
    ...
    void Program$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                po.addFxn("freezeRomConfig2", (Proto.Fxn)om.findStrict("xdc.cfg.Program$$freezeRomConfig2", "xdc.cfg"), Global.get(cap, "freezeRomConfig2"));
                ...
                po.addFxn("frozenRomConfig2", (Proto.Fxn)om.findStrict("xdc.cfg.Program$$frozenRomConfig2", "xdc.cfg"), Global.get(cap, "frozenRomConfig2"));
