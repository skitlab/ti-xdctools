 ...
 *  `{@link xdc.cfg.Program#linkTemplate linkTemplate}`.  These configuration
 *  options provide the user complete control of the linker command file
 */
...
metaonly module Program {
     ...
     *  @_nodoc
     *
     *  This map contains symbol definitions that are used to define alises
     ...
     *  "reset" functions.
     *
     *  The only other use of this map is to define symbolic names for 
     *  statically created instances as part of the support for legacy
     *  BIOS 5 instance names.
     */
