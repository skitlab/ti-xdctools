...
/* write0_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write0_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId);
...
/* write1_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write1_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg);
...
/* write2_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write2_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg);
...
/* write4_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write4_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
/* write8_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write8_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
