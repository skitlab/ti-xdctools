...
#define xdc_runtime_Registry___VERS 150
...
xdc__CODESECT(xdc_runtime_Registry_Module__startupDone__S, "xdc_runtime_Registry_Module__startupDone")
...
__extern xdc_runtime_Registry_Result xdc_runtime_Registry_addModule__E( xdc_runtime_Registry_Desc* desc, xdc_String modName );
xdc__CODESECT(xdc_runtime_Registry_addModule__F, "xdc_runtime_Registry_addModule")
__extern xdc_runtime_Registry_Result xdc_runtime_Registry_addModule__F( xdc_runtime_Registry_Desc* desc, xdc_String modName );
__extern xdc_runtime_Registry_Result xdc_runtime_Registry_addModule__R( xdc_runtime_Registry_Desc* desc, xdc_String modName );
...
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByName__E( xdc_String modName );
xdc__CODESECT(xdc_runtime_Registry_findByName__F, "xdc_runtime_Registry_findByName")
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByName__F( xdc_String modName );
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByName__R( xdc_String modName );
...
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByNamePattern__E( xdc_String namePat, xdc_Int len, xdc_runtime_Registry_Desc* prev );
xdc__CODESECT(xdc_runtime_Registry_findByNamePattern__F, "xdc_runtime_Registry_findByNamePattern")
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByNamePattern__F( xdc_String namePat, xdc_Int len, xdc_runtime_Registry_Desc* prev );
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByNamePattern__R( xdc_String namePat, xdc_Int len, xdc_runtime_Registry_Desc* prev );
...
xdc__CODESECT(xdc_runtime_Registry_findById__F, "xdc_runtime_Registry_findById")
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findById__F( xdc_runtime_Types_ModuleId mid );
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findById__R( xdc_runtime_Types_ModuleId mid );
...
__extern xdc_Bool xdc_runtime_Registry_getMask__E( xdc_String name, xdc_runtime_Types_DiagsMask* mask );
xdc__CODESECT(xdc_runtime_Registry_getMask__F, "xdc_runtime_Registry_getMask")
__extern xdc_Bool xdc_runtime_Registry_getMask__F( xdc_String name, xdc_runtime_Types_DiagsMask* mask );
__extern xdc_Bool xdc_runtime_Registry_getMask__R( xdc_String name, xdc_runtime_Types_DiagsMask* mask );
...
xdc__CODESECT(xdc_runtime_Registry_isMember__F, "xdc_runtime_Registry_isMember")
__extern xdc_Bool xdc_runtime_Registry_isMember__F( xdc_runtime_Types_ModuleId mid );
__extern xdc_Bool xdc_runtime_Registry_isMember__R( xdc_runtime_Types_ModuleId mid );
...
xdc__CODESECT(xdc_runtime_Registry_getNextModule__F, "xdc_runtime_Registry_getNextModule")
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_getNextModule__F( xdc_runtime_Registry_Desc* desc );
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_getNextModule__R( xdc_runtime_Registry_Desc* desc );
...
__extern xdc_String xdc_runtime_Registry_getModuleName__E( xdc_runtime_Registry_Desc* desc );
xdc__CODESECT(xdc_runtime_Registry_getModuleName__F, "xdc_runtime_Registry_getModuleName")
__extern xdc_String xdc_runtime_Registry_getModuleName__F( xdc_runtime_Registry_Desc* desc );
__extern xdc_String xdc_runtime_Registry_getModuleName__R( xdc_runtime_Registry_Desc* desc );
...
xdc__CODESECT(xdc_runtime_Registry_getModuleId__F, "xdc_runtime_Registry_getModuleId")
__extern xdc_runtime_Types_ModuleId xdc_runtime_Registry_getModuleId__F( xdc_runtime_Registry_Desc* desc );
__extern xdc_runtime_Types_ModuleId xdc_runtime_Registry_getModuleId__R( xdc_runtime_Registry_Desc* desc );
...
__extern xdc_runtime_Registry_Desc* xdc_runtime_Registry_findByNameInList__I( xdc_String name, xdc_runtime_Registry_Desc* listHead );
...
__extern xdc_Void xdc_runtime_Registry_newModule__I( xdc_runtime_Registry_Desc* desc, xdc_String modName );
...
__extern xdc_Bool xdc_runtime_Registry_matchPattern__I( xdc_String pattern, xdc_Int len, xdc_String modName );
