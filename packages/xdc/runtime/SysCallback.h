...
#define xdc_runtime_SysCallback___VERS 150
...
/* AbortFxn */
typedef xdc_Void (*xdc_runtime_SysCallback_AbortFxn)(xdc_String);
...
xdc__CODESECT(xdc_runtime_SysCallback_Module__startupDone__S, "xdc_runtime_SysCallback_Module__startupDone")
...
__extern xdc_Void xdc_runtime_SysCallback_abort__E( xdc_String str );
xdc__CODESECT(xdc_runtime_SysCallback_abort__F, "xdc_runtime_SysCallback_abort")
__extern xdc_Void xdc_runtime_SysCallback_abort__F( xdc_String str );
__extern xdc_Void xdc_runtime_SysCallback_abort__R( xdc_String str );
...
xdc__CODESECT(xdc_runtime_SysCallback_exit__F, "xdc_runtime_SysCallback_exit")
__extern xdc_Void xdc_runtime_SysCallback_exit__F( xdc_Int stat );
__extern xdc_Void xdc_runtime_SysCallback_exit__R( xdc_Int stat );
...
xdc__CODESECT(xdc_runtime_SysCallback_flush__F, "xdc_runtime_SysCallback_flush")
__extern xdc_Void xdc_runtime_SysCallback_flush__F( void );
__extern xdc_Void xdc_runtime_SysCallback_flush__R( void );
...
xdc__CODESECT(xdc_runtime_SysCallback_putch__F, "xdc_runtime_SysCallback_putch")
__extern xdc_Void xdc_runtime_SysCallback_putch__F( xdc_Char ch );
__extern xdc_Void xdc_runtime_SysCallback_putch__R( xdc_Char ch );
...
xdc__CODESECT(xdc_runtime_SysCallback_ready__F, "xdc_runtime_SysCallback_ready")
__extern xdc_Bool xdc_runtime_SysCallback_ready__F( void );
__extern xdc_Bool xdc_runtime_SysCallback_ready__R( void );
...
{
    return xdc_runtime_SysCallback_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 xdc_runtime_SysCallback_Module_getMask( void ) 
{
    return xdc_runtime_SysCallback_Module__diagsMask__C != NULL ? *xdc_runtime_SysCallback_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void xdc_runtime_SysCallback_Module_setMask( xdc_Bits16 mask ) 
{
    if (xdc_runtime_SysCallback_Module__diagsMask__C != NULL) *xdc_runtime_SysCallback_Module__diagsMask__C = mask;
}
