...
#define xdc_runtime_knl_GateProcessSupportNull___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Instance_init__F, "xdc_runtime_knl_GateProcessSupportNull_Instance_init")
__extern void xdc_runtime_knl_GateProcessSupportNull_Instance_init__F( xdc_runtime_knl_GateProcessSupportNull_Object*, const xdc_runtime_knl_GateProcessSupportNull_Params* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Instance_init__R, "xdc_runtime_knl_GateProcessSupportNull_Instance_init")
__extern void xdc_runtime_knl_GateProcessSupportNull_Instance_init__R( xdc_runtime_knl_GateProcessSupportNull_Object*, const xdc_runtime_knl_GateProcessSupportNull_Params* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Handle__label__S, "xdc_runtime_knl_GateProcessSupportNull_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Module__startupDone__S, "xdc_runtime_knl_GateProcessSupportNull_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_GateProcessSupportNull_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Object__create__S, "xdc_runtime_knl_GateProcessSupportNull_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Object__delete__S, "xdc_runtime_knl_GateProcessSupportNull_Object__delete")
__extern xdc_Void xdc_runtime_knl_GateProcessSupportNull_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Object__destruct__S, "xdc_runtime_knl_GateProcessSupportNull_Object__destruct")
__extern xdc_Void xdc_runtime_knl_GateProcessSupportNull_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Object__get__S, "xdc_runtime_knl_GateProcessSupportNull_Object__get")
__extern xdc_Ptr xdc_runtime_knl_GateProcessSupportNull_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Object__first__S, "xdc_runtime_knl_GateProcessSupportNull_Object__first")
__extern xdc_Ptr xdc_runtime_knl_GateProcessSupportNull_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Object__next__S, "xdc_runtime_knl_GateProcessSupportNull_Object__next")
__extern xdc_Ptr xdc_runtime_knl_GateProcessSupportNull_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_Params__init__S, "xdc_runtime_knl_GateProcessSupportNull_Params__init")
__extern xdc_Void xdc_runtime_knl_GateProcessSupportNull_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_query__F, "xdc_runtime_knl_GateProcessSupportNull_query")
__extern xdc_Bool xdc_runtime_knl_GateProcessSupportNull_query__F( xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_GateProcessSupportNull_query__R( xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_enter__F, "xdc_runtime_knl_GateProcessSupportNull_enter")
__extern xdc_IArg xdc_runtime_knl_GateProcessSupportNull_enter__F( xdc_runtime_knl_GateProcessSupportNull_Object* __inst );
__extern xdc_IArg xdc_runtime_knl_GateProcessSupportNull_enter__R( xdc_runtime_knl_GateProcessSupportNull_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_leave__F, "xdc_runtime_knl_GateProcessSupportNull_leave")
__extern xdc_Void xdc_runtime_knl_GateProcessSupportNull_leave__F( xdc_runtime_knl_GateProcessSupportNull_Object* __inst, xdc_IArg key );
__extern xdc_Void xdc_runtime_knl_GateProcessSupportNull_leave__R( xdc_runtime_knl_GateProcessSupportNull_Handle __inst, xdc_IArg key );
...
xdc__CODESECT(xdc_runtime_knl_GateProcessSupportNull_getReferenceCount__F, "xdc_runtime_knl_GateProcessSupportNull_getReferenceCount")
__extern xdc_Int xdc_runtime_knl_GateProcessSupportNull_getReferenceCount__F( xdc_runtime_knl_GateProcessSupportNull_Object* __inst, xdc_runtime_Error_Block* err );
__extern xdc_Int xdc_runtime_knl_GateProcessSupportNull_getReferenceCount__R( xdc_runtime_knl_GateProcessSupportNull_Handle __inst, xdc_runtime_Error_Block* err );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_GateProcessSupportNull_enter_FxnT)(void*);
static inline xdc_runtime_knl_GateProcessSupportNull_enter_FxnT xdc_runtime_knl_GateProcessSupportNull_enter_fxnP( void )
{
    return (xdc_runtime_knl_GateProcessSupportNull_enter_FxnT)xdc_runtime_knl_GateProcessSupportNull_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_GateProcessSupportNull_leave_FxnT)(void*, xdc_IArg);
static inline xdc_runtime_knl_GateProcessSupportNull_leave_FxnT xdc_runtime_knl_GateProcessSupportNull_leave_fxnP( void )
{
    return (xdc_runtime_knl_GateProcessSupportNull_leave_FxnT)xdc_runtime_knl_GateProcessSupportNull_leave; 
}

/* getReferenceCount_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_GateProcessSupportNull_getReferenceCount_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_GateProcessSupportNull_getReferenceCount_FxnT xdc_runtime_knl_GateProcessSupportNull_getReferenceCount_fxnP( void )
{
    return (xdc_runtime_knl_GateProcessSupportNull_getReferenceCount_FxnT)xdc_runtime_knl_GateProcessSupportNull_getReferenceCount; 
}
...
{
    if (dst) {
        xdc_runtime_knl_GateProcessSupportNull_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_GateProcessSupportNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String xdc_runtime_knl_GateProcessSupportNull_Handle_name( xdc_runtime_knl_GateProcessSupportNull_Handle inst )
{
...
/* create */
static inline xdc_runtime_knl_GateProcessSupportNull_Handle xdc_runtime_knl_GateProcessSupportNull_create( const xdc_runtime_knl_GateProcessSupportNull_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_GateProcessSupportNull_Handle)xdc_runtime_knl_GateProcessSupportNull_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateProcessSupportNull_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_GateProcessSupportNull_construct( xdc_runtime_knl_GateProcessSupportNull_Struct* __obj, const xdc_runtime_knl_GateProcessSupportNull_Params* __prms )
{
    xdc_runtime_knl_GateProcessSupportNull_Object__create__S(__obj, sizeof (xdc_runtime_knl_GateProcessSupportNull_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateProcessSupportNull_Params), NULL);
}

/* delete */
static inline void xdc_runtime_knl_GateProcessSupportNull_delete( xdc_runtime_knl_GateProcessSupportNull_Handle* instp )
{
    xdc_runtime_knl_GateProcessSupportNull_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_GateProcessSupportNull_destruct( xdc_runtime_knl_GateProcessSupportNull_Struct* obj )
{
    xdc_runtime_knl_GateProcessSupportNull_Object__destruct__S(obj);
}
...
#define GateProcessSupportNull_enter_fxnP xdc_runtime_knl_GateProcessSupportNull_enter_fxnP
#define GateProcessSupportNull_enter_FxnT xdc_runtime_knl_GateProcessSupportNull_enter_FxnT
#define GateProcessSupportNull_leave xdc_runtime_knl_GateProcessSupportNull_leave
#define GateProcessSupportNull_leave_fxnP xdc_runtime_knl_GateProcessSupportNull_leave_fxnP
#define GateProcessSupportNull_leave_FxnT xdc_runtime_knl_GateProcessSupportNull_leave_FxnT
#define GateProcessSupportNull_getReferenceCount xdc_runtime_knl_GateProcessSupportNull_getReferenceCount
#define GateProcessSupportNull_getReferenceCount_fxnP xdc_runtime_knl_GateProcessSupportNull_getReferenceCount_fxnP
#define GateProcessSupportNull_getReferenceCount_FxnT xdc_runtime_knl_GateProcessSupportNull_getReferenceCount_FxnT
