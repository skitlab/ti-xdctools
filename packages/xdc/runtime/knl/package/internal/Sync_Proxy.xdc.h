...
#ifndef xdc_runtime_knl_Sync_Proxy__INTERNAL__
#define xdc_runtime_knl_Sync_Proxy__INTERNAL__

#ifndef xdc_runtime_knl_Sync_Proxy__internalaccess
#define xdc_runtime_knl_Sync_Proxy__internalaccess
#endif

#include <xdc/runtime/knl/Sync_Proxy.h>
...
/* query */
#undef xdc_runtime_knl_Sync_Proxy_query
#define xdc_runtime_knl_Sync_Proxy_query xdc_runtime_knl_Sync_Proxy_query__F

/* signal */
#undef xdc_runtime_knl_Sync_Proxy_signal
#define xdc_runtime_knl_Sync_Proxy_signal xdc_runtime_knl_Sync_Proxy_signal__F

/* wait */
#undef xdc_runtime_knl_Sync_Proxy_wait
#define xdc_runtime_knl_Sync_Proxy_wait xdc_runtime_knl_Sync_Proxy_wait__F

/* Module_startup */
#undef xdc_runtime_knl_Sync_Proxy_Module_startup
#define xdc_runtime_knl_Sync_Proxy_Module_startup xdc_runtime_knl_Sync_Proxy_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_Sync_Proxy_Instance_init
#define xdc_runtime_knl_Sync_Proxy_Instance_init xdc_runtime_knl_Sync_Proxy_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_Sync_Proxy_Instance_finalize
#define xdc_runtime_knl_Sync_Proxy_Instance_finalize xdc_runtime_knl_Sync_Proxy_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.Sync_Proxy"
typedef char xdc_runtime_knl_Sync_Proxy_Object__sizingError[sizeof(xdc_runtime_knl_Sync_Proxy_Object) > sizeof(xdc_runtime_knl_Sync_Proxy_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_Sync_Proxy__INTERNAL____ */
