...
#ifndef xdc_runtime_knl_GateH__INTERNAL__
#define xdc_runtime_knl_GateH__INTERNAL__

#ifndef xdc_runtime_knl_GateH__internalaccess
#define xdc_runtime_knl_GateH__internalaccess
#endif
...
/* enter */
#undef xdc_runtime_knl_GateH_enter
#define xdc_runtime_knl_GateH_enter xdc_runtime_knl_GateH_enter__F

/* leave */
#undef xdc_runtime_knl_GateH_leave
#define xdc_runtime_knl_GateH_leave xdc_runtime_knl_GateH_leave__F

/* Module_startup */
#undef xdc_runtime_knl_GateH_Module_startup
#define xdc_runtime_knl_GateH_Module_startup xdc_runtime_knl_GateH_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_GateH_Instance_init
#define xdc_runtime_knl_GateH_Instance_init xdc_runtime_knl_GateH_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_GateH_Instance_finalize
#define xdc_runtime_knl_GateH_Instance_finalize xdc_runtime_knl_GateH_Instance_finalize__F
...
#endif /* xdc_runtime_knl_GateH__INTERNAL____ */
