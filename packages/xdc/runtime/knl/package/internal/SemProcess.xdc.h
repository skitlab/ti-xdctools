...
#define xdc_runtime_knl_SemProcess__INTERNAL__

#ifndef xdc_runtime_knl_SemProcess__internalaccess
#define xdc_runtime_knl_SemProcess__internalaccess
#endif
...
/* pend */
#undef xdc_runtime_knl_SemProcess_pend
#define xdc_runtime_knl_SemProcess_pend xdc_runtime_knl_SemProcess_pend__F

/* post */
#undef xdc_runtime_knl_SemProcess_post
#define xdc_runtime_knl_SemProcess_post xdc_runtime_knl_SemProcess_post__F

/* Module_startup */
#undef xdc_runtime_knl_SemProcess_Module_startup
#define xdc_runtime_knl_SemProcess_Module_startup xdc_runtime_knl_SemProcess_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_SemProcess_Instance_init
#define xdc_runtime_knl_SemProcess_Instance_init xdc_runtime_knl_SemProcess_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_SemProcess_Instance_finalize
#define xdc_runtime_knl_SemProcess_Instance_finalize xdc_runtime_knl_SemProcess_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.SemProcess"
typedef char xdc_runtime_knl_SemProcess_Object__sizingError[sizeof(xdc_runtime_knl_SemProcess_Object) > sizeof(xdc_runtime_knl_SemProcess_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_SemProcess__INTERNAL____ */
