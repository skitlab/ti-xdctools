...
#ifndef xdc_runtime_knl_SyncSemThread__INTERNAL__
#define xdc_runtime_knl_SyncSemThread__INTERNAL__

#ifndef xdc_runtime_knl_SyncSemThread__internalaccess
#define xdc_runtime_knl_SyncSemThread__internalaccess
#endif
...
/* query */
#undef xdc_runtime_knl_SyncSemThread_query
#define xdc_runtime_knl_SyncSemThread_query xdc_runtime_knl_SyncSemThread_query__F

/* signal */
#undef xdc_runtime_knl_SyncSemThread_signal
#define xdc_runtime_knl_SyncSemThread_signal xdc_runtime_knl_SyncSemThread_signal__F

/* wait */
#undef xdc_runtime_knl_SyncSemThread_wait
#define xdc_runtime_knl_SyncSemThread_wait xdc_runtime_knl_SyncSemThread_wait__F

/* Module_startup */
#undef xdc_runtime_knl_SyncSemThread_Module_startup
#define xdc_runtime_knl_SyncSemThread_Module_startup xdc_runtime_knl_SyncSemThread_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_SyncSemThread_Instance_init
#define xdc_runtime_knl_SyncSemThread_Instance_init xdc_runtime_knl_SyncSemThread_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_SyncSemThread_Instance_finalize
#define xdc_runtime_knl_SyncSemThread_Instance_finalize xdc_runtime_knl_SyncSemThread_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.SyncSemThread"
typedef char xdc_runtime_knl_SyncSemThread_Object__sizingError[sizeof(xdc_runtime_knl_SyncSemThread_Object) > sizeof(xdc_runtime_knl_SyncSemThread_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_SyncSemThread__INTERNAL____ */
