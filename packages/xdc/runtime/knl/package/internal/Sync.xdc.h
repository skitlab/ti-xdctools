...
#ifndef xdc_runtime_knl_Sync__INTERNAL__
#define xdc_runtime_knl_Sync__INTERNAL__

#ifndef xdc_runtime_knl_Sync__internalaccess
#define xdc_runtime_knl_Sync__internalaccess
#endif
...
/* query */
#undef xdc_runtime_knl_Sync_query
#define xdc_runtime_knl_Sync_query xdc_runtime_knl_Sync_query__F

/* signal */
#undef xdc_runtime_knl_Sync_signal
#define xdc_runtime_knl_Sync_signal xdc_runtime_knl_Sync_signal__F

/* wait */
#undef xdc_runtime_knl_Sync_wait
#define xdc_runtime_knl_Sync_wait xdc_runtime_knl_Sync_wait__F

/* Module_startup */
#undef xdc_runtime_knl_Sync_Module_startup
#define xdc_runtime_knl_Sync_Module_startup xdc_runtime_knl_Sync_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_Sync_Instance_init
#define xdc_runtime_knl_Sync_Instance_init xdc_runtime_knl_Sync_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_Sync_Instance_finalize
#define xdc_runtime_knl_Sync_Instance_finalize xdc_runtime_knl_Sync_Instance_finalize__F
...
#endif /* xdc_runtime_knl_Sync__INTERNAL____ */
