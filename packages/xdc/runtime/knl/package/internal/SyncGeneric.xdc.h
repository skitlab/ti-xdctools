...
#ifndef xdc_runtime_knl_SyncGeneric__INTERNAL__
#define xdc_runtime_knl_SyncGeneric__INTERNAL__

#ifndef xdc_runtime_knl_SyncGeneric__internalaccess
#define xdc_runtime_knl_SyncGeneric__internalaccess
#endif
...
/* query */
#undef xdc_runtime_knl_SyncGeneric_query
#define xdc_runtime_knl_SyncGeneric_query xdc_runtime_knl_SyncGeneric_query__F

/* signal */
#undef xdc_runtime_knl_SyncGeneric_signal
#define xdc_runtime_knl_SyncGeneric_signal xdc_runtime_knl_SyncGeneric_signal__F

/* wait */
#undef xdc_runtime_knl_SyncGeneric_wait
#define xdc_runtime_knl_SyncGeneric_wait xdc_runtime_knl_SyncGeneric_wait__F

/* Module_startup */
#undef xdc_runtime_knl_SyncGeneric_Module_startup
#define xdc_runtime_knl_SyncGeneric_Module_startup xdc_runtime_knl_SyncGeneric_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_SyncGeneric_Instance_init
#define xdc_runtime_knl_SyncGeneric_Instance_init xdc_runtime_knl_SyncGeneric_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_SyncGeneric_Instance_finalize
#define xdc_runtime_knl_SyncGeneric_Instance_finalize xdc_runtime_knl_SyncGeneric_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.SyncGeneric"
typedef char xdc_runtime_knl_SyncGeneric_Object__sizingError[sizeof(xdc_runtime_knl_SyncGeneric_Object) > sizeof(xdc_runtime_knl_SyncGeneric_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_SyncGeneric__INTERNAL____ */
