...
#ifndef xdc_runtime_knl_GateThread__INTERNAL__
#define xdc_runtime_knl_GateThread__INTERNAL__

#ifndef xdc_runtime_knl_GateThread__internalaccess
#define xdc_runtime_knl_GateThread__internalaccess
#endif
...
/* query */
#undef xdc_runtime_knl_GateThread_query
#define xdc_runtime_knl_GateThread_query xdc_runtime_knl_GateThread_query__F

/* enter */
#undef xdc_runtime_knl_GateThread_enter
#define xdc_runtime_knl_GateThread_enter xdc_runtime_knl_GateThread_enter__F

/* leave */
#undef xdc_runtime_knl_GateThread_leave
#define xdc_runtime_knl_GateThread_leave xdc_runtime_knl_GateThread_leave__F

/* Module_startup */
#undef xdc_runtime_knl_GateThread_Module_startup
#define xdc_runtime_knl_GateThread_Module_startup xdc_runtime_knl_GateThread_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_GateThread_Instance_init
#define xdc_runtime_knl_GateThread_Instance_init xdc_runtime_knl_GateThread_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_GateThread_Instance_finalize
#define xdc_runtime_knl_GateThread_Instance_finalize xdc_runtime_knl_GateThread_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.GateThread"
typedef char xdc_runtime_knl_GateThread_Object__sizingError[sizeof(xdc_runtime_knl_GateThread_Object) > sizeof(xdc_runtime_knl_GateThread_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_GateThread__INTERNAL____ */
