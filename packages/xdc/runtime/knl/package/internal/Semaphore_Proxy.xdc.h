...
#ifndef xdc_runtime_knl_Semaphore_Proxy__INTERNAL__
#define xdc_runtime_knl_Semaphore_Proxy__INTERNAL__

#ifndef xdc_runtime_knl_Semaphore_Proxy__internalaccess
#define xdc_runtime_knl_Semaphore_Proxy__internalaccess
#endif

#include <xdc/runtime/knl/Semaphore_Proxy.h>
...
/* pend */
#undef xdc_runtime_knl_Semaphore_Proxy_pend
#define xdc_runtime_knl_Semaphore_Proxy_pend xdc_runtime_knl_Semaphore_Proxy_pend__F

/* post */
#undef xdc_runtime_knl_Semaphore_Proxy_post
#define xdc_runtime_knl_Semaphore_Proxy_post xdc_runtime_knl_Semaphore_Proxy_post__F

/* Module_startup */
#undef xdc_runtime_knl_Semaphore_Proxy_Module_startup
#define xdc_runtime_knl_Semaphore_Proxy_Module_startup xdc_runtime_knl_Semaphore_Proxy_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_Semaphore_Proxy_Instance_init
#define xdc_runtime_knl_Semaphore_Proxy_Instance_init xdc_runtime_knl_Semaphore_Proxy_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_Semaphore_Proxy_Instance_finalize
#define xdc_runtime_knl_Semaphore_Proxy_Instance_finalize xdc_runtime_knl_Semaphore_Proxy_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.Semaphore_Proxy"
typedef char xdc_runtime_knl_Semaphore_Proxy_Object__sizingError[sizeof(xdc_runtime_knl_Semaphore_Proxy_Object) > sizeof(xdc_runtime_knl_Semaphore_Proxy_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_Semaphore_Proxy__INTERNAL____ */
