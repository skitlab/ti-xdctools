...
#define xdc_runtime_knl_SemThread_Proxy_pend xdc_runtime_knl_SemThread_Proxy_pend__F

/* post */
#undef xdc_runtime_knl_SemThread_Proxy_post
#define xdc_runtime_knl_SemThread_Proxy_post xdc_runtime_knl_SemThread_Proxy_post__F

/* Module_startup */
#undef xdc_runtime_knl_SemThread_Proxy_Module_startup
#define xdc_runtime_knl_SemThread_Proxy_Module_startup xdc_runtime_knl_SemThread_Proxy_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_SemThread_Proxy_Instance_init
#define xdc_runtime_knl_SemThread_Proxy_Instance_init xdc_runtime_knl_SemThread_Proxy_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_SemThread_Proxy_Instance_finalize
#define xdc_runtime_knl_SemThread_Proxy_Instance_finalize xdc_runtime_knl_SemThread_Proxy_Instance_finalize__F
