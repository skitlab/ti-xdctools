...
#ifndef xdc_runtime_knl_SemThread__INTERNAL__
#define xdc_runtime_knl_SemThread__INTERNAL__

#ifndef xdc_runtime_knl_SemThread__internalaccess
#define xdc_runtime_knl_SemThread__internalaccess
#endif
...
/* pend */
#undef xdc_runtime_knl_SemThread_pend
#define xdc_runtime_knl_SemThread_pend xdc_runtime_knl_SemThread_pend__F

/* post */
#undef xdc_runtime_knl_SemThread_post
#define xdc_runtime_knl_SemThread_post xdc_runtime_knl_SemThread_post__F

/* Module_startup */
#undef xdc_runtime_knl_SemThread_Module_startup
#define xdc_runtime_knl_SemThread_Module_startup xdc_runtime_knl_SemThread_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_SemThread_Instance_init
#define xdc_runtime_knl_SemThread_Instance_init xdc_runtime_knl_SemThread_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_SemThread_Instance_finalize
#define xdc_runtime_knl_SemThread_Instance_finalize xdc_runtime_knl_SemThread_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_xdc.runtime.knl.SemThread"
typedef char xdc_runtime_knl_SemThread_Object__sizingError[sizeof(xdc_runtime_knl_SemThread_Object) > sizeof(xdc_runtime_knl_SemThread_Struct) ? -1 : 1];


#endif /* xdc_runtime_knl_SemThread__INTERNAL____ */
