...
#ifndef xdc_runtime_knl_Semaphore__INTERNAL__
#define xdc_runtime_knl_Semaphore__INTERNAL__

#ifndef xdc_runtime_knl_Semaphore__internalaccess
#define xdc_runtime_knl_Semaphore__internalaccess
#endif
...
/* pend */
#undef xdc_runtime_knl_Semaphore_pend
#define xdc_runtime_knl_Semaphore_pend xdc_runtime_knl_Semaphore_pend__F

/* post */
#undef xdc_runtime_knl_Semaphore_post
#define xdc_runtime_knl_Semaphore_post xdc_runtime_knl_Semaphore_post__F

/* Module_startup */
#undef xdc_runtime_knl_Semaphore_Module_startup
#define xdc_runtime_knl_Semaphore_Module_startup xdc_runtime_knl_Semaphore_Module_startup__F

/* Instance_init */
#undef xdc_runtime_knl_Semaphore_Instance_init
#define xdc_runtime_knl_Semaphore_Instance_init xdc_runtime_knl_Semaphore_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_knl_Semaphore_Instance_finalize
#define xdc_runtime_knl_Semaphore_Instance_finalize xdc_runtime_knl_Semaphore_Instance_finalize__F
...
#endif /* xdc_runtime_knl_Semaphore__INTERNAL____ */
