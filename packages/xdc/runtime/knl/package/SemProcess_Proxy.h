...
#define xdc_runtime_knl_SemProcess_Proxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Handle__label__S, "xdc_runtime_knl_SemProcess_Proxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Module__startupDone__S, "xdc_runtime_knl_SemProcess_Proxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_SemProcess_Proxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Object__create__S, "xdc_runtime_knl_SemProcess_Proxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Object__delete__S, "xdc_runtime_knl_SemProcess_Proxy_Object__delete")
__extern xdc_Void xdc_runtime_knl_SemProcess_Proxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Object__destruct__S, "xdc_runtime_knl_SemProcess_Proxy_Object__destruct")
__extern xdc_Void xdc_runtime_knl_SemProcess_Proxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Object__get__S, "xdc_runtime_knl_SemProcess_Proxy_Object__get")
__extern xdc_Ptr xdc_runtime_knl_SemProcess_Proxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Object__first__S, "xdc_runtime_knl_SemProcess_Proxy_Object__first")
__extern xdc_Ptr xdc_runtime_knl_SemProcess_Proxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Object__next__S, "xdc_runtime_knl_SemProcess_Proxy_Object__next")
__extern xdc_Ptr xdc_runtime_knl_SemProcess_Proxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Params__init__S, "xdc_runtime_knl_SemProcess_Proxy_Params__init")
__extern xdc_Void xdc_runtime_knl_SemProcess_Proxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Proxy__abstract__S, "xdc_runtime_knl_SemProcess_Proxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_knl_SemProcess_Proxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_Proxy__delegate__S, "xdc_runtime_knl_SemProcess_Proxy_Proxy__delegate")
...
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_pend__R, "xdc_runtime_knl_SemProcess_Proxy_pend")
__extern xdc_Int xdc_runtime_knl_SemProcess_Proxy_pend__R( xdc_runtime_knl_SemProcess_Proxy_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_SemProcess_Proxy_post__R, "xdc_runtime_knl_SemProcess_Proxy_post")
__extern xdc_Bool xdc_runtime_knl_SemProcess_Proxy_post__R( xdc_runtime_knl_SemProcess_Proxy_Handle __inst, xdc_runtime_Error_Block* eb );
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_SemProcess_Proxy_pend_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SemProcess_Proxy_pend_FxnT xdc_runtime_knl_SemProcess_Proxy_pend_fxnP( void )
{
    return (xdc_runtime_knl_SemProcess_Proxy_pend_FxnT)xdc_runtime_knl_SemProcess_Proxy_pend; 
}

/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_SemProcess_Proxy_post_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SemProcess_Proxy_post_FxnT xdc_runtime_knl_SemProcess_Proxy_post_fxnP( void )
{
    return (xdc_runtime_knl_SemProcess_Proxy_post_FxnT)xdc_runtime_knl_SemProcess_Proxy_post; 
}
...
{
    if (dst) {
        xdc_runtime_knl_SemProcess_Proxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_SemProcess_Proxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline xdc_runtime_knl_SemProcess_Proxy_Handle xdc_runtime_knl_SemProcess_Proxy_create( xdc_Int count, xdc_Int key, const xdc_runtime_knl_SemProcess_Proxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_SemProcess_Proxy_Args__create __args;
    __args.count = count;
    __args.key = key;
    return (xdc_runtime_knl_SemProcess_Proxy_Handle)xdc_runtime_knl_SemProcess_Proxy_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SemProcess_Proxy_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_SemProcess_Proxy_delete( xdc_runtime_knl_SemProcess_Proxy_Handle* instp )
{
    xdc_runtime_knl_SemProcess_Proxy_Object__delete__S(instp);
}
...
#define SemProcess_Proxy_pend_fxnP xdc_runtime_knl_SemProcess_Proxy_pend_fxnP
#define SemProcess_Proxy_pend_FxnT xdc_runtime_knl_SemProcess_Proxy_pend_FxnT
#define SemProcess_Proxy_post xdc_runtime_knl_SemProcess_Proxy_post
#define SemProcess_Proxy_post_fxnP xdc_runtime_knl_SemProcess_Proxy_post_fxnP
#define SemProcess_Proxy_post_FxnT xdc_runtime_knl_SemProcess_Proxy_post_FxnT
