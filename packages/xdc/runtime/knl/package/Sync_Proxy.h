...
#define xdc_runtime_knl_Sync_Proxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Handle__label__S, "xdc_runtime_knl_Sync_Proxy_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_knl_Sync_Proxy_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Module__startupDone__S, "xdc_runtime_knl_Sync_Proxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_Sync_Proxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Object__create__S, "xdc_runtime_knl_Sync_Proxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Object__delete__S, "xdc_runtime_knl_Sync_Proxy_Object__delete")
__extern xdc_Void xdc_runtime_knl_Sync_Proxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Object__destruct__S, "xdc_runtime_knl_Sync_Proxy_Object__destruct")
__extern xdc_Void xdc_runtime_knl_Sync_Proxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Object__get__S, "xdc_runtime_knl_Sync_Proxy_Object__get")
__extern xdc_Ptr xdc_runtime_knl_Sync_Proxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Object__first__S, "xdc_runtime_knl_Sync_Proxy_Object__first")
__extern xdc_Ptr xdc_runtime_knl_Sync_Proxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Object__next__S, "xdc_runtime_knl_Sync_Proxy_Object__next")
__extern xdc_Ptr xdc_runtime_knl_Sync_Proxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Params__init__S, "xdc_runtime_knl_Sync_Proxy_Params__init")
__extern xdc_Void xdc_runtime_knl_Sync_Proxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Proxy__abstract__S, "xdc_runtime_knl_Sync_Proxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_knl_Sync_Proxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_Proxy__delegate__S, "xdc_runtime_knl_Sync_Proxy_Proxy__delegate")
...
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_query__R, "xdc_runtime_knl_Sync_Proxy_query")
__extern xdc_Bool xdc_runtime_knl_Sync_Proxy_query__R( xdc_runtime_knl_Sync_Proxy_Handle __inst, xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_signal__R, "xdc_runtime_knl_Sync_Proxy_signal")
__extern xdc_Void xdc_runtime_knl_Sync_Proxy_signal__R( xdc_runtime_knl_Sync_Proxy_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_Sync_Proxy_wait__R, "xdc_runtime_knl_Sync_Proxy_wait")
__extern xdc_Int xdc_runtime_knl_Sync_Proxy_wait__R( xdc_runtime_knl_Sync_Proxy_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Sync_Proxy_query_FxnT)(void*, xdc_Int);
static inline xdc_runtime_knl_Sync_Proxy_query_FxnT xdc_runtime_knl_Sync_Proxy_query_fxnP( void )
{
    return (xdc_runtime_knl_Sync_Proxy_query_FxnT)xdc_runtime_knl_Sync_Proxy_query; 
}

/* signal_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_Sync_Proxy_signal_FxnT)(void*);
static inline xdc_runtime_knl_Sync_Proxy_signal_FxnT xdc_runtime_knl_Sync_Proxy_signal_fxnP( void )
{
    return (xdc_runtime_knl_Sync_Proxy_signal_FxnT)xdc_runtime_knl_Sync_Proxy_signal; 
}

/* wait_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_Sync_Proxy_wait_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Sync_Proxy_wait_FxnT xdc_runtime_knl_Sync_Proxy_wait_fxnP( void )
{
    return (xdc_runtime_knl_Sync_Proxy_wait_FxnT)xdc_runtime_knl_Sync_Proxy_wait; 
}
...
{
    if (dst) {
        xdc_runtime_knl_Sync_Proxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_Sync_Proxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline xdc_runtime_knl_Sync_Proxy_Handle xdc_runtime_knl_Sync_Proxy_create( const xdc_runtime_knl_Sync_Proxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_Sync_Proxy_Handle)xdc_runtime_knl_Sync_Proxy_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_Sync_Proxy_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_Sync_Proxy_delete( xdc_runtime_knl_Sync_Proxy_Handle* instp )
{
    xdc_runtime_knl_Sync_Proxy_Object__delete__S(instp);
}
...
#define Sync_Proxy_query_fxnP xdc_runtime_knl_Sync_Proxy_query_fxnP
#define Sync_Proxy_query_FxnT xdc_runtime_knl_Sync_Proxy_query_FxnT
#define Sync_Proxy_signal xdc_runtime_knl_Sync_Proxy_signal
#define Sync_Proxy_signal_fxnP xdc_runtime_knl_Sync_Proxy_signal_fxnP
#define Sync_Proxy_signal_FxnT xdc_runtime_knl_Sync_Proxy_signal_FxnT
#define Sync_Proxy_wait xdc_runtime_knl_Sync_Proxy_wait
#define Sync_Proxy_wait_fxnP xdc_runtime_knl_Sync_Proxy_wait_fxnP
#define Sync_Proxy_wait_FxnT xdc_runtime_knl_Sync_Proxy_wait_FxnT
