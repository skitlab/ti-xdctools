...
#define xdc_runtime_knl_Cache_Proxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Handle__label__S, "xdc_runtime_knl_Cache_Proxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Module__startupDone__S, "xdc_runtime_knl_Cache_Proxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_Cache_Proxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Object__create__S, "xdc_runtime_knl_Cache_Proxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Object__delete__S, "xdc_runtime_knl_Cache_Proxy_Object__delete")
__extern xdc_Void xdc_runtime_knl_Cache_Proxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Object__destruct__S, "xdc_runtime_knl_Cache_Proxy_Object__destruct")
__extern xdc_Void xdc_runtime_knl_Cache_Proxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Object__get__S, "xdc_runtime_knl_Cache_Proxy_Object__get")
__extern xdc_Ptr xdc_runtime_knl_Cache_Proxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Object__first__S, "xdc_runtime_knl_Cache_Proxy_Object__first")
__extern xdc_Ptr xdc_runtime_knl_Cache_Proxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Object__next__S, "xdc_runtime_knl_Cache_Proxy_Object__next")
__extern xdc_Ptr xdc_runtime_knl_Cache_Proxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Params__init__S, "xdc_runtime_knl_Cache_Proxy_Params__init")
__extern xdc_Void xdc_runtime_knl_Cache_Proxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Proxy__abstract__S, "xdc_runtime_knl_Cache_Proxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_knl_Cache_Proxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_Proxy__delegate__S, "xdc_runtime_knl_Cache_Proxy_Proxy__delegate")
...
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_inv__R, "xdc_runtime_knl_Cache_Proxy_inv")
__extern xdc_Bool xdc_runtime_knl_Cache_Proxy_inv__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_wb__R, "xdc_runtime_knl_Cache_Proxy_wb")
__extern xdc_Bool xdc_runtime_knl_Cache_Proxy_wb__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_wbInv__R, "xdc_runtime_knl_Cache_Proxy_wbInv")
__extern xdc_Bool xdc_runtime_knl_Cache_Proxy_wbInv__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Cache_Proxy_wait__R, "xdc_runtime_knl_Cache_Proxy_wait")
__extern xdc_Bool xdc_runtime_knl_Cache_Proxy_wait__R( xdc_runtime_Error_Block* eb );
