...
#define xdc_runtime_knl_GateH_Proxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Handle__label__S, "xdc_runtime_knl_GateH_Proxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Module__startupDone__S, "xdc_runtime_knl_GateH_Proxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_GateH_Proxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Object__create__S, "xdc_runtime_knl_GateH_Proxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Object__delete__S, "xdc_runtime_knl_GateH_Proxy_Object__delete")
__extern xdc_Void xdc_runtime_knl_GateH_Proxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Object__destruct__S, "xdc_runtime_knl_GateH_Proxy_Object__destruct")
__extern xdc_Void xdc_runtime_knl_GateH_Proxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Object__get__S, "xdc_runtime_knl_GateH_Proxy_Object__get")
__extern xdc_Ptr xdc_runtime_knl_GateH_Proxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Object__first__S, "xdc_runtime_knl_GateH_Proxy_Object__first")
__extern xdc_Ptr xdc_runtime_knl_GateH_Proxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Object__next__S, "xdc_runtime_knl_GateH_Proxy_Object__next")
__extern xdc_Ptr xdc_runtime_knl_GateH_Proxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Params__init__S, "xdc_runtime_knl_GateH_Proxy_Params__init")
__extern xdc_Void xdc_runtime_knl_GateH_Proxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Proxy__abstract__S, "xdc_runtime_knl_GateH_Proxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_knl_GateH_Proxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_Proxy__delegate__S, "xdc_runtime_knl_GateH_Proxy_Proxy__delegate")
...
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_query__R, "xdc_runtime_knl_GateH_Proxy_query")
__extern xdc_Bool xdc_runtime_knl_GateH_Proxy_query__R( xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_enter__R, "xdc_runtime_knl_GateH_Proxy_enter")
__extern xdc_IArg xdc_runtime_knl_GateH_Proxy_enter__R( xdc_runtime_knl_GateH_Proxy_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_GateH_Proxy_leave__R, "xdc_runtime_knl_GateH_Proxy_leave")
__extern xdc_Void xdc_runtime_knl_GateH_Proxy_leave__R( xdc_runtime_knl_GateH_Proxy_Handle __inst, xdc_IArg key );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_GateH_Proxy_enter_FxnT)(void*);
static inline xdc_runtime_knl_GateH_Proxy_enter_FxnT xdc_runtime_knl_GateH_Proxy_enter_fxnP( void )
{
    return (xdc_runtime_knl_GateH_Proxy_enter_FxnT)xdc_runtime_knl_GateH_Proxy_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_GateH_Proxy_leave_FxnT)(void*, xdc_IArg);
static inline xdc_runtime_knl_GateH_Proxy_leave_FxnT xdc_runtime_knl_GateH_Proxy_leave_fxnP( void )
{
    return (xdc_runtime_knl_GateH_Proxy_leave_FxnT)xdc_runtime_knl_GateH_Proxy_leave; 
}
...
{
    if (dst) {
        xdc_runtime_knl_GateH_Proxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_GateH_Proxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline xdc_runtime_knl_GateH_Proxy_Handle xdc_runtime_knl_GateH_Proxy_create( const xdc_runtime_knl_GateH_Proxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_GateH_Proxy_Handle)xdc_runtime_knl_GateH_Proxy_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateH_Proxy_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_GateH_Proxy_delete( xdc_runtime_knl_GateH_Proxy_Handle* instp )
{
    xdc_runtime_knl_GateH_Proxy_Object__delete__S(instp);
}
...
#define GateH_Proxy_enter_fxnP xdc_runtime_knl_GateH_Proxy_enter_fxnP
#define GateH_Proxy_enter_FxnT xdc_runtime_knl_GateH_Proxy_enter_FxnT
#define GateH_Proxy_leave xdc_runtime_knl_GateH_Proxy_leave
#define GateH_Proxy_leave_fxnP xdc_runtime_knl_GateH_Proxy_leave_fxnP
#define GateH_Proxy_leave_FxnT xdc_runtime_knl_GateH_Proxy_leave_FxnT
