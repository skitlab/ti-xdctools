...
#define xdc_runtime_knl_Thread_Proxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Handle__label__S, "xdc_runtime_knl_Thread_Proxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Module__startupDone__S, "xdc_runtime_knl_Thread_Proxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Object__create__S, "xdc_runtime_knl_Thread_Proxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Object__delete__S, "xdc_runtime_knl_Thread_Proxy_Object__delete")
__extern xdc_Void xdc_runtime_knl_Thread_Proxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Object__destruct__S, "xdc_runtime_knl_Thread_Proxy_Object__destruct")
__extern xdc_Void xdc_runtime_knl_Thread_Proxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Object__get__S, "xdc_runtime_knl_Thread_Proxy_Object__get")
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Object__first__S, "xdc_runtime_knl_Thread_Proxy_Object__first")
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Object__next__S, "xdc_runtime_knl_Thread_Proxy_Object__next")
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Params__init__S, "xdc_runtime_knl_Thread_Proxy_Params__init")
__extern xdc_Void xdc_runtime_knl_Thread_Proxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Proxy__abstract__S, "xdc_runtime_knl_Thread_Proxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_Proxy__delegate__S, "xdc_runtime_knl_Thread_Proxy_Proxy__delegate")
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_self__R, "xdc_runtime_knl_Thread_Proxy_self")
__extern xdc_runtime_knl_IThreadSupport_Handle xdc_runtime_knl_Thread_Proxy_self__R( xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_start__R, "xdc_runtime_knl_Thread_Proxy_start")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_start__R( xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_yield__R, "xdc_runtime_knl_Thread_Proxy_yield")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_yield__R( xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_compareOsPriorities__R, "xdc_runtime_knl_Thread_Proxy_compareOsPriorities")
__extern xdc_Int xdc_runtime_knl_Thread_Proxy_compareOsPriorities__R( xdc_Int p1, xdc_Int p2, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_sleep__R, "xdc_runtime_knl_Thread_Proxy_sleep")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_sleep__R( xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_join__R, "xdc_runtime_knl_Thread_Proxy_join")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_join__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_getPriority__R, "xdc_runtime_knl_Thread_Proxy_getPriority")
__extern xdc_runtime_knl_IThreadSupport_Priority xdc_runtime_knl_Thread_Proxy_getPriority__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_setPriority__R, "xdc_runtime_knl_Thread_Proxy_setPriority")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_setPriority__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_knl_IThreadSupport_Priority newPri, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_getOsPriority__R, "xdc_runtime_knl_Thread_Proxy_getOsPriority")
__extern xdc_Int xdc_runtime_knl_Thread_Proxy_getOsPriority__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_setOsPriority__R, "xdc_runtime_knl_Thread_Proxy_setOsPriority")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_setOsPriority__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_Int newPri, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_getOsHandle__R, "xdc_runtime_knl_Thread_Proxy_getOsHandle")
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_getOsHandle__R( xdc_runtime_knl_Thread_Proxy_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_getTls__R, "xdc_runtime_knl_Thread_Proxy_getTls")
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_getTls__R( xdc_runtime_knl_Thread_Proxy_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_setTls__R, "xdc_runtime_knl_Thread_Proxy_setTls")
__extern xdc_Void xdc_runtime_knl_Thread_Proxy_setTls__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_Ptr tls );
...
xdc__CODESECT(xdc_runtime_knl_Thread_Proxy_stat__R, "xdc_runtime_knl_Thread_Proxy_stat")
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_stat__R( xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_knl_IThreadSupport_Stat* buf, xdc_runtime_Error_Block* eb );
...
/* join_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_Proxy_join_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_Proxy_join_FxnT xdc_runtime_knl_Thread_Proxy_join_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_join_FxnT)xdc_runtime_knl_Thread_Proxy_join; 
}

/* getPriority_{FxnT,fxnP} */
typedef xdc_runtime_knl_IThreadSupport_Priority (*xdc_runtime_knl_Thread_Proxy_getPriority_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_Proxy_getPriority_FxnT xdc_runtime_knl_Thread_Proxy_getPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_getPriority_FxnT)xdc_runtime_knl_Thread_Proxy_getPriority; 
}

/* setPriority_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_Proxy_setPriority_FxnT)(void*, xdc_runtime_knl_IThreadSupport_Priority, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_Proxy_setPriority_FxnT xdc_runtime_knl_Thread_Proxy_setPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_setPriority_FxnT)xdc_runtime_knl_Thread_Proxy_setPriority; 
}

/* getOsPriority_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_Thread_Proxy_getOsPriority_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_Proxy_getOsPriority_FxnT xdc_runtime_knl_Thread_Proxy_getOsPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_getOsPriority_FxnT)xdc_runtime_knl_Thread_Proxy_getOsPriority; 
}

/* setOsPriority_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_Proxy_setOsPriority_FxnT)(void*, xdc_Int, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_Proxy_setOsPriority_FxnT xdc_runtime_knl_Thread_Proxy_setOsPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_setOsPriority_FxnT)xdc_runtime_knl_Thread_Proxy_setOsPriority; 
}

/* getOsHandle_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_knl_Thread_Proxy_getOsHandle_FxnT)(void*);
static inline xdc_runtime_knl_Thread_Proxy_getOsHandle_FxnT xdc_runtime_knl_Thread_Proxy_getOsHandle_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_getOsHandle_FxnT)xdc_runtime_knl_Thread_Proxy_getOsHandle; 
}

/* getTls_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_knl_Thread_Proxy_getTls_FxnT)(void*);
static inline xdc_runtime_knl_Thread_Proxy_getTls_FxnT xdc_runtime_knl_Thread_Proxy_getTls_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_getTls_FxnT)xdc_runtime_knl_Thread_Proxy_getTls; 
}

/* setTls_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_Thread_Proxy_setTls_FxnT)(void*, xdc_Ptr);
static inline xdc_runtime_knl_Thread_Proxy_setTls_FxnT xdc_runtime_knl_Thread_Proxy_setTls_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_setTls_FxnT)xdc_runtime_knl_Thread_Proxy_setTls; 
}

/* stat_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_Proxy_stat_FxnT)(void*, xdc_runtime_knl_IThreadSupport_Stat*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_Proxy_stat_FxnT xdc_runtime_knl_Thread_Proxy_stat_fxnP( void )
{
    return (xdc_runtime_knl_Thread_Proxy_stat_FxnT)xdc_runtime_knl_Thread_Proxy_stat; 
}
...
{
    if (dst) {
        xdc_runtime_knl_Thread_Proxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_Thread_Proxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline xdc_runtime_knl_Thread_Proxy_Handle xdc_runtime_knl_Thread_Proxy_create( xdc_runtime_knl_IThreadSupport_RunFxn fxn, const xdc_runtime_knl_Thread_Proxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_Thread_Proxy_Args__create __args;
    __args.fxn = fxn;
    return (xdc_runtime_knl_Thread_Proxy_Handle)xdc_runtime_knl_Thread_Proxy_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_Thread_Proxy_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_Thread_Proxy_delete( xdc_runtime_knl_Thread_Proxy_Handle* instp )
{
    xdc_runtime_knl_Thread_Proxy_Object__delete__S(instp);
}
...
#define Thread_Proxy_join_fxnP xdc_runtime_knl_Thread_Proxy_join_fxnP
#define Thread_Proxy_join_FxnT xdc_runtime_knl_Thread_Proxy_join_FxnT
#define Thread_Proxy_getPriority xdc_runtime_knl_Thread_Proxy_getPriority
#define Thread_Proxy_getPriority_fxnP xdc_runtime_knl_Thread_Proxy_getPriority_fxnP
#define Thread_Proxy_getPriority_FxnT xdc_runtime_knl_Thread_Proxy_getPriority_FxnT
#define Thread_Proxy_setPriority xdc_runtime_knl_Thread_Proxy_setPriority
#define Thread_Proxy_setPriority_fxnP xdc_runtime_knl_Thread_Proxy_setPriority_fxnP
#define Thread_Proxy_setPriority_FxnT xdc_runtime_knl_Thread_Proxy_setPriority_FxnT
#define Thread_Proxy_getOsPriority xdc_runtime_knl_Thread_Proxy_getOsPriority
#define Thread_Proxy_getOsPriority_fxnP xdc_runtime_knl_Thread_Proxy_getOsPriority_fxnP
#define Thread_Proxy_getOsPriority_FxnT xdc_runtime_knl_Thread_Proxy_getOsPriority_FxnT
#define Thread_Proxy_setOsPriority xdc_runtime_knl_Thread_Proxy_setOsPriority
#define Thread_Proxy_setOsPriority_fxnP xdc_runtime_knl_Thread_Proxy_setOsPriority_fxnP
#define Thread_Proxy_setOsPriority_FxnT xdc_runtime_knl_Thread_Proxy_setOsPriority_FxnT
#define Thread_Proxy_getOsHandle xdc_runtime_knl_Thread_Proxy_getOsHandle
#define Thread_Proxy_getOsHandle_fxnP xdc_runtime_knl_Thread_Proxy_getOsHandle_fxnP
#define Thread_Proxy_getOsHandle_FxnT xdc_runtime_knl_Thread_Proxy_getOsHandle_FxnT
#define Thread_Proxy_getTls xdc_runtime_knl_Thread_Proxy_getTls
#define Thread_Proxy_getTls_fxnP xdc_runtime_knl_Thread_Proxy_getTls_fxnP
#define Thread_Proxy_getTls_FxnT xdc_runtime_knl_Thread_Proxy_getTls_FxnT
#define Thread_Proxy_setTls xdc_runtime_knl_Thread_Proxy_setTls
#define Thread_Proxy_setTls_fxnP xdc_runtime_knl_Thread_Proxy_setTls_fxnP
#define Thread_Proxy_setTls_FxnT xdc_runtime_knl_Thread_Proxy_setTls_FxnT
#define Thread_Proxy_stat xdc_runtime_knl_Thread_Proxy_stat
#define Thread_Proxy_stat_fxnP xdc_runtime_knl_Thread_Proxy_stat_fxnP
#define Thread_Proxy_stat_FxnT xdc_runtime_knl_Thread_Proxy_stat_FxnT
