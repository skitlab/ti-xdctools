...
#define xdc_runtime_knl_ISemProcessSupport___VERS 150
...
/* create */
static inline xdc_runtime_knl_ISemProcessSupport_Handle xdc_runtime_knl_ISemProcessSupport_create( xdc_runtime_knl_ISemProcessSupport_Module __mod, xdc_Int count, xdc_Int key, const xdc_runtime_knl_ISemProcessSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_ISemProcessSupport_Args__create __args;
    __args.count = count;
    __args.key = key;
    return (xdc_runtime_knl_ISemProcessSupport_Handle) __mod->__sysp->__create(0, 0, &__args, (const xdc_UChar*)__prms, sizeof (xdc_runtime_knl_ISemProcessSupport_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_ISemProcessSupport_delete( xdc_runtime_knl_ISemProcessSupport_Handle* instp )
{
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemProcessSupport_pend_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
...
/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemProcessSupport_post_FxnT)(void*, xdc_runtime_Error_Block*);
