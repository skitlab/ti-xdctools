...
#define xdc_runtime_knl_GateProcess___VERS 150
...
typedef xdc_Bool (*CT__xdc_runtime_knl_GateProcess_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__xdc_runtime_knl_GateProcess_Module__startupDoneFxn xdc_runtime_knl_GateProcess_Module__startupDoneFxn__C;
...
struct xdc_runtime_knl_GateProcess_Struct {
    ...
    xdc_runtime_knl_GateProcess_Proxy_Handle __f0;
...
struct xdc_runtime_knl_GateProcess_Fxns__ {
    ...
    xdc_IArg (*enter)(xdc_runtime_knl_GateProcess_Handle);
    xdc_Void (*leave)(xdc_runtime_knl_GateProcess_Handle, xdc_IArg);
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Instance_init__F, "xdc_runtime_knl_GateProcess_Instance_init")
__extern int xdc_runtime_knl_GateProcess_Instance_init__F( xdc_runtime_knl_GateProcess_Object*, const xdc_runtime_knl_GateProcess_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Instance_finalize__F, "xdc_runtime_knl_GateProcess_Instance_finalize")
__extern void xdc_runtime_knl_GateProcess_Instance_finalize__F( xdc_runtime_knl_GateProcess_Object* , int );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Instance_init__R, "xdc_runtime_knl_GateProcess_Instance_init")
__extern int xdc_runtime_knl_GateProcess_Instance_init__R( xdc_runtime_knl_GateProcess_Object*, const xdc_runtime_knl_GateProcess_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Instance_finalize__R, "xdc_runtime_knl_GateProcess_Instance_finalize")
__extern void xdc_runtime_knl_GateProcess_Instance_finalize__R( xdc_runtime_knl_GateProcess_Object* , int );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Handle__label__S, "xdc_runtime_knl_GateProcess_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_GateProcess_Module__startupDone__S, "xdc_runtime_knl_GateProcess_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_GateProcess_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Object__create__S, "xdc_runtime_knl_GateProcess_Object__create")
__extern xdc_Ptr xdc_runtime_knl_GateProcess_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar* __pa, xdc_SizeT __psz, xdc_runtime_Error_Block* __eb );

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Object__delete__S, "xdc_runtime_knl_GateProcess_Object__delete")
__extern xdc_Void xdc_runtime_knl_GateProcess_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Object__destruct__S, "xdc_runtime_knl_GateProcess_Object__destruct")
__extern xdc_Void xdc_runtime_knl_GateProcess_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Object__get__S, "xdc_runtime_knl_GateProcess_Object__get")
__extern xdc_Ptr xdc_runtime_knl_GateProcess_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Object__first__S, "xdc_runtime_knl_GateProcess_Object__first")
__extern xdc_Ptr xdc_runtime_knl_GateProcess_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Object__next__S, "xdc_runtime_knl_GateProcess_Object__next")
__extern xdc_Ptr xdc_runtime_knl_GateProcess_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Params__init__S, "xdc_runtime_knl_GateProcess_Params__init")
__extern xdc_Void xdc_runtime_knl_GateProcess_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_GateProcess_query__F, "xdc_runtime_knl_GateProcess_query")
__extern xdc_Bool xdc_runtime_knl_GateProcess_query__F( xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_GateProcess_query__R( xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_GateProcess_enter__F, "xdc_runtime_knl_GateProcess_enter")
__extern xdc_IArg xdc_runtime_knl_GateProcess_enter__F( xdc_runtime_knl_GateProcess_Object* __inst );
__extern xdc_IArg xdc_runtime_knl_GateProcess_enter__R( xdc_runtime_knl_GateProcess_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_GateProcess_leave__F, "xdc_runtime_knl_GateProcess_leave")
__extern xdc_Void xdc_runtime_knl_GateProcess_leave__F( xdc_runtime_knl_GateProcess_Object* __inst, xdc_IArg key );
__extern xdc_Void xdc_runtime_knl_GateProcess_leave__R( xdc_runtime_knl_GateProcess_Handle __inst, xdc_IArg key );
...
xdc__CODESECT(xdc_runtime_knl_GateProcess_getReferenceCount__F, "xdc_runtime_knl_GateProcess_getReferenceCount")
__extern xdc_Int xdc_runtime_knl_GateProcess_getReferenceCount__F( xdc_runtime_knl_GateProcess_Object* __inst, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_GateProcess_getReferenceCount__R( xdc_runtime_knl_GateProcess_Handle __inst, xdc_runtime_Error_Block* eb );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_GateProcess_enter_FxnT)(void*);
static inline xdc_runtime_knl_GateProcess_enter_FxnT xdc_runtime_knl_GateProcess_enter_fxnP( void )
{
    return (xdc_runtime_knl_GateProcess_enter_FxnT)xdc_runtime_knl_GateProcess_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_GateProcess_leave_FxnT)(void*, xdc_IArg);
static inline xdc_runtime_knl_GateProcess_leave_FxnT xdc_runtime_knl_GateProcess_leave_fxnP( void )
{
    return (xdc_runtime_knl_GateProcess_leave_FxnT)xdc_runtime_knl_GateProcess_leave; 
}

/* getReferenceCount_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_GateProcess_getReferenceCount_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_GateProcess_getReferenceCount_FxnT xdc_runtime_knl_GateProcess_getReferenceCount_fxnP( void )
{
    return (xdc_runtime_knl_GateProcess_getReferenceCount_FxnT)xdc_runtime_knl_GateProcess_getReferenceCount; 
}
...
static inline xdc_runtime_knl_GateProcess_Handle xdc_runtime_knl_GateProcess_Handle_downCast( xdc_runtime_IGateProvider_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&xdc_runtime_knl_GateProcess_Module__FXNS__C ? (xdc_runtime_knl_GateProcess_Handle)i : 0;
}
...
{
    return xdc_runtime_knl_GateProcess_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 xdc_runtime_knl_GateProcess_Module_getMask( void ) 
{
    return xdc_runtime_knl_GateProcess_Module__diagsMask__C != NULL ? *xdc_runtime_knl_GateProcess_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void xdc_runtime_knl_GateProcess_Module_setMask( xdc_Bits16 mask ) 
{
    if (xdc_runtime_knl_GateProcess_Module__diagsMask__C != NULL) *xdc_runtime_knl_GateProcess_Module__diagsMask__C = mask;
}
...
{
    if (prms) {
        xdc_runtime_knl_GateProcess_Params__init__S(prms, 0, sizeof(xdc_runtime_knl_GateProcess_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
{
    if (dst) {
        xdc_runtime_knl_GateProcess_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_GateProcess_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline xdc_runtime_knl_GateProcess_Handle xdc_runtime_knl_GateProcess_create( const xdc_runtime_knl_GateProcess_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_GateProcess_Handle)xdc_runtime_knl_GateProcess_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateProcess_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_GateProcess_construct( xdc_runtime_knl_GateProcess_Struct* __obj, const xdc_runtime_knl_GateProcess_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_GateProcess_Object__create__S(__obj, sizeof (xdc_runtime_knl_GateProcess_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateProcess_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_GateProcess_delete( xdc_runtime_knl_GateProcess_Handle* instp )
{
    xdc_runtime_knl_GateProcess_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_GateProcess_destruct( xdc_runtime_knl_GateProcess_Struct* obj )
{
    xdc_runtime_knl_GateProcess_Object__destruct__S(obj);
}
...
#define GateProcess_enter_fxnP xdc_runtime_knl_GateProcess_enter_fxnP
#define GateProcess_enter_FxnT xdc_runtime_knl_GateProcess_enter_FxnT
#define GateProcess_leave xdc_runtime_knl_GateProcess_leave
#define GateProcess_leave_fxnP xdc_runtime_knl_GateProcess_leave_fxnP
#define GateProcess_leave_FxnT xdc_runtime_knl_GateProcess_leave_FxnT
#define GateProcess_getReferenceCount xdc_runtime_knl_GateProcess_getReferenceCount
#define GateProcess_getReferenceCount_fxnP xdc_runtime_knl_GateProcess_getReferenceCount_fxnP
#define GateProcess_getReferenceCount_FxnT xdc_runtime_knl_GateProcess_getReferenceCount_FxnT
