...
#define xdc_runtime_knl_IGateProcessSupport___VERS 150
...
/* create */
static inline xdc_runtime_knl_IGateProcessSupport_Handle xdc_runtime_knl_IGateProcessSupport_create( xdc_runtime_knl_IGateProcessSupport_Module __mod, const xdc_runtime_knl_IGateProcessSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_IGateProcessSupport_Handle) __mod->__sysp->__create(0, 0, 0, (const xdc_UChar*)__prms, sizeof (xdc_runtime_knl_IGateProcessSupport_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_IGateProcessSupport_delete( xdc_runtime_knl_IGateProcessSupport_Handle* instp )
{
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_IGateProcessSupport_enter_FxnT)(void*);
...
/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_IGateProcessSupport_leave_FxnT)(void*, xdc_IArg);
...
typedef xdc_Int (*xdc_runtime_knl_IGateProcessSupport_getReferenceCount_FxnT)(void*, xdc_runtime_Error_Block*);
