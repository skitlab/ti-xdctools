...
#define xdc_runtime_knl_IThreadSupport___VERS 150
...
/* create */
static inline xdc_runtime_knl_IThreadSupport_Handle xdc_runtime_knl_IThreadSupport_create( xdc_runtime_knl_IThreadSupport_Module __mod, xdc_runtime_knl_IThreadSupport_RunFxn fxn, const xdc_runtime_knl_IThreadSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_IThreadSupport_Args__create __args;
    __args.fxn = fxn;
    return (xdc_runtime_knl_IThreadSupport_Handle) __mod->__sysp->__create(0, 0, &__args, (const xdc_UChar*)__prms, sizeof (xdc_runtime_knl_IThreadSupport_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_IThreadSupport_delete( xdc_runtime_knl_IThreadSupport_Handle* instp )
{
...
/* join_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_join_FxnT)(void*, xdc_runtime_Error_Block*);
...
typedef xdc_runtime_knl_IThreadSupport_Priority (*xdc_runtime_knl_IThreadSupport_getPriority_FxnT)(void*, xdc_runtime_Error_Block*);
...
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_setPriority_FxnT)(void*, xdc_runtime_knl_IThreadSupport_Priority, xdc_runtime_Error_Block*);
...
typedef xdc_Int (*xdc_runtime_knl_IThreadSupport_getOsPriority_FxnT)(void*, xdc_runtime_Error_Block*);
...
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_setOsPriority_FxnT)(void*, xdc_Int, xdc_runtime_Error_Block*);
...
typedef xdc_Ptr (*xdc_runtime_knl_IThreadSupport_getOsHandle_FxnT)(void*);
...
/* getTls_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_knl_IThreadSupport_getTls_FxnT)(void*);
...
/* setTls_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_IThreadSupport_setTls_FxnT)(void*, xdc_Ptr);
...
/* stat_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_stat_FxnT)(void*, xdc_runtime_knl_IThreadSupport_Stat*, xdc_runtime_Error_Block*);
