...
#define xdc_runtime_knl_ISemThreadSupport___VERS 150
...
/* create */
static inline xdc_runtime_knl_ISemThreadSupport_Handle xdc_runtime_knl_ISemThreadSupport_create( xdc_runtime_knl_ISemThreadSupport_Module __mod, xdc_Int count, const xdc_runtime_knl_ISemThreadSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_ISemThreadSupport_Args__create __args;
    __args.count = count;
    return (xdc_runtime_knl_ISemThreadSupport_Handle) __mod->__sysp->__create(0, 0, &__args, (const xdc_UChar*)__prms, sizeof (xdc_runtime_knl_ISemThreadSupport_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_ISemThreadSupport_delete( xdc_runtime_knl_ISemThreadSupport_Handle* instp )
{
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemThreadSupport_pend_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
...
/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemThreadSupport_post_FxnT)(void*, xdc_runtime_Error_Block*);
