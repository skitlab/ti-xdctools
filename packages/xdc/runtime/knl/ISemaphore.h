...
#define xdc_runtime_knl_ISemaphore___VERS 150
...
/* delete */
static inline void xdc_runtime_knl_ISemaphore_delete( xdc_runtime_knl_ISemaphore_Handle* instp )
{
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemaphore_pend_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
...
/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemaphore_post_FxnT)(void*, xdc_runtime_Error_Block*);
