...
#define xdc_runtime_knl_SyncNull___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Instance_init__F, "xdc_runtime_knl_SyncNull_Instance_init")
__extern void xdc_runtime_knl_SyncNull_Instance_init__F( xdc_runtime_knl_SyncNull_Object*, const xdc_runtime_knl_SyncNull_Params* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Instance_init__R, "xdc_runtime_knl_SyncNull_Instance_init")
__extern void xdc_runtime_knl_SyncNull_Instance_init__R( xdc_runtime_knl_SyncNull_Object*, const xdc_runtime_knl_SyncNull_Params* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Handle__label__S, "xdc_runtime_knl_SyncNull_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_knl_SyncNull_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Module__startupDone__S, "xdc_runtime_knl_SyncNull_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_SyncNull_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Object__create__S, "xdc_runtime_knl_SyncNull_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Object__delete__S, "xdc_runtime_knl_SyncNull_Object__delete")
__extern xdc_Void xdc_runtime_knl_SyncNull_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Object__destruct__S, "xdc_runtime_knl_SyncNull_Object__destruct")
__extern xdc_Void xdc_runtime_knl_SyncNull_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Object__get__S, "xdc_runtime_knl_SyncNull_Object__get")
__extern xdc_Ptr xdc_runtime_knl_SyncNull_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Object__first__S, "xdc_runtime_knl_SyncNull_Object__first")
__extern xdc_Ptr xdc_runtime_knl_SyncNull_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Object__next__S, "xdc_runtime_knl_SyncNull_Object__next")
__extern xdc_Ptr xdc_runtime_knl_SyncNull_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_SyncNull_Params__init__S, "xdc_runtime_knl_SyncNull_Params__init")
__extern xdc_Void xdc_runtime_knl_SyncNull_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_SyncNull_query__F, "xdc_runtime_knl_SyncNull_query")
__extern xdc_Bool xdc_runtime_knl_SyncNull_query__F( xdc_runtime_knl_SyncNull_Object* __inst, xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_SyncNull_query__R( xdc_runtime_knl_SyncNull_Handle __inst, xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_SyncNull_signal__F, "xdc_runtime_knl_SyncNull_signal")
__extern xdc_Void xdc_runtime_knl_SyncNull_signal__F( xdc_runtime_knl_SyncNull_Object* __inst );
__extern xdc_Void xdc_runtime_knl_SyncNull_signal__R( xdc_runtime_knl_SyncNull_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_SyncNull_wait__F, "xdc_runtime_knl_SyncNull_wait")
__extern xdc_Int xdc_runtime_knl_SyncNull_wait__F( xdc_runtime_knl_SyncNull_Object* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_SyncNull_wait__R( xdc_runtime_knl_SyncNull_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_SyncNull_query_FxnT)(void*, xdc_Int);
static inline xdc_runtime_knl_SyncNull_query_FxnT xdc_runtime_knl_SyncNull_query_fxnP( void )
{
    return (xdc_runtime_knl_SyncNull_query_FxnT)xdc_runtime_knl_SyncNull_query; 
}

/* signal_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_SyncNull_signal_FxnT)(void*);
static inline xdc_runtime_knl_SyncNull_signal_FxnT xdc_runtime_knl_SyncNull_signal_fxnP( void )
{
    return (xdc_runtime_knl_SyncNull_signal_FxnT)xdc_runtime_knl_SyncNull_signal; 
}

/* wait_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_SyncNull_wait_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SyncNull_wait_FxnT xdc_runtime_knl_SyncNull_wait_fxnP( void )
{
    return (xdc_runtime_knl_SyncNull_wait_FxnT)xdc_runtime_knl_SyncNull_wait; 
}
...
{
    if (dst) {
        xdc_runtime_knl_SyncNull_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_SyncNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline xdc_runtime_knl_SyncNull_Handle xdc_runtime_knl_SyncNull_create( const xdc_runtime_knl_SyncNull_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_SyncNull_Handle)xdc_runtime_knl_SyncNull_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SyncNull_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_SyncNull_construct( xdc_runtime_knl_SyncNull_Struct* __obj, const xdc_runtime_knl_SyncNull_Params* __prms )
{
    xdc_runtime_knl_SyncNull_Object__create__S(__obj, sizeof (xdc_runtime_knl_SyncNull_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SyncNull_Params), NULL);
}

/* delete */
static inline void xdc_runtime_knl_SyncNull_delete( xdc_runtime_knl_SyncNull_Handle* instp )
{
    xdc_runtime_knl_SyncNull_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_SyncNull_destruct( xdc_runtime_knl_SyncNull_Struct* obj )
{
    xdc_runtime_knl_SyncNull_Object__destruct__S(obj);
}
...
#define SyncNull_query_fxnP xdc_runtime_knl_SyncNull_query_fxnP
#define SyncNull_query_FxnT xdc_runtime_knl_SyncNull_query_FxnT
#define SyncNull_signal xdc_runtime_knl_SyncNull_signal
#define SyncNull_signal_fxnP xdc_runtime_knl_SyncNull_signal_fxnP
#define SyncNull_signal_FxnT xdc_runtime_knl_SyncNull_signal_FxnT
#define SyncNull_wait xdc_runtime_knl_SyncNull_wait
#define SyncNull_wait_fxnP xdc_runtime_knl_SyncNull_wait_fxnP
#define SyncNull_wait_FxnT xdc_runtime_knl_SyncNull_wait_FxnT
