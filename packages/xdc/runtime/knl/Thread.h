...
#define xdc_runtime_knl_Thread___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_Thread_Instance_init__F, "xdc_runtime_knl_Thread_Instance_init")
__extern int xdc_runtime_knl_Thread_Instance_init__F( xdc_runtime_knl_Thread_Object*, xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(xdc_runtime_knl_Thread_Instance_finalize__F, "xdc_runtime_knl_Thread_Instance_finalize")
__extern void xdc_runtime_knl_Thread_Instance_finalize__F( xdc_runtime_knl_Thread_Object* , int );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_Thread_Instance_init__R, "xdc_runtime_knl_Thread_Instance_init")
__extern int xdc_runtime_knl_Thread_Instance_init__R( xdc_runtime_knl_Thread_Object*, xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(xdc_runtime_knl_Thread_Instance_finalize__R, "xdc_runtime_knl_Thread_Instance_finalize")
__extern void xdc_runtime_knl_Thread_Instance_finalize__R( xdc_runtime_knl_Thread_Object* , int );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Handle__label__S, "xdc_runtime_knl_Thread_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_knl_Thread_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Module__startupDone__S, "xdc_runtime_knl_Thread_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_Thread_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Object__create__S, "xdc_runtime_knl_Thread_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Object__delete__S, "xdc_runtime_knl_Thread_Object__delete")
__extern xdc_Void xdc_runtime_knl_Thread_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Object__destruct__S, "xdc_runtime_knl_Thread_Object__destruct")
__extern xdc_Void xdc_runtime_knl_Thread_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Object__get__S, "xdc_runtime_knl_Thread_Object__get")
__extern xdc_Ptr xdc_runtime_knl_Thread_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Object__first__S, "xdc_runtime_knl_Thread_Object__first")
__extern xdc_Ptr xdc_runtime_knl_Thread_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Object__next__S, "xdc_runtime_knl_Thread_Object__next")
__extern xdc_Ptr xdc_runtime_knl_Thread_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_Thread_Params__init__S, "xdc_runtime_knl_Thread_Params__init")
__extern xdc_Void xdc_runtime_knl_Thread_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_Thread_self__F, "xdc_runtime_knl_Thread_self")
__extern xdc_runtime_knl_Thread_Handle xdc_runtime_knl_Thread_self__F( xdc_runtime_Error_Block* eb );
__extern xdc_runtime_knl_Thread_Handle xdc_runtime_knl_Thread_self__R( xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_start__F, "xdc_runtime_knl_Thread_start")
__extern xdc_Bool xdc_runtime_knl_Thread_start__F( xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_start__R( xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_yield__F, "xdc_runtime_knl_Thread_yield")
__extern xdc_Bool xdc_runtime_knl_Thread_yield__F( xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_yield__R( xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_compareOsPriorities__F, "xdc_runtime_knl_Thread_compareOsPriorities")
__extern xdc_Int xdc_runtime_knl_Thread_compareOsPriorities__F( xdc_Int p1, xdc_Int p2, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_Thread_compareOsPriorities__R( xdc_Int p1, xdc_Int p2, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_sleep__F, "xdc_runtime_knl_Thread_sleep")
__extern xdc_Bool xdc_runtime_knl_Thread_sleep__F( xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_sleep__R( xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_join__F, "xdc_runtime_knl_Thread_join")
__extern xdc_Bool xdc_runtime_knl_Thread_join__F( xdc_runtime_knl_Thread_Object* __inst, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_join__R( xdc_runtime_knl_Thread_Handle __inst, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_getPriority__F, "xdc_runtime_knl_Thread_getPriority")
__extern xdc_runtime_knl_Thread_Priority xdc_runtime_knl_Thread_getPriority__F( xdc_runtime_knl_Thread_Object* __inst, xdc_runtime_Error_Block* eb );
__extern xdc_runtime_knl_Thread_Priority xdc_runtime_knl_Thread_getPriority__R( xdc_runtime_knl_Thread_Handle __inst, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_setPriority__F, "xdc_runtime_knl_Thread_setPriority")
__extern xdc_Bool xdc_runtime_knl_Thread_setPriority__F( xdc_runtime_knl_Thread_Object* __inst, xdc_runtime_knl_Thread_Priority newPri, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_setPriority__R( xdc_runtime_knl_Thread_Handle __inst, xdc_runtime_knl_Thread_Priority newPri, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_getOsPriority__F, "xdc_runtime_knl_Thread_getOsPriority")
__extern xdc_Int xdc_runtime_knl_Thread_getOsPriority__F( xdc_runtime_knl_Thread_Object* __inst, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_Thread_getOsPriority__R( xdc_runtime_knl_Thread_Handle __inst, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_setOsPriority__F, "xdc_runtime_knl_Thread_setOsPriority")
__extern xdc_Bool xdc_runtime_knl_Thread_setOsPriority__F( xdc_runtime_knl_Thread_Object* __inst, xdc_Int newPri, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_setOsPriority__R( xdc_runtime_knl_Thread_Handle __inst, xdc_Int newPri, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Thread_getOsHandle__F, "xdc_runtime_knl_Thread_getOsHandle")
__extern xdc_Ptr xdc_runtime_knl_Thread_getOsHandle__F( xdc_runtime_knl_Thread_Object* __inst );
__extern xdc_Ptr xdc_runtime_knl_Thread_getOsHandle__R( xdc_runtime_knl_Thread_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_Thread_getTls__F, "xdc_runtime_knl_Thread_getTls")
__extern xdc_Ptr xdc_runtime_knl_Thread_getTls__F( xdc_runtime_knl_Thread_Object* __inst );
__extern xdc_Ptr xdc_runtime_knl_Thread_getTls__R( xdc_runtime_knl_Thread_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_Thread_setTls__F, "xdc_runtime_knl_Thread_setTls")
__extern xdc_Void xdc_runtime_knl_Thread_setTls__F( xdc_runtime_knl_Thread_Object* __inst, xdc_Ptr tls );
__extern xdc_Void xdc_runtime_knl_Thread_setTls__R( xdc_runtime_knl_Thread_Handle __inst, xdc_Ptr tls );
...
xdc__CODESECT(xdc_runtime_knl_Thread_stat__F, "xdc_runtime_knl_Thread_stat")
__extern xdc_Bool xdc_runtime_knl_Thread_stat__F( xdc_runtime_knl_Thread_Object* __inst, xdc_runtime_knl_Thread_Stat* buf, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Thread_stat__R( xdc_runtime_knl_Thread_Handle __inst, xdc_runtime_knl_Thread_Stat* buf, xdc_runtime_Error_Block* eb );
...
/* join_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_join_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_join_FxnT xdc_runtime_knl_Thread_join_fxnP( void )
{
    return (xdc_runtime_knl_Thread_join_FxnT)xdc_runtime_knl_Thread_join; 
}

/* getPriority_{FxnT,fxnP} */
typedef xdc_runtime_knl_Thread_Priority (*xdc_runtime_knl_Thread_getPriority_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_getPriority_FxnT xdc_runtime_knl_Thread_getPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_getPriority_FxnT)xdc_runtime_knl_Thread_getPriority; 
}

/* setPriority_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_setPriority_FxnT)(void*, xdc_runtime_knl_Thread_Priority, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_setPriority_FxnT xdc_runtime_knl_Thread_setPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_setPriority_FxnT)xdc_runtime_knl_Thread_setPriority; 
}

/* getOsPriority_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_Thread_getOsPriority_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_getOsPriority_FxnT xdc_runtime_knl_Thread_getOsPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_getOsPriority_FxnT)xdc_runtime_knl_Thread_getOsPriority; 
}

/* setOsPriority_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_setOsPriority_FxnT)(void*, xdc_Int, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_setOsPriority_FxnT xdc_runtime_knl_Thread_setOsPriority_fxnP( void )
{
    return (xdc_runtime_knl_Thread_setOsPriority_FxnT)xdc_runtime_knl_Thread_setOsPriority; 
}

/* getOsHandle_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_knl_Thread_getOsHandle_FxnT)(void*);
static inline xdc_runtime_knl_Thread_getOsHandle_FxnT xdc_runtime_knl_Thread_getOsHandle_fxnP( void )
{
    return (xdc_runtime_knl_Thread_getOsHandle_FxnT)xdc_runtime_knl_Thread_getOsHandle; 
}

/* getTls_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_knl_Thread_getTls_FxnT)(void*);
static inline xdc_runtime_knl_Thread_getTls_FxnT xdc_runtime_knl_Thread_getTls_fxnP( void )
{
    return (xdc_runtime_knl_Thread_getTls_FxnT)xdc_runtime_knl_Thread_getTls; 
}

/* setTls_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_Thread_setTls_FxnT)(void*, xdc_Ptr);
static inline xdc_runtime_knl_Thread_setTls_FxnT xdc_runtime_knl_Thread_setTls_fxnP( void )
{
    return (xdc_runtime_knl_Thread_setTls_FxnT)xdc_runtime_knl_Thread_setTls; 
}

/* stat_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_Thread_stat_FxnT)(void*, xdc_runtime_knl_Thread_Stat*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_Thread_stat_FxnT xdc_runtime_knl_Thread_stat_fxnP( void )
{
    return (xdc_runtime_knl_Thread_stat_FxnT)xdc_runtime_knl_Thread_stat; 
}
...
{
    if (dst) {
        xdc_runtime_knl_Thread_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_Thread_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String xdc_runtime_knl_Thread_Handle_name( xdc_runtime_knl_Thread_Handle inst )
{
...
/* create */
static inline xdc_runtime_knl_Thread_Handle xdc_runtime_knl_Thread_create( xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_Thread_Args__create __args;
    __args.fxn = fxn;
    return (xdc_runtime_knl_Thread_Handle)xdc_runtime_knl_Thread_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_Thread_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_Thread_construct( xdc_runtime_knl_Thread_Struct* __obj, xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_Thread_Args__create __args;
    __args.fxn = fxn;
    xdc_runtime_knl_Thread_Object__create__S(__obj, sizeof (xdc_runtime_knl_Thread_Struct), &__args, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_Thread_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_Thread_delete( xdc_runtime_knl_Thread_Handle* instp )
{
    xdc_runtime_knl_Thread_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_Thread_destruct( xdc_runtime_knl_Thread_Struct* obj )
{
    xdc_runtime_knl_Thread_Object__destruct__S(obj);
}
...
#define Thread_join_fxnP xdc_runtime_knl_Thread_join_fxnP
#define Thread_join_FxnT xdc_runtime_knl_Thread_join_FxnT
#define Thread_getPriority xdc_runtime_knl_Thread_getPriority
#define Thread_getPriority_fxnP xdc_runtime_knl_Thread_getPriority_fxnP
#define Thread_getPriority_FxnT xdc_runtime_knl_Thread_getPriority_FxnT
#define Thread_setPriority xdc_runtime_knl_Thread_setPriority
#define Thread_setPriority_fxnP xdc_runtime_knl_Thread_setPriority_fxnP
#define Thread_setPriority_FxnT xdc_runtime_knl_Thread_setPriority_FxnT
#define Thread_getOsPriority xdc_runtime_knl_Thread_getOsPriority
#define Thread_getOsPriority_fxnP xdc_runtime_knl_Thread_getOsPriority_fxnP
#define Thread_getOsPriority_FxnT xdc_runtime_knl_Thread_getOsPriority_FxnT
#define Thread_setOsPriority xdc_runtime_knl_Thread_setOsPriority
#define Thread_setOsPriority_fxnP xdc_runtime_knl_Thread_setOsPriority_fxnP
#define Thread_setOsPriority_FxnT xdc_runtime_knl_Thread_setOsPriority_FxnT
#define Thread_getOsHandle xdc_runtime_knl_Thread_getOsHandle
#define Thread_getOsHandle_fxnP xdc_runtime_knl_Thread_getOsHandle_fxnP
#define Thread_getOsHandle_FxnT xdc_runtime_knl_Thread_getOsHandle_FxnT
#define Thread_getTls xdc_runtime_knl_Thread_getTls
#define Thread_getTls_fxnP xdc_runtime_knl_Thread_getTls_fxnP
#define Thread_getTls_FxnT xdc_runtime_knl_Thread_getTls_FxnT
#define Thread_setTls xdc_runtime_knl_Thread_setTls
#define Thread_setTls_fxnP xdc_runtime_knl_Thread_setTls_fxnP
#define Thread_setTls_FxnT xdc_runtime_knl_Thread_setTls_FxnT
#define Thread_stat xdc_runtime_knl_Thread_stat
#define Thread_stat_fxnP xdc_runtime_knl_Thread_stat_fxnP
#define Thread_stat_FxnT xdc_runtime_knl_Thread_stat_FxnT
