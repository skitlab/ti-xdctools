...
#define xdc_runtime_knl_GateH___VERS 150
...
xdc__CODESECT(xdc_runtime_knl_GateH_Module__startupDone__S, "xdc_runtime_knl_GateH_Module__startupDone")
...
xdc__CODESECT(xdc_runtime_knl_GateH_enter__F, "xdc_runtime_knl_GateH_enter")
__extern xdc_IArg xdc_runtime_knl_GateH_enter__F( xdc_runtime_IGateProvider_Handle hdl );
__extern xdc_IArg xdc_runtime_knl_GateH_enter__R( xdc_runtime_IGateProvider_Handle hdl );
...
xdc__CODESECT(xdc_runtime_knl_GateH_leave__F, "xdc_runtime_knl_GateH_leave")
__extern xdc_Void xdc_runtime_knl_GateH_leave__F( xdc_runtime_IGateProvider_Handle hdl, xdc_IArg key );
__extern xdc_Void xdc_runtime_knl_GateH_leave__R( xdc_runtime_IGateProvider_Handle hdl, xdc_IArg key );
