...
#define xdc_runtime_knl_SemThread___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_SemThread_Instance_init__F, "xdc_runtime_knl_SemThread_Instance_init")
__extern int xdc_runtime_knl_SemThread_Instance_init__F( xdc_runtime_knl_SemThread_Object*, xdc_Int count, const xdc_runtime_knl_SemThread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(xdc_runtime_knl_SemThread_Instance_finalize__F, "xdc_runtime_knl_SemThread_Instance_finalize")
__extern void xdc_runtime_knl_SemThread_Instance_finalize__F( xdc_runtime_knl_SemThread_Object* , int );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_SemThread_Instance_init__R, "xdc_runtime_knl_SemThread_Instance_init")
__extern int xdc_runtime_knl_SemThread_Instance_init__R( xdc_runtime_knl_SemThread_Object*, xdc_Int count, const xdc_runtime_knl_SemThread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(xdc_runtime_knl_SemThread_Instance_finalize__R, "xdc_runtime_knl_SemThread_Instance_finalize")
__extern void xdc_runtime_knl_SemThread_Instance_finalize__R( xdc_runtime_knl_SemThread_Object* , int );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Handle__label__S, "xdc_runtime_knl_SemThread_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_knl_SemThread_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Module__startupDone__S, "xdc_runtime_knl_SemThread_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_SemThread_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Object__create__S, "xdc_runtime_knl_SemThread_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Object__delete__S, "xdc_runtime_knl_SemThread_Object__delete")
__extern xdc_Void xdc_runtime_knl_SemThread_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Object__destruct__S, "xdc_runtime_knl_SemThread_Object__destruct")
__extern xdc_Void xdc_runtime_knl_SemThread_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Object__get__S, "xdc_runtime_knl_SemThread_Object__get")
__extern xdc_Ptr xdc_runtime_knl_SemThread_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Object__first__S, "xdc_runtime_knl_SemThread_Object__first")
__extern xdc_Ptr xdc_runtime_knl_SemThread_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Object__next__S, "xdc_runtime_knl_SemThread_Object__next")
__extern xdc_Ptr xdc_runtime_knl_SemThread_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_SemThread_Params__init__S, "xdc_runtime_knl_SemThread_Params__init")
__extern xdc_Void xdc_runtime_knl_SemThread_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_SemThread_pend__F, "xdc_runtime_knl_SemThread_pend")
__extern xdc_Int xdc_runtime_knl_SemThread_pend__F( xdc_runtime_knl_SemThread_Object* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_SemThread_pend__R( xdc_runtime_knl_SemThread_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_SemThread_post__F, "xdc_runtime_knl_SemThread_post")
__extern xdc_Bool xdc_runtime_knl_SemThread_post__F( xdc_runtime_knl_SemThread_Object* __inst, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_SemThread_post__R( xdc_runtime_knl_SemThread_Handle __inst, xdc_runtime_Error_Block* eb );
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_SemThread_pend_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SemThread_pend_FxnT xdc_runtime_knl_SemThread_pend_fxnP( void )
{
    return (xdc_runtime_knl_SemThread_pend_FxnT)xdc_runtime_knl_SemThread_pend; 
}

/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_SemThread_post_FxnT)(void*, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SemThread_post_FxnT xdc_runtime_knl_SemThread_post_fxnP( void )
{
    return (xdc_runtime_knl_SemThread_post_FxnT)xdc_runtime_knl_SemThread_post; 
}
...
{
    if (dst) {
        xdc_runtime_knl_SemThread_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_SemThread_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline xdc_runtime_knl_SemThread_Handle xdc_runtime_knl_SemThread_create( xdc_Int count, const xdc_runtime_knl_SemThread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_SemThread_Args__create __args;
    __args.count = count;
    return (xdc_runtime_knl_SemThread_Handle)xdc_runtime_knl_SemThread_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SemThread_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_SemThread_construct( xdc_runtime_knl_SemThread_Struct* __obj, xdc_Int count, const xdc_runtime_knl_SemThread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_SemThread_Args__create __args;
    __args.count = count;
    xdc_runtime_knl_SemThread_Object__create__S(__obj, sizeof (xdc_runtime_knl_SemThread_Struct), &__args, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SemThread_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_SemThread_delete( xdc_runtime_knl_SemThread_Handle* instp )
{
    xdc_runtime_knl_SemThread_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_SemThread_destruct( xdc_runtime_knl_SemThread_Struct* obj )
{
    xdc_runtime_knl_SemThread_Object__destruct__S(obj);
}
...
#define SemThread_pend_fxnP xdc_runtime_knl_SemThread_pend_fxnP
#define SemThread_pend_FxnT xdc_runtime_knl_SemThread_pend_FxnT
#define SemThread_post xdc_runtime_knl_SemThread_post
#define SemThread_post_fxnP xdc_runtime_knl_SemThread_post_fxnP
#define SemThread_post_FxnT xdc_runtime_knl_SemThread_post_FxnT
