...
#define xdc_runtime_knl_GateThreadSupportNull___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Instance_init__F, "xdc_runtime_knl_GateThreadSupportNull_Instance_init")
__extern void xdc_runtime_knl_GateThreadSupportNull_Instance_init__F( xdc_runtime_knl_GateThreadSupportNull_Object*, const xdc_runtime_knl_GateThreadSupportNull_Params* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Instance_init__R, "xdc_runtime_knl_GateThreadSupportNull_Instance_init")
__extern void xdc_runtime_knl_GateThreadSupportNull_Instance_init__R( xdc_runtime_knl_GateThreadSupportNull_Object*, const xdc_runtime_knl_GateThreadSupportNull_Params* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Handle__label__S, "xdc_runtime_knl_GateThreadSupportNull_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Module__startupDone__S, "xdc_runtime_knl_GateThreadSupportNull_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_GateThreadSupportNull_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Object__create__S, "xdc_runtime_knl_GateThreadSupportNull_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Object__delete__S, "xdc_runtime_knl_GateThreadSupportNull_Object__delete")
__extern xdc_Void xdc_runtime_knl_GateThreadSupportNull_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Object__destruct__S, "xdc_runtime_knl_GateThreadSupportNull_Object__destruct")
__extern xdc_Void xdc_runtime_knl_GateThreadSupportNull_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Object__get__S, "xdc_runtime_knl_GateThreadSupportNull_Object__get")
__extern xdc_Ptr xdc_runtime_knl_GateThreadSupportNull_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Object__first__S, "xdc_runtime_knl_GateThreadSupportNull_Object__first")
__extern xdc_Ptr xdc_runtime_knl_GateThreadSupportNull_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Object__next__S, "xdc_runtime_knl_GateThreadSupportNull_Object__next")
__extern xdc_Ptr xdc_runtime_knl_GateThreadSupportNull_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_Params__init__S, "xdc_runtime_knl_GateThreadSupportNull_Params__init")
__extern xdc_Void xdc_runtime_knl_GateThreadSupportNull_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_query__F, "xdc_runtime_knl_GateThreadSupportNull_query")
__extern xdc_Bool xdc_runtime_knl_GateThreadSupportNull_query__F( xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_GateThreadSupportNull_query__R( xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_enter__F, "xdc_runtime_knl_GateThreadSupportNull_enter")
__extern xdc_IArg xdc_runtime_knl_GateThreadSupportNull_enter__F( xdc_runtime_knl_GateThreadSupportNull_Object* __inst );
__extern xdc_IArg xdc_runtime_knl_GateThreadSupportNull_enter__R( xdc_runtime_knl_GateThreadSupportNull_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_GateThreadSupportNull_leave__F, "xdc_runtime_knl_GateThreadSupportNull_leave")
__extern xdc_Void xdc_runtime_knl_GateThreadSupportNull_leave__F( xdc_runtime_knl_GateThreadSupportNull_Object* __inst, xdc_IArg key );
__extern xdc_Void xdc_runtime_knl_GateThreadSupportNull_leave__R( xdc_runtime_knl_GateThreadSupportNull_Handle __inst, xdc_IArg key );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_GateThreadSupportNull_enter_FxnT)(void*);
static inline xdc_runtime_knl_GateThreadSupportNull_enter_FxnT xdc_runtime_knl_GateThreadSupportNull_enter_fxnP( void )
{
    return (xdc_runtime_knl_GateThreadSupportNull_enter_FxnT)xdc_runtime_knl_GateThreadSupportNull_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_GateThreadSupportNull_leave_FxnT)(void*, xdc_IArg);
static inline xdc_runtime_knl_GateThreadSupportNull_leave_FxnT xdc_runtime_knl_GateThreadSupportNull_leave_fxnP( void )
{
    return (xdc_runtime_knl_GateThreadSupportNull_leave_FxnT)xdc_runtime_knl_GateThreadSupportNull_leave; 
}
...
{
    if (dst) {
        xdc_runtime_knl_GateThreadSupportNull_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_GateThreadSupportNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String xdc_runtime_knl_GateThreadSupportNull_Handle_name( xdc_runtime_knl_GateThreadSupportNull_Handle inst )
{
...
/* create */
static inline xdc_runtime_knl_GateThreadSupportNull_Handle xdc_runtime_knl_GateThreadSupportNull_create( const xdc_runtime_knl_GateThreadSupportNull_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_GateThreadSupportNull_Handle)xdc_runtime_knl_GateThreadSupportNull_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateThreadSupportNull_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_GateThreadSupportNull_construct( xdc_runtime_knl_GateThreadSupportNull_Struct* __obj, const xdc_runtime_knl_GateThreadSupportNull_Params* __prms )
{
    xdc_runtime_knl_GateThreadSupportNull_Object__create__S(__obj, sizeof (xdc_runtime_knl_GateThreadSupportNull_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateThreadSupportNull_Params), NULL);
}

/* delete */
static inline void xdc_runtime_knl_GateThreadSupportNull_delete( xdc_runtime_knl_GateThreadSupportNull_Handle* instp )
{
    xdc_runtime_knl_GateThreadSupportNull_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_GateThreadSupportNull_destruct( xdc_runtime_knl_GateThreadSupportNull_Struct* obj )
{
    xdc_runtime_knl_GateThreadSupportNull_Object__destruct__S(obj);
}
...
#define GateThreadSupportNull_enter_fxnP xdc_runtime_knl_GateThreadSupportNull_enter_fxnP
#define GateThreadSupportNull_enter_FxnT xdc_runtime_knl_GateThreadSupportNull_enter_FxnT
#define GateThreadSupportNull_leave xdc_runtime_knl_GateThreadSupportNull_leave
#define GateThreadSupportNull_leave_fxnP xdc_runtime_knl_GateThreadSupportNull_leave_fxnP
#define GateThreadSupportNull_leave_FxnT xdc_runtime_knl_GateThreadSupportNull_leave_FxnT
