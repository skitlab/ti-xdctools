...
#define xdc_runtime_knl_SyncSemThread___VERS 150
...
typedef xdc_Bool (*CT__xdc_runtime_knl_SyncSemThread_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__xdc_runtime_knl_SyncSemThread_Module__startupDoneFxn xdc_runtime_knl_SyncSemThread_Module__startupDoneFxn__C;
...
struct xdc_runtime_knl_SyncSemThread_Struct {
    ...
    xdc_runtime_knl_SemThread_Handle __f0;
...
struct xdc_runtime_knl_SyncSemThread_Fxns__ {
    ...
    xdc_Bool (*query)(xdc_runtime_knl_SyncSemThread_Handle, xdc_Int);
    xdc_Void (*signal)(xdc_runtime_knl_SyncSemThread_Handle);
    xdc_Int (*wait)(xdc_runtime_knl_SyncSemThread_Handle, xdc_UInt, xdc_runtime_Error_Block*);
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Instance_init__F, "xdc_runtime_knl_SyncSemThread_Instance_init")
__extern int xdc_runtime_knl_SyncSemThread_Instance_init__F( xdc_runtime_knl_SyncSemThread_Object*, const xdc_runtime_knl_SyncSemThread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Instance_finalize__F, "xdc_runtime_knl_SyncSemThread_Instance_finalize")
__extern void xdc_runtime_knl_SyncSemThread_Instance_finalize__F( xdc_runtime_knl_SyncSemThread_Object* , int );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Instance_init__R, "xdc_runtime_knl_SyncSemThread_Instance_init")
__extern int xdc_runtime_knl_SyncSemThread_Instance_init__R( xdc_runtime_knl_SyncSemThread_Object*, const xdc_runtime_knl_SyncSemThread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Instance_finalize__R, "xdc_runtime_knl_SyncSemThread_Instance_finalize")
__extern void xdc_runtime_knl_SyncSemThread_Instance_finalize__R( xdc_runtime_knl_SyncSemThread_Object* , int );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Handle__label__S, "xdc_runtime_knl_SyncSemThread_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Module__startupDone__S, "xdc_runtime_knl_SyncSemThread_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_SyncSemThread_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__create__S, "xdc_runtime_knl_SyncSemThread_Object__create")
__extern xdc_Ptr xdc_runtime_knl_SyncSemThread_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar* __pa, xdc_SizeT __psz, xdc_runtime_Error_Block* __eb );

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__delete__S, "xdc_runtime_knl_SyncSemThread_Object__delete")
__extern xdc_Void xdc_runtime_knl_SyncSemThread_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__destruct__S, "xdc_runtime_knl_SyncSemThread_Object__destruct")
__extern xdc_Void xdc_runtime_knl_SyncSemThread_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__get__S, "xdc_runtime_knl_SyncSemThread_Object__get")
__extern xdc_Ptr xdc_runtime_knl_SyncSemThread_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__first__S, "xdc_runtime_knl_SyncSemThread_Object__first")
__extern xdc_Ptr xdc_runtime_knl_SyncSemThread_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__next__S, "xdc_runtime_knl_SyncSemThread_Object__next")
__extern xdc_Ptr xdc_runtime_knl_SyncSemThread_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Params__init__S, "xdc_runtime_knl_SyncSemThread_Params__init")
__extern xdc_Void xdc_runtime_knl_SyncSemThread_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_Bool xdc_runtime_knl_SyncSemThread_query__E( xdc_runtime_knl_SyncSemThread_Handle __inst, xdc_Int qual );
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_query__F, "xdc_runtime_knl_SyncSemThread_query")
__extern xdc_Bool xdc_runtime_knl_SyncSemThread_query__F( xdc_runtime_knl_SyncSemThread_Object* __inst, xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_SyncSemThread_query__R( xdc_runtime_knl_SyncSemThread_Handle __inst, xdc_Int qual );
...
__extern xdc_Void xdc_runtime_knl_SyncSemThread_signal__E( xdc_runtime_knl_SyncSemThread_Handle __inst );
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_signal__F, "xdc_runtime_knl_SyncSemThread_signal")
__extern xdc_Void xdc_runtime_knl_SyncSemThread_signal__F( xdc_runtime_knl_SyncSemThread_Object* __inst );
__extern xdc_Void xdc_runtime_knl_SyncSemThread_signal__R( xdc_runtime_knl_SyncSemThread_Handle __inst );
...
__extern xdc_Int xdc_runtime_knl_SyncSemThread_wait__E( xdc_runtime_knl_SyncSemThread_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_wait__F, "xdc_runtime_knl_SyncSemThread_wait")
__extern xdc_Int xdc_runtime_knl_SyncSemThread_wait__F( xdc_runtime_knl_SyncSemThread_Object* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_SyncSemThread_wait__R( xdc_runtime_knl_SyncSemThread_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_SyncSemThread_query_FxnT)(void*, xdc_Int);
static inline xdc_runtime_knl_SyncSemThread_query_FxnT xdc_runtime_knl_SyncSemThread_query_fxnP( void )
{
    return (xdc_runtime_knl_SyncSemThread_query_FxnT)xdc_runtime_knl_SyncSemThread_query; 
}

/* signal_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_SyncSemThread_signal_FxnT)(void*);
static inline xdc_runtime_knl_SyncSemThread_signal_FxnT xdc_runtime_knl_SyncSemThread_signal_fxnP( void )
{
    return (xdc_runtime_knl_SyncSemThread_signal_FxnT)xdc_runtime_knl_SyncSemThread_signal; 
}

/* wait_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_SyncSemThread_wait_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SyncSemThread_wait_FxnT xdc_runtime_knl_SyncSemThread_wait_fxnP( void )
{
    return (xdc_runtime_knl_SyncSemThread_wait_FxnT)xdc_runtime_knl_SyncSemThread_wait; 
}
...
static inline xdc_runtime_knl_SyncSemThread_Handle xdc_runtime_knl_SyncSemThread_Handle_downCast( xdc_runtime_knl_ISync_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&xdc_runtime_knl_SyncSemThread_Module__FXNS__C ? (xdc_runtime_knl_SyncSemThread_Handle)i : 0;
}
...
{
    return xdc_runtime_knl_SyncSemThread_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 xdc_runtime_knl_SyncSemThread_Module_getMask( void ) 
{
    return xdc_runtime_knl_SyncSemThread_Module__diagsMask__C != NULL ? *xdc_runtime_knl_SyncSemThread_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void xdc_runtime_knl_SyncSemThread_Module_setMask( xdc_Bits16 mask ) 
{
    if (xdc_runtime_knl_SyncSemThread_Module__diagsMask__C != NULL) *xdc_runtime_knl_SyncSemThread_Module__diagsMask__C = mask;
}
...
{
    if (prms) {
        xdc_runtime_knl_SyncSemThread_Params__init__S(prms, 0, sizeof(xdc_runtime_knl_SyncSemThread_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
{
    if (dst) {
        xdc_runtime_knl_SyncSemThread_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_SyncSemThread_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline xdc_runtime_knl_SyncSemThread_Handle xdc_runtime_knl_SyncSemThread_Object_get( xdc_runtime_knl_SyncSemThread_Instance_State* oarr, int i ) 
{
...
/* Handle_name */
static inline String xdc_runtime_knl_SyncSemThread_Handle_name( xdc_runtime_knl_SyncSemThread_Handle inst )
{
...
/* create */
static inline xdc_runtime_knl_SyncSemThread_Handle xdc_runtime_knl_SyncSemThread_create( const xdc_runtime_knl_SyncSemThread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_SyncSemThread_Handle)xdc_runtime_knl_SyncSemThread_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SyncSemThread_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_SyncSemThread_construct( xdc_runtime_knl_SyncSemThread_Struct* __obj, const xdc_runtime_knl_SyncSemThread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_SyncSemThread_Object__create__S(__obj, sizeof (xdc_runtime_knl_SyncSemThread_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SyncSemThread_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_SyncSemThread_delete( xdc_runtime_knl_SyncSemThread_Handle* instp )
{
    xdc_runtime_knl_SyncSemThread_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_SyncSemThread_destruct( xdc_runtime_knl_SyncSemThread_Struct* obj )
{
    xdc_runtime_knl_SyncSemThread_Object__destruct__S(obj);
}
...
#define SyncSemThread_query_fxnP xdc_runtime_knl_SyncSemThread_query_fxnP
#define SyncSemThread_query_FxnT xdc_runtime_knl_SyncSemThread_query_FxnT
#define SyncSemThread_signal xdc_runtime_knl_SyncSemThread_signal
#define SyncSemThread_signal_fxnP xdc_runtime_knl_SyncSemThread_signal_fxnP
#define SyncSemThread_signal_FxnT xdc_runtime_knl_SyncSemThread_signal_FxnT
#define SyncSemThread_wait xdc_runtime_knl_SyncSemThread_wait
#define SyncSemThread_wait_fxnP xdc_runtime_knl_SyncSemThread_wait_fxnP
#define SyncSemThread_wait_FxnT xdc_runtime_knl_SyncSemThread_wait_FxnT
