...
#define xdc_runtime_knl_GateThread___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_GateThread_Instance_init__F, "xdc_runtime_knl_GateThread_Instance_init")
__extern int xdc_runtime_knl_GateThread_Instance_init__F( xdc_runtime_knl_GateThread_Object*, const xdc_runtime_knl_GateThread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(xdc_runtime_knl_GateThread_Instance_finalize__F, "xdc_runtime_knl_GateThread_Instance_finalize")
__extern void xdc_runtime_knl_GateThread_Instance_finalize__F( xdc_runtime_knl_GateThread_Object* , int );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_GateThread_Instance_init__R, "xdc_runtime_knl_GateThread_Instance_init")
__extern int xdc_runtime_knl_GateThread_Instance_init__R( xdc_runtime_knl_GateThread_Object*, const xdc_runtime_knl_GateThread_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(xdc_runtime_knl_GateThread_Instance_finalize__R, "xdc_runtime_knl_GateThread_Instance_finalize")
__extern void xdc_runtime_knl_GateThread_Instance_finalize__R( xdc_runtime_knl_GateThread_Object* , int );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Handle__label__S, "xdc_runtime_knl_GateThread_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_knl_GateThread_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Module__startupDone__S, "xdc_runtime_knl_GateThread_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_GateThread_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Object__create__S, "xdc_runtime_knl_GateThread_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Object__delete__S, "xdc_runtime_knl_GateThread_Object__delete")
__extern xdc_Void xdc_runtime_knl_GateThread_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Object__destruct__S, "xdc_runtime_knl_GateThread_Object__destruct")
__extern xdc_Void xdc_runtime_knl_GateThread_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Object__get__S, "xdc_runtime_knl_GateThread_Object__get")
__extern xdc_Ptr xdc_runtime_knl_GateThread_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Object__first__S, "xdc_runtime_knl_GateThread_Object__first")
__extern xdc_Ptr xdc_runtime_knl_GateThread_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Object__next__S, "xdc_runtime_knl_GateThread_Object__next")
__extern xdc_Ptr xdc_runtime_knl_GateThread_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_GateThread_Params__init__S, "xdc_runtime_knl_GateThread_Params__init")
__extern xdc_Void xdc_runtime_knl_GateThread_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_GateThread_query__F, "xdc_runtime_knl_GateThread_query")
__extern xdc_Bool xdc_runtime_knl_GateThread_query__F( xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_GateThread_query__R( xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_GateThread_enter__F, "xdc_runtime_knl_GateThread_enter")
__extern xdc_IArg xdc_runtime_knl_GateThread_enter__F( xdc_runtime_knl_GateThread_Object* __inst );
__extern xdc_IArg xdc_runtime_knl_GateThread_enter__R( xdc_runtime_knl_GateThread_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_GateThread_leave__F, "xdc_runtime_knl_GateThread_leave")
__extern xdc_Void xdc_runtime_knl_GateThread_leave__F( xdc_runtime_knl_GateThread_Object* __inst, xdc_IArg key );
__extern xdc_Void xdc_runtime_knl_GateThread_leave__R( xdc_runtime_knl_GateThread_Handle __inst, xdc_IArg key );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_GateThread_enter_FxnT)(void*);
static inline xdc_runtime_knl_GateThread_enter_FxnT xdc_runtime_knl_GateThread_enter_fxnP( void )
{
    return (xdc_runtime_knl_GateThread_enter_FxnT)xdc_runtime_knl_GateThread_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_GateThread_leave_FxnT)(void*, xdc_IArg);
static inline xdc_runtime_knl_GateThread_leave_FxnT xdc_runtime_knl_GateThread_leave_fxnP( void )
{
    return (xdc_runtime_knl_GateThread_leave_FxnT)xdc_runtime_knl_GateThread_leave; 
}
...
{
    if (dst) {
        xdc_runtime_knl_GateThread_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_GateThread_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline xdc_runtime_knl_GateThread_Handle xdc_runtime_knl_GateThread_create( const xdc_runtime_knl_GateThread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_GateThread_Handle)xdc_runtime_knl_GateThread_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateThread_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_GateThread_construct( xdc_runtime_knl_GateThread_Struct* __obj, const xdc_runtime_knl_GateThread_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_knl_GateThread_Object__create__S(__obj, sizeof (xdc_runtime_knl_GateThread_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_GateThread_Params), __eb);
}

/* delete */
static inline void xdc_runtime_knl_GateThread_delete( xdc_runtime_knl_GateThread_Handle* instp )
{
    xdc_runtime_knl_GateThread_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_GateThread_destruct( xdc_runtime_knl_GateThread_Struct* obj )
{
    xdc_runtime_knl_GateThread_Object__destruct__S(obj);
}
...
#define GateThread_enter_fxnP xdc_runtime_knl_GateThread_enter_fxnP
#define GateThread_enter_FxnT xdc_runtime_knl_GateThread_enter_FxnT
#define GateThread_leave xdc_runtime_knl_GateThread_leave
#define GateThread_leave_fxnP xdc_runtime_knl_GateThread_leave_fxnP
#define GateThread_leave_FxnT xdc_runtime_knl_GateThread_leave_FxnT
