...
#define xdc_runtime_knl_Semaphore___VERS 150
...
xdc__CODESECT(xdc_runtime_knl_Semaphore_Module__startupDone__S, "xdc_runtime_knl_Semaphore_Module__startupDone")
...
xdc__CODESECT(xdc_runtime_knl_Semaphore_pend__F, "xdc_runtime_knl_Semaphore_pend")
__extern xdc_Int xdc_runtime_knl_Semaphore_pend__F( xdc_runtime_knl_ISemaphore_Handle sem, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_Semaphore_pend__R( xdc_runtime_knl_ISemaphore_Handle sem, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Semaphore_post__F, "xdc_runtime_knl_Semaphore_post")
__extern xdc_Bool xdc_runtime_knl_Semaphore_post__F( xdc_runtime_knl_ISemaphore_Handle sem, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Semaphore_post__R( xdc_runtime_knl_ISemaphore_Handle sem, xdc_runtime_Error_Block* eb );
...
{
    return xdc_runtime_knl_Semaphore_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 xdc_runtime_knl_Semaphore_Module_getMask( void ) 
{
    return xdc_runtime_knl_Semaphore_Module__diagsMask__C != NULL ? *xdc_runtime_knl_Semaphore_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void xdc_runtime_knl_Semaphore_Module_setMask( xdc_Bits16 mask ) 
{
    if (xdc_runtime_knl_Semaphore_Module__diagsMask__C != NULL) *xdc_runtime_knl_Semaphore_Module__diagsMask__C = mask;
}
