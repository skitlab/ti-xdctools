...
#define xdc_runtime_knl_Cache___VERS 150
...
xdc__CODESECT(xdc_runtime_knl_Cache_Module__startupDone__S, "xdc_runtime_knl_Cache_Module__startupDone")
...
xdc__CODESECT(xdc_runtime_knl_Cache_inv__F, "xdc_runtime_knl_Cache_inv")
__extern xdc_Bool xdc_runtime_knl_Cache_inv__F( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Cache_inv__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Cache_wb__F, "xdc_runtime_knl_Cache_wb")
__extern xdc_Bool xdc_runtime_knl_Cache_wb__F( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Cache_wb__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Cache_wbInv__F, "xdc_runtime_knl_Cache_wbInv")
__extern xdc_Bool xdc_runtime_knl_Cache_wbInv__F( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Cache_wbInv__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bool wait, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_knl_Cache_wait__F, "xdc_runtime_knl_Cache_wait")
__extern xdc_Bool xdc_runtime_knl_Cache_wait__F( xdc_runtime_Error_Block* eb );
__extern xdc_Bool xdc_runtime_knl_Cache_wait__R( xdc_runtime_Error_Block* eb );
