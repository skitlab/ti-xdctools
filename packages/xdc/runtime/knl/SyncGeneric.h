...
#define xdc_runtime_knl_SyncGeneric___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Instance_init__F, "xdc_runtime_knl_SyncGeneric_Instance_init")
__extern void xdc_runtime_knl_SyncGeneric_Instance_init__F( xdc_runtime_knl_SyncGeneric_Object*, const xdc_runtime_knl_SyncGeneric_Params* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Instance_init__R, "xdc_runtime_knl_SyncGeneric_Instance_init")
__extern void xdc_runtime_knl_SyncGeneric_Instance_init__R( xdc_runtime_knl_SyncGeneric_Object*, const xdc_runtime_knl_SyncGeneric_Params* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Handle__label__S, "xdc_runtime_knl_SyncGeneric_Handle__label")
...
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Module__startupDone__S, "xdc_runtime_knl_SyncGeneric_Module__startupDone")
__extern xdc_Bool xdc_runtime_knl_SyncGeneric_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Object__create__S, "xdc_runtime_knl_SyncGeneric_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Object__delete__S, "xdc_runtime_knl_SyncGeneric_Object__delete")
__extern xdc_Void xdc_runtime_knl_SyncGeneric_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Object__destruct__S, "xdc_runtime_knl_SyncGeneric_Object__destruct")
__extern xdc_Void xdc_runtime_knl_SyncGeneric_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Object__get__S, "xdc_runtime_knl_SyncGeneric_Object__get")
__extern xdc_Ptr xdc_runtime_knl_SyncGeneric_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Object__first__S, "xdc_runtime_knl_SyncGeneric_Object__first")
__extern xdc_Ptr xdc_runtime_knl_SyncGeneric_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Object__next__S, "xdc_runtime_knl_SyncGeneric_Object__next")
__extern xdc_Ptr xdc_runtime_knl_SyncGeneric_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_Params__init__S, "xdc_runtime_knl_SyncGeneric_Params__init")
__extern xdc_Void xdc_runtime_knl_SyncGeneric_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_query__F, "xdc_runtime_knl_SyncGeneric_query")
__extern xdc_Bool xdc_runtime_knl_SyncGeneric_query__F( xdc_runtime_knl_SyncGeneric_Object* __inst, xdc_Int qual );
__extern xdc_Bool xdc_runtime_knl_SyncGeneric_query__R( xdc_runtime_knl_SyncGeneric_Handle __inst, xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_signal__F, "xdc_runtime_knl_SyncGeneric_signal")
__extern xdc_Void xdc_runtime_knl_SyncGeneric_signal__F( xdc_runtime_knl_SyncGeneric_Object* __inst );
__extern xdc_Void xdc_runtime_knl_SyncGeneric_signal__R( xdc_runtime_knl_SyncGeneric_Handle __inst );
...
xdc__CODESECT(xdc_runtime_knl_SyncGeneric_wait__F, "xdc_runtime_knl_SyncGeneric_wait")
__extern xdc_Int xdc_runtime_knl_SyncGeneric_wait__F( xdc_runtime_knl_SyncGeneric_Object* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Int xdc_runtime_knl_SyncGeneric_wait__R( xdc_runtime_knl_SyncGeneric_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_SyncGeneric_query_FxnT)(void*, xdc_Int);
static inline xdc_runtime_knl_SyncGeneric_query_FxnT xdc_runtime_knl_SyncGeneric_query_fxnP( void )
{
    return (xdc_runtime_knl_SyncGeneric_query_FxnT)xdc_runtime_knl_SyncGeneric_query; 
}

/* signal_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_SyncGeneric_signal_FxnT)(void*);
static inline xdc_runtime_knl_SyncGeneric_signal_FxnT xdc_runtime_knl_SyncGeneric_signal_fxnP( void )
{
    return (xdc_runtime_knl_SyncGeneric_signal_FxnT)xdc_runtime_knl_SyncGeneric_signal; 
}

/* wait_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_SyncGeneric_wait_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline xdc_runtime_knl_SyncGeneric_wait_FxnT xdc_runtime_knl_SyncGeneric_wait_fxnP( void )
{
    return (xdc_runtime_knl_SyncGeneric_wait_FxnT)xdc_runtime_knl_SyncGeneric_wait; 
}
...
{
    if (dst) {
        xdc_runtime_knl_SyncGeneric_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_knl_SyncGeneric_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String xdc_runtime_knl_SyncGeneric_Handle_name( xdc_runtime_knl_SyncGeneric_Handle inst )
{
...
/* create */
static inline xdc_runtime_knl_SyncGeneric_Handle xdc_runtime_knl_SyncGeneric_create( const xdc_runtime_knl_SyncGeneric_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_knl_SyncGeneric_Handle)xdc_runtime_knl_SyncGeneric_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SyncGeneric_Params), __eb);
}

/* construct */
static inline void xdc_runtime_knl_SyncGeneric_construct( xdc_runtime_knl_SyncGeneric_Struct* __obj, const xdc_runtime_knl_SyncGeneric_Params* __prms )
{
    xdc_runtime_knl_SyncGeneric_Object__create__S(__obj, sizeof (xdc_runtime_knl_SyncGeneric_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_knl_SyncGeneric_Params), NULL);
}

/* delete */
static inline void xdc_runtime_knl_SyncGeneric_delete( xdc_runtime_knl_SyncGeneric_Handle* instp )
{
    xdc_runtime_knl_SyncGeneric_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_knl_SyncGeneric_destruct( xdc_runtime_knl_SyncGeneric_Struct* obj )
{
    xdc_runtime_knl_SyncGeneric_Object__destruct__S(obj);
}
...
#define SyncGeneric_query_fxnP xdc_runtime_knl_SyncGeneric_query_fxnP
#define SyncGeneric_query_FxnT xdc_runtime_knl_SyncGeneric_query_FxnT
#define SyncGeneric_signal xdc_runtime_knl_SyncGeneric_signal
#define SyncGeneric_signal_fxnP xdc_runtime_knl_SyncGeneric_signal_fxnP
#define SyncGeneric_signal_FxnT xdc_runtime_knl_SyncGeneric_signal_FxnT
#define SyncGeneric_wait xdc_runtime_knl_SyncGeneric_wait
#define SyncGeneric_wait_fxnP xdc_runtime_knl_SyncGeneric_wait_fxnP
#define SyncGeneric_wait_FxnT xdc_runtime_knl_SyncGeneric_wait_FxnT
