...
#define xdc_runtime_IFilterLogger___VERS 150
...
/* write0_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IFilterLogger_write0_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId);
...
/* write1_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IFilterLogger_write1_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg);
...
/* write2_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IFilterLogger_write2_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg);
...
/* write4_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IFilterLogger_write4_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
/* write8_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IFilterLogger_write8_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
typedef xdc_Void (*xdc_runtime_IFilterLogger_setFilterLevel_FxnT)(void*, xdc_runtime_Diags_Mask, xdc_runtime_Diags_EventLevel);
