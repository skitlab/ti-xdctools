...
__extern xdc_Ptr xdc_runtime_Core_constructObject__I( const xdc_runtime_Core_ObjDesc* od, xdc_Ptr curObj, xdc_SizeT objStrSize, xdc_Ptr resPrms, const xdc_Ptr argPrms, xdc_SizeT argPrmsSize, xdc_runtime_Error_Block* eb );
