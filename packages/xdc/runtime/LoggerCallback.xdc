 ...
 *  create a logger instance, plugs in the user defined functions, assign it as 
 *  the default logger for all modules, and enable `USER1` logging in all 
 *  all modules of the package `my.pkg`. See the 
...
module LoggerCallback inherits ILogger {
     ...
     *  The default create function returns `0` always.
     */
