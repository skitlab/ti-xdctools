...
#define xdc_runtime_HeapStd___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_HeapStd_Instance_init__F, "xdc_runtime_HeapStd_Instance_init")
__extern int xdc_runtime_HeapStd_Instance_init__F( xdc_runtime_HeapStd_Object*, const xdc_runtime_HeapStd_Params*, xdc_runtime_Error_Block* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_HeapStd_Instance_init__R, "xdc_runtime_HeapStd_Instance_init")
__extern int xdc_runtime_HeapStd_Instance_init__R( xdc_runtime_HeapStd_Object*, const xdc_runtime_HeapStd_Params*, xdc_runtime_Error_Block* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_HeapStd_Handle__label__S, "xdc_runtime_HeapStd_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_HeapStd_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_HeapStd_Module__startupDone__S, "xdc_runtime_HeapStd_Module__startupDone")
__extern xdc_Bool xdc_runtime_HeapStd_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_HeapStd_Object__create__S, "xdc_runtime_HeapStd_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_HeapStd_Object__delete__S, "xdc_runtime_HeapStd_Object__delete")
__extern xdc_Void xdc_runtime_HeapStd_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_HeapStd_Object__destruct__S, "xdc_runtime_HeapStd_Object__destruct")
__extern xdc_Void xdc_runtime_HeapStd_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_HeapStd_Object__get__S, "xdc_runtime_HeapStd_Object__get")
__extern xdc_Ptr xdc_runtime_HeapStd_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_HeapStd_Object__first__S, "xdc_runtime_HeapStd_Object__first")
__extern xdc_Ptr xdc_runtime_HeapStd_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_HeapStd_Object__next__S, "xdc_runtime_HeapStd_Object__next")
__extern xdc_Ptr xdc_runtime_HeapStd_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_HeapStd_Params__init__S, "xdc_runtime_HeapStd_Params__init")
__extern xdc_Void xdc_runtime_HeapStd_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_HeapStd_free__F, "xdc_runtime_HeapStd_free")
__extern xdc_Void xdc_runtime_HeapStd_free__F( xdc_runtime_HeapStd_Object* __inst, xdc_Ptr block, xdc_SizeT size );
__extern xdc_Void xdc_runtime_HeapStd_free__R( xdc_runtime_HeapStd_Handle __inst, xdc_Ptr block, xdc_SizeT size );
...
xdc__CODESECT(xdc_runtime_HeapStd_getStats__F, "xdc_runtime_HeapStd_getStats")
__extern xdc_Void xdc_runtime_HeapStd_getStats__F( xdc_runtime_HeapStd_Object* __inst, xdc_runtime_Memory_Stats* stats );
__extern xdc_Void xdc_runtime_HeapStd_getStats__R( xdc_runtime_HeapStd_Handle __inst, xdc_runtime_Memory_Stats* stats );
...
xdc__CODESECT(xdc_runtime_HeapStd_alloc__F, "xdc_runtime_HeapStd_alloc")
__extern xdc_Ptr xdc_runtime_HeapStd_alloc__F( xdc_runtime_HeapStd_Object* __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
__extern xdc_Ptr xdc_runtime_HeapStd_alloc__R( xdc_runtime_HeapStd_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_HeapStd_isBlocking__F, "xdc_runtime_HeapStd_isBlocking")
__extern xdc_Bool xdc_runtime_HeapStd_isBlocking__F( xdc_runtime_HeapStd_Object* __inst );
__extern xdc_Bool xdc_runtime_HeapStd_isBlocking__R( xdc_runtime_HeapStd_Handle __inst );
...
/* free_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_HeapStd_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline xdc_runtime_HeapStd_free_FxnT xdc_runtime_HeapStd_free_fxnP( void )
{
    return (xdc_runtime_HeapStd_free_FxnT)xdc_runtime_HeapStd_free; 
}

/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_HeapStd_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline xdc_runtime_HeapStd_getStats_FxnT xdc_runtime_HeapStd_getStats_fxnP( void )
{
    return (xdc_runtime_HeapStd_getStats_FxnT)xdc_runtime_HeapStd_getStats; 
}

/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_HeapStd_alloc_FxnT)(void*, xdc_SizeT, xdc_SizeT, xdc_runtime_Error_Block*);
static inline xdc_runtime_HeapStd_alloc_FxnT xdc_runtime_HeapStd_alloc_fxnP( void )
{
    return (xdc_runtime_HeapStd_alloc_FxnT)xdc_runtime_HeapStd_alloc; 
}

/* isBlocking_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_HeapStd_isBlocking_FxnT)(void*);
static inline xdc_runtime_HeapStd_isBlocking_FxnT xdc_runtime_HeapStd_isBlocking_fxnP( void )
{
    return (xdc_runtime_HeapStd_isBlocking_FxnT)xdc_runtime_HeapStd_isBlocking; 
}
...
{
    if (dst) {
        xdc_runtime_HeapStd_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_HeapStd_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline xdc_runtime_HeapStd_Handle xdc_runtime_HeapStd_create( const xdc_runtime_HeapStd_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_HeapStd_Handle)xdc_runtime_HeapStd_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_HeapStd_Params), __eb);
}

/* construct */
static inline void xdc_runtime_HeapStd_construct( xdc_runtime_HeapStd_Struct* __obj, const xdc_runtime_HeapStd_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    xdc_runtime_HeapStd_Object__create__S(__obj, sizeof (xdc_runtime_HeapStd_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_HeapStd_Params), __eb);
}

/* delete */
static inline void xdc_runtime_HeapStd_delete( xdc_runtime_HeapStd_Handle* instp )
{
    xdc_runtime_HeapStd_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_HeapStd_destruct( xdc_runtime_HeapStd_Struct* obj )
{
...
#define HeapStd_free_fxnP xdc_runtime_HeapStd_free_fxnP
#define HeapStd_free_FxnT xdc_runtime_HeapStd_free_FxnT
#define HeapStd_getStats xdc_runtime_HeapStd_getStats
#define HeapStd_getStats_fxnP xdc_runtime_HeapStd_getStats_fxnP
#define HeapStd_getStats_FxnT xdc_runtime_HeapStd_getStats_FxnT
#define HeapStd_alloc xdc_runtime_HeapStd_alloc
#define HeapStd_alloc_fxnP xdc_runtime_HeapStd_alloc_fxnP
#define HeapStd_alloc_FxnT xdc_runtime_HeapStd_alloc_FxnT
#define HeapStd_isBlocking xdc_runtime_HeapStd_isBlocking
#define HeapStd_isBlocking_fxnP xdc_runtime_HeapStd_isBlocking_fxnP
#define HeapStd_isBlocking_FxnT xdc_runtime_HeapStd_isBlocking_FxnT
