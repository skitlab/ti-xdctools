...
#define xdc_runtime_Assert___VERS 150
...
xdc__CODESECT(xdc_runtime_Assert_Module__startupDone__S, "xdc_runtime_Assert_Module__startupDone")
...
__extern xdc_Void xdc_runtime_Assert_raise__I( xdc_runtime_Types_ModuleId mod, xdc_String file, xdc_Int line, xdc_runtime_Assert_Id id );
...
#endif
/*
 *  @(#) xdc.runtime; 2, 1, 0,394; 11-3-2012 15:19:12; /db/ztree/library/trees/xdc/xdc-y44x/src/packages/
 */
