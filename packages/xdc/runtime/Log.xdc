...
module Log {
     ...
     *  @param(id)      a unique ID used to match benchmark start and stop events
     */
     ...
     *  @param(fmt)     a constant string that provides format specifiers for up to 6 additional parameters
     *  @param(id)      a unique ID used to match benchmark start and stop events
     *  @param(instId)  a unique instance ID that can be used to match and instance
     */
     ...
     *  @see #error5
     */
    @Macro Void error1(String fmt, IArg a1);
     ...
     *  @see #error5
     */
    @Macro Void error2(String fmt, IArg a1, IArg a2);
     ...
     *  @see #error5
     */
    @Macro Void error3(String fmt, IArg a1, IArg a2, IArg a3);
     ...
     *  @see #error5
     */
    @Macro Void error4(String fmt, IArg a1, IArg a2, IArg a3,
        IArg a4);
     ...
     *  @p
     */
    @Macro Void error5(String fmt, IArg a1, IArg a2, IArg a3,
        IArg a4, IArg a5);
     ...
     *  @see #warning5
     */
    @Macro Void warning0(String fmt);
     ...
     *  @see #warning5
     */
    @Macro Void warning1(String fmt, IArg a1);
     ...
     *  @see #warning5
     */
    @Macro Void warning2(String fmt, IArg a1, IArg a2);
     ...
     *  @see #warning5
     */
    @Macro Void warning3(String fmt, IArg a1, IArg a2, IArg a3);
     ...
     *  @see #warning5
     */
    @Macro Void warning4(String fmt, IArg a1, IArg a2, IArg a3,
        IArg a4);
     ...
     *  @p
     */
    @Macro Void warning5(String fmt, IArg a1, IArg a2, IArg a3,
        IArg a4, IArg a5);
     ...
     *  @see #info5
     */
    @Macro Void info1(String fmt, IArg a1);
     ...
     *  @see #info5
     */
    @Macro Void info2(String fmt, IArg a1, IArg a2);
     ...
     *  @see #info5
     */
    @Macro Void info3(String fmt, IArg a1, IArg a2, IArg a3);
     ...
     *  @see #info5
     */
    @Macro Void info4(String fmt, IArg a1, IArg a2, IArg a3, IArg a4);
     ...
     *  @p
     */
    @Macro Void info5(String fmt, IArg a1, IArg a2, IArg a3, IArg a4, IArg a5);
