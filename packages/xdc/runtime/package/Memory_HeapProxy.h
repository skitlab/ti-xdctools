...
#define xdc_runtime_Memory_HeapProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Handle__label__S, "xdc_runtime_Memory_HeapProxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Module__startupDone__S, "xdc_runtime_Memory_HeapProxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_Memory_HeapProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Object__create__S, "xdc_runtime_Memory_HeapProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Object__delete__S, "xdc_runtime_Memory_HeapProxy_Object__delete")
__extern xdc_Void xdc_runtime_Memory_HeapProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Object__destruct__S, "xdc_runtime_Memory_HeapProxy_Object__destruct")
__extern xdc_Void xdc_runtime_Memory_HeapProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Object__get__S, "xdc_runtime_Memory_HeapProxy_Object__get")
__extern xdc_Ptr xdc_runtime_Memory_HeapProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Object__first__S, "xdc_runtime_Memory_HeapProxy_Object__first")
__extern xdc_Ptr xdc_runtime_Memory_HeapProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Object__next__S, "xdc_runtime_Memory_HeapProxy_Object__next")
__extern xdc_Ptr xdc_runtime_Memory_HeapProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Params__init__S, "xdc_runtime_Memory_HeapProxy_Params__init")
__extern xdc_Void xdc_runtime_Memory_HeapProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Proxy__abstract__S, "xdc_runtime_Memory_HeapProxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_Memory_HeapProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_Proxy__delegate__S, "xdc_runtime_Memory_HeapProxy_Proxy__delegate")
...
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_alloc__R, "xdc_runtime_Memory_HeapProxy_alloc")
__extern xdc_Ptr xdc_runtime_Memory_HeapProxy_alloc__R( xdc_runtime_Memory_HeapProxy_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_free__R, "xdc_runtime_Memory_HeapProxy_free")
__extern xdc_Void xdc_runtime_Memory_HeapProxy_free__R( xdc_runtime_Memory_HeapProxy_Handle __inst, xdc_Ptr block, xdc_SizeT size );
...
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_isBlocking__R, "xdc_runtime_Memory_HeapProxy_isBlocking")
__extern xdc_Bool xdc_runtime_Memory_HeapProxy_isBlocking__R( xdc_runtime_Memory_HeapProxy_Handle __inst );
...
xdc__CODESECT(xdc_runtime_Memory_HeapProxy_getStats__R, "xdc_runtime_Memory_HeapProxy_getStats")
__extern xdc_Void xdc_runtime_Memory_HeapProxy_getStats__R( xdc_runtime_Memory_HeapProxy_Handle __inst, xdc_runtime_Memory_Stats* stats );
...
{
    return (xdc_runtime_Memory_HeapProxy_alloc_FxnT)xdc_runtime_Memory_HeapProxy_alloc; 
}

/* free_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_Memory_HeapProxy_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline xdc_runtime_Memory_HeapProxy_free_FxnT xdc_runtime_Memory_HeapProxy_free_fxnP( void )
{
    return (xdc_runtime_Memory_HeapProxy_free_FxnT)xdc_runtime_Memory_HeapProxy_free; 
}
...
{
    return (xdc_runtime_Memory_HeapProxy_isBlocking_FxnT)xdc_runtime_Memory_HeapProxy_isBlocking; 
}

/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_Memory_HeapProxy_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline xdc_runtime_Memory_HeapProxy_getStats_FxnT xdc_runtime_Memory_HeapProxy_getStats_fxnP( void )
{
    return (xdc_runtime_Memory_HeapProxy_getStats_FxnT)xdc_runtime_Memory_HeapProxy_getStats; 
}
...
#define Memory_HeapProxy_alloc_fxnP xdc_runtime_Memory_HeapProxy_alloc_fxnP
#define Memory_HeapProxy_alloc_FxnT xdc_runtime_Memory_HeapProxy_alloc_FxnT
#define Memory_HeapProxy_free xdc_runtime_Memory_HeapProxy_free
#define Memory_HeapProxy_free_fxnP xdc_runtime_Memory_HeapProxy_free_fxnP
#define Memory_HeapProxy_free_FxnT xdc_runtime_Memory_HeapProxy_free_FxnT
#define Memory_HeapProxy_isBlocking xdc_runtime_Memory_HeapProxy_isBlocking
#define Memory_HeapProxy_isBlocking_fxnP xdc_runtime_Memory_HeapProxy_isBlocking_fxnP
#define Memory_HeapProxy_isBlocking_FxnT xdc_runtime_Memory_HeapProxy_isBlocking_FxnT
#define Memory_HeapProxy_getStats xdc_runtime_Memory_HeapProxy_getStats
#define Memory_HeapProxy_getStats_fxnP xdc_runtime_Memory_HeapProxy_getStats_fxnP
#define Memory_HeapProxy_getStats_FxnT xdc_runtime_Memory_HeapProxy_getStats_FxnT
