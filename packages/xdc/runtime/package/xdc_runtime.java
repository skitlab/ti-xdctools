...
public class xdc_runtime
{
    ...
    void IFilterLogger$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.runtime.IFilterLogger.Object", new Proto.Str(po, false));
    ...
    void LoggerCallback$$OBJECTS()
    {
        ...
        Object objP = om.bind("xdc.runtime.LoggerCallback.Object", new Proto.Str(po, false));
    ...
    {
        // module Assert
        om.bind("xdc.runtime.Assert.raise", new Extern("xdc_runtime_Assert_raise__I", "xdc_Void(*)(xdc_Bits16,xdc_String,xdc_Int,xdc_runtime_Assert_Id)", true, false));
    }
    ...
    void Core$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Core.assignParams", new Extern("xdc_runtime_Core_assignParams__I", "xdc_Void(*)(xdc_Ptr,xdc_Ptr,xdc_SizeT,xdc_SizeT)", true, false));
        om.bind("xdc.runtime.Core.createObject", new Extern("xdc_runtime_Core_createObject__I", "xdc_Ptr(*)(xdc_runtime_Core_ObjDesc*,xdc_Ptr,xdc_SizeT,xdc_Ptr,xdc_Ptr,xdc_SizeT,xdc_runtime_Error_Block*)", true, false));
        om.bind("xdc.runtime.Core.constructObject", new Extern("xdc_runtime_Core_constructObject__I", "xdc_Ptr(*)(xdc_runtime_Core_ObjDesc*,xdc_Ptr,xdc_SizeT,xdc_Ptr,xdc_Ptr,xdc_SizeT,xdc_runtime_Error_Block*)", true, false));
    ...
    void Diags$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Diags.setMask", new Extern("xdc_runtime_Diags_setMask__E", "xdc_Void(*)(xdc_String)", true, false));
    }
    ...
    void Error$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Error.getMsg", new Extern("xdc_runtime_Error_getMsg__E", "xdc_String(*)(xdc_runtime_Error_Block*)", true, false));
        ...
        om.bind("xdc.runtime.Error.raiseX", new Extern("xdc_runtime_Error_raiseX__E", "xdc_Void(*)(xdc_runtime_Error_Block*,xdc_Bits16,xdc_String,xdc_Int,xdc_runtime_Error_Id,xdc_IArg,xdc_IArg)", true, false));
    }
    ...
    void Registry$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Registry.addModule", new Extern("xdc_runtime_Registry_addModule__E", "xdc_runtime_Registry_Result(*)(xdc_runtime_Types_RegDesc*,xdc_String)", true, false));
        om.bind("xdc.runtime.Registry.findByName", new Extern("xdc_runtime_Registry_findByName__E", "xdc_runtime_Types_RegDesc*(*)(xdc_String)", true, false));
        om.bind("xdc.runtime.Registry.findByNamePattern", new Extern("xdc_runtime_Registry_findByNamePattern__E", "xdc_runtime_Types_RegDesc*(*)(xdc_String,xdc_Int,xdc_runtime_Types_RegDesc*)", true, false));
        ...
        om.bind("xdc.runtime.Registry.getMask", new Extern("xdc_runtime_Registry_getMask__E", "xdc_Bool(*)(xdc_String,xdc_Bits16*)", true, false));
        ...
        om.bind("xdc.runtime.Registry.getModuleName", new Extern("xdc_runtime_Registry_getModuleName__E", "xdc_String(*)(xdc_runtime_Types_RegDesc*)", true, false));
        ...
        om.bind("xdc.runtime.Registry.findByNameInList", new Extern("xdc_runtime_Registry_findByNameInList__I", "xdc_runtime_Types_RegDesc*(*)(xdc_String,xdc_runtime_Types_RegDesc*)", true, false));
        om.bind("xdc.runtime.Registry.newModule", new Extern("xdc_runtime_Registry_newModule__I", "xdc_Void(*)(xdc_runtime_Types_RegDesc*,xdc_String)", true, false));
        om.bind("xdc.runtime.Registry.matchPattern", new Extern("xdc_runtime_Registry_matchPattern__I", "xdc_Bool(*)(xdc_String,xdc_Int,xdc_String)", true, false));
    }
    ...
    void System$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.System.abort", new Extern("xdc_runtime_System_abort__E", "xdc_Void(*)(xdc_String)", true, false));
        ...
        om.bind("xdc.runtime.System.printf", new Extern("xdc_runtime_System_printf__E", "xdc_Int(*)(xdc_String,...)", true, false));
        om.bind("xdc.runtime.System.aprintf", new Extern("xdc_runtime_System_aprintf__E", "xdc_Int(*)(xdc_String,...)", true, false));
        om.bind("xdc.runtime.System.sprintf", new Extern("xdc_runtime_System_sprintf__E", "xdc_Int(*)(xdc_Char[],xdc_String,...)", true, false));
        om.bind("xdc.runtime.System.asprintf", new Extern("xdc_runtime_System_asprintf__E", "xdc_Int(*)(xdc_Char[],xdc_String,...)", true, false));
        om.bind("xdc.runtime.System.vprintf", new Extern("xdc_runtime_System_vprintf__E", "xdc_Int(*)(xdc_String,xdc_VaList)", true, false));
        om.bind("xdc.runtime.System.avprintf", new Extern("xdc_runtime_System_avprintf__E", "xdc_Int(*)(xdc_String,xdc_VaList)", true, false));
        om.bind("xdc.runtime.System.vsprintf", new Extern("xdc_runtime_System_vsprintf__E", "xdc_Int(*)(xdc_Char[],xdc_String,xdc_VaList)", true, false));
        om.bind("xdc.runtime.System.avsprintf", new Extern("xdc_runtime_System_avsprintf__E", "xdc_Int(*)(xdc_Char[],xdc_String,xdc_VaList)", true, false));
        om.bind("xdc.runtime.System.printfExtend", new Extern("xdc_runtime_System_printfExtend__I", "xdc_Int(*)(xdc_Char**,xdc_Char**,xdc_VaList*,xdc_runtime_System_ParseData*)", true, false));
        om.bind("xdc.runtime.System.doPrint", new Extern("xdc_runtime_System_doPrint__I", "xdc_Int(*)(xdc_Char[],xdc_String,xdc_VaList*,xdc_Bool)", true, false));
        om.bind("xdc.runtime.System.formatNum", new Extern("xdc_runtime_System_formatNum__I", "xdc_Char*(*)(xdc_Char*,xdc_UInt32,xdc_Int,xdc_Int)", true, false));
        om.bind("xdc.runtime.System.lastFxn", new Extern("xdc_runtime_System_lastFxn__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("xdc.runtime.System.putchar", new Extern("xdc_runtime_System_putchar__I", "xdc_Void(*)(xdc_Char**,xdc_Char)", true, false));
    ...
    {
        // module SysCallback
        om.bind("xdc.runtime.SysCallback.abort", new Extern("xdc_runtime_SysCallback_abort__E", "xdc_Void(*)(xdc_String)", true, false));
    ...
    {
        // module SysMin
        om.bind("xdc.runtime.SysMin.abort", new Extern("xdc_runtime_SysMin_abort__E", "xdc_Void(*)(xdc_String)", true, false));
    ...
    {
        // module SysStd
        om.bind("xdc.runtime.SysStd.abort", new Extern("xdc_runtime_SysStd_abort__E", "xdc_Void(*)(xdc_String)", true, false));
    ...
    void Text$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Text.ropeText", new Extern("xdc_runtime_Text_ropeText__E", "xdc_String(*)(xdc_Bits16)", true, false));
        om.bind("xdc.runtime.Text.matchRope", new Extern("xdc_runtime_Text_matchRope__E", "xdc_Int(*)(xdc_Bits16,xdc_String,xdc_Int*)", true, false));
        ...
        om.bind("xdc.runtime.Text.matchVisFxn", new Extern("xdc_runtime_Text_matchVisFxn__I", "xdc_Bool(*)(xdc_Ptr,xdc_String)", true, false));
        om.bind("xdc.runtime.Text.printVisFxn", new Extern("xdc_runtime_Text_printVisFxn__I", "xdc_Bool(*)(xdc_Ptr,xdc_String)", true, false));
        ...
        om.bind("xdc.runtime.Text.visitRope2", new Extern("xdc_runtime_Text_visitRope2__I", "xdc_Void(*)(xdc_Bits16,xdc_Fxn,xdc_Ptr,xdc_String[])", true, false));
        om.bind("xdc.runtime.Text.xprintf", new Extern("xdc_runtime_Text_xprintf__I", "xdc_Int(*)(xdc_Char**,xdc_String,...)", true, false));
    }
    ...
    void System_SupportProxy$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.System_SupportProxy.abort", new Extern("xdc_runtime_System_SupportProxy_abort__E", "xdc_Void(*)(xdc_String)", true, false));
    ...
    void SysCallback$$TYPES()
    {
        ...
        po.init("xdc.runtime.SysCallback.Module", om.findStrict("xdc.runtime.ISystemSupport.Module", "xdc.runtime"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
            po.addFld("abortFxn", new Proto.Adr("xdc_Void(*)(xdc_String)", "PFv"), "&xdc_runtime_SysCallback_defaultAbort", "w");
        ...
        om.bind("xdc.runtime.SysCallback.AbortFxn", new Proto.Adr("xdc_Void(*)(xdc_String)", "PFv"));
    ...
    void LoggerBuf$$SINGLETONS()
    {
        ...
        loggables.add(Global.newObject("name", "setFilterLevel", "entry", "%p, %d, %d", "exit", ""));
        loggables.add(Global.newObject("name", "getFilterLevel", "entry", "%p, %d", "exit", "%d"));
    ...
    void Registry$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "addModule", "entry", "%p, \"%s\"", "exit", "%d"));
        loggables.add(Global.newObject("name", "findByName", "entry", "\"%s\"", "exit", "%p"));
        loggables.add(Global.newObject("name", "findByNamePattern", "entry", "\"%s\", %d, %p", "exit", "%p"));
        loggables.add(Global.newObject("name", "findById", "entry", "%d", "exit", "%p"));
        loggables.add(Global.newObject("name", "getMask", "entry", "\"%s\", %p", "exit", "%d"));
        loggables.add(Global.newObject("name", "isMember", "entry", "%d", "exit", "%d"));
        loggables.add(Global.newObject("name", "getNextModule", "entry", "%p", "exit", "%p"));
        loggables.add(Global.newObject("name", "getModuleName", "entry", "%p", "exit", "\"%s\""));
        loggables.add(Global.newObject("name", "getModuleId", "entry", "%p", "exit", "%d"));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("Registry", vo);
