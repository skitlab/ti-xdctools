...
#define xdc_runtime_LoggerSys_TimestampProxy___VERS 150
...
typedef xdc_Bool (*CT__xdc_runtime_LoggerSys_TimestampProxy_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__xdc_runtime_LoggerSys_TimestampProxy_Module__startupDoneFxn xdc_runtime_LoggerSys_TimestampProxy_Module__startupDoneFxn__C;
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Handle__label__S, "xdc_runtime_LoggerSys_TimestampProxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Module__startupDone__S, "xdc_runtime_LoggerSys_TimestampProxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_LoggerSys_TimestampProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__create__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__create")
__extern xdc_Ptr xdc_runtime_LoggerSys_TimestampProxy_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar* __pa, xdc_SizeT __psz, xdc_runtime_Error_Block* __eb );

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__delete__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__delete")
__extern xdc_Void xdc_runtime_LoggerSys_TimestampProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__destruct__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__destruct")
__extern xdc_Void xdc_runtime_LoggerSys_TimestampProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__get__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__get")
__extern xdc_Ptr xdc_runtime_LoggerSys_TimestampProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__first__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__first")
__extern xdc_Ptr xdc_runtime_LoggerSys_TimestampProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__next__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__next")
__extern xdc_Ptr xdc_runtime_LoggerSys_TimestampProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Params__init__S, "xdc_runtime_LoggerSys_TimestampProxy_Params__init")
__extern xdc_Void xdc_runtime_LoggerSys_TimestampProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Proxy__abstract__S, "xdc_runtime_LoggerSys_TimestampProxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_LoggerSys_TimestampProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Proxy__delegate__S, "xdc_runtime_LoggerSys_TimestampProxy_Proxy__delegate")
__extern xdc_Ptr xdc_runtime_LoggerSys_TimestampProxy_Proxy__delegate__S( void );
...
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_get32__R, "xdc_runtime_LoggerSys_TimestampProxy_get32")
__extern xdc_Bits32 xdc_runtime_LoggerSys_TimestampProxy_get32__R( void );
...
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_get64__R, "xdc_runtime_LoggerSys_TimestampProxy_get64")
__extern xdc_Void xdc_runtime_LoggerSys_TimestampProxy_get64__R( xdc_runtime_Types_Timestamp64* result );
...
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_getFreq__R, "xdc_runtime_LoggerSys_TimestampProxy_getFreq")
__extern xdc_Void xdc_runtime_LoggerSys_TimestampProxy_getFreq__R( xdc_runtime_Types_FreqHz* freq );
