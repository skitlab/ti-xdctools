...
#define xdc_runtime_LoggerBuf_write0 xdc_runtime_LoggerBuf_write0__F

/* write1 */
#undef xdc_runtime_LoggerBuf_write1
#define xdc_runtime_LoggerBuf_write1 xdc_runtime_LoggerBuf_write1__F

/* write2 */
#undef xdc_runtime_LoggerBuf_write2
#define xdc_runtime_LoggerBuf_write2 xdc_runtime_LoggerBuf_write2__F
...
#define xdc_runtime_LoggerBuf_setFilterLevel xdc_runtime_LoggerBuf_setFilterLevel__F

/* getFilterLevel */
#undef xdc_runtime_LoggerBuf_getFilterLevel
#define xdc_runtime_LoggerBuf_getFilterLevel xdc_runtime_LoggerBuf_getFilterLevel__F
