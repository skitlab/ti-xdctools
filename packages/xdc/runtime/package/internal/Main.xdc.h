...
#ifndef xdc_runtime_Main__INTERNAL__
#define xdc_runtime_Main__INTERNAL__

#ifndef xdc_runtime_Main__internalaccess
#define xdc_runtime_Main__internalaccess
#endif
...
/* Module_startup */
#undef xdc_runtime_Main_Module_startup
#define xdc_runtime_Main_Module_startup xdc_runtime_Main_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Main_Instance_init
#define xdc_runtime_Main_Instance_init xdc_runtime_Main_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Main_Instance_finalize
#define xdc_runtime_Main_Instance_finalize xdc_runtime_Main_Instance_finalize__F
...
#endif /* xdc_runtime_Main__INTERNAL____ */
