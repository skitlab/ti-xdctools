...
#define xdc_runtime_Registry_addModule xdc_runtime_Registry_addModule__F

/* findByName */
#undef xdc_runtime_Registry_findByName
#define xdc_runtime_Registry_findByName xdc_runtime_Registry_findByName__F

/* findByNamePattern */
#undef xdc_runtime_Registry_findByNamePattern
#define xdc_runtime_Registry_findByNamePattern xdc_runtime_Registry_findByNamePattern__F

/* findById */
#undef xdc_runtime_Registry_findById
#define xdc_runtime_Registry_findById xdc_runtime_Registry_findById__F

/* getMask */
#undef xdc_runtime_Registry_getMask
#define xdc_runtime_Registry_getMask xdc_runtime_Registry_getMask__F

/* isMember */
#undef xdc_runtime_Registry_isMember
#define xdc_runtime_Registry_isMember xdc_runtime_Registry_isMember__F

/* getNextModule */
#undef xdc_runtime_Registry_getNextModule
#define xdc_runtime_Registry_getNextModule xdc_runtime_Registry_getNextModule__F

/* getModuleName */
#undef xdc_runtime_Registry_getModuleName
#define xdc_runtime_Registry_getModuleName xdc_runtime_Registry_getModuleName__F

/* getModuleId */
#undef xdc_runtime_Registry_getModuleId
#define xdc_runtime_Registry_getModuleId xdc_runtime_Registry_getModuleId__F
...
#define xdc_runtime_Registry_Module_startup xdc_runtime_Registry_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Registry_Instance_init
#define xdc_runtime_Registry_Instance_init xdc_runtime_Registry_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Registry_Instance_finalize
#define xdc_runtime_Registry_Instance_finalize xdc_runtime_Registry_Instance_finalize__F
