...
#define Module__LOGFXN0 xdc_runtime_Startup_Module__loggerFxn0__C
#undef Module__LOGFXN1
#define Module__LOGFXN1 xdc_runtime_Startup_Module__loggerFxn1__C
#undef Module__LOGFXN2
#define Module__LOGFXN2 xdc_runtime_Startup_Module__loggerFxn2__C
