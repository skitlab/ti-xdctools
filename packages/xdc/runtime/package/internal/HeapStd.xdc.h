...
#define xdc_runtime_HeapStd_free xdc_runtime_HeapStd_free__F

/* getStats */
#undef xdc_runtime_HeapStd_getStats
#define xdc_runtime_HeapStd_getStats xdc_runtime_HeapStd_getStats__F

/* alloc */
#undef xdc_runtime_HeapStd_alloc
#define xdc_runtime_HeapStd_alloc xdc_runtime_HeapStd_alloc__F

/* isBlocking */
#undef xdc_runtime_HeapStd_isBlocking
#define xdc_runtime_HeapStd_isBlocking xdc_runtime_HeapStd_isBlocking__F

/* Module_startup */
#undef xdc_runtime_HeapStd_Module_startup
#define xdc_runtime_HeapStd_Module_startup xdc_runtime_HeapStd_Module_startup__F

/* Instance_init */
#undef xdc_runtime_HeapStd_Instance_init
#define xdc_runtime_HeapStd_Instance_init xdc_runtime_HeapStd_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_HeapStd_Instance_finalize
#define xdc_runtime_HeapStd_Instance_finalize xdc_runtime_HeapStd_Instance_finalize__F
