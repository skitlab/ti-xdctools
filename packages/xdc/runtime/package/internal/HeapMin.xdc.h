...
#define xdc_runtime_HeapMin_getStats xdc_runtime_HeapMin_getStats__F

/* alloc */
#undef xdc_runtime_HeapMin_alloc
#define xdc_runtime_HeapMin_alloc xdc_runtime_HeapMin_alloc__F

/* free */
#undef xdc_runtime_HeapMin_free
#define xdc_runtime_HeapMin_free xdc_runtime_HeapMin_free__F

/* isBlocking */
#undef xdc_runtime_HeapMin_isBlocking
#define xdc_runtime_HeapMin_isBlocking xdc_runtime_HeapMin_isBlocking__F

/* Module_startup */
#undef xdc_runtime_HeapMin_Module_startup
#define xdc_runtime_HeapMin_Module_startup xdc_runtime_HeapMin_Module_startup__F

/* Instance_init */
#undef xdc_runtime_HeapMin_Instance_init
#define xdc_runtime_HeapMin_Instance_init xdc_runtime_HeapMin_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_HeapMin_Instance_finalize
#define xdc_runtime_HeapMin_Instance_finalize xdc_runtime_HeapMin_Instance_finalize__F
