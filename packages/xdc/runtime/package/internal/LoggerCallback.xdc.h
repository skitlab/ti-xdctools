...
#define xdc_runtime_LoggerCallback_enable xdc_runtime_LoggerCallback_enable__F

/* disable */
#undef xdc_runtime_LoggerCallback_disable
#define xdc_runtime_LoggerCallback_disable xdc_runtime_LoggerCallback_disable__F

/* write0 */
#undef xdc_runtime_LoggerCallback_write0
#define xdc_runtime_LoggerCallback_write0 xdc_runtime_LoggerCallback_write0__F

/* write1 */
#undef xdc_runtime_LoggerCallback_write1
#define xdc_runtime_LoggerCallback_write1 xdc_runtime_LoggerCallback_write1__F

/* write2 */
#undef xdc_runtime_LoggerCallback_write2
#define xdc_runtime_LoggerCallback_write2 xdc_runtime_LoggerCallback_write2__F

/* write4 */
#undef xdc_runtime_LoggerCallback_write4
#define xdc_runtime_LoggerCallback_write4 xdc_runtime_LoggerCallback_write4__F

/* write8 */
#undef xdc_runtime_LoggerCallback_write8
#define xdc_runtime_LoggerCallback_write8 xdc_runtime_LoggerCallback_write8__F

/* Module_startup */
#undef xdc_runtime_LoggerCallback_Module_startup
#define xdc_runtime_LoggerCallback_Module_startup xdc_runtime_LoggerCallback_Module_startup__F

/* Instance_init */
#undef xdc_runtime_LoggerCallback_Instance_init
#define xdc_runtime_LoggerCallback_Instance_init xdc_runtime_LoggerCallback_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_LoggerCallback_Instance_finalize
#define xdc_runtime_LoggerCallback_Instance_finalize xdc_runtime_LoggerCallback_Instance_finalize__F
