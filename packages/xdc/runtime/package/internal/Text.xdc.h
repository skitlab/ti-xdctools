...
#define xdc_runtime_Text_cordText xdc_runtime_Text_cordText__F

/* ropeText */
#undef xdc_runtime_Text_ropeText
#define xdc_runtime_Text_ropeText xdc_runtime_Text_ropeText__F

/* matchRope */
#undef xdc_runtime_Text_matchRope
#define xdc_runtime_Text_matchRope xdc_runtime_Text_matchRope__F

/* putLab */
#undef xdc_runtime_Text_putLab
#define xdc_runtime_Text_putLab xdc_runtime_Text_putLab__F

/* putMod */
#undef xdc_runtime_Text_putMod
#define xdc_runtime_Text_putMod xdc_runtime_Text_putMod__F

/* putSite */
#undef xdc_runtime_Text_putSite
#define xdc_runtime_Text_putSite xdc_runtime_Text_putSite__F
...
#define xdc_runtime_Text_Module_startup xdc_runtime_Text_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Text_Instance_init
#define xdc_runtime_Text_Instance_init xdc_runtime_Text_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Text_Instance_finalize
#define xdc_runtime_Text_Instance_finalize xdc_runtime_Text_Instance_finalize__F
