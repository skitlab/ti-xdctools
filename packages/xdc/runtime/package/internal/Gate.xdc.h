...
#ifndef xdc_runtime_Gate__INTERNAL__
#define xdc_runtime_Gate__INTERNAL__

#ifndef xdc_runtime_Gate__internalaccess
#define xdc_runtime_Gate__internalaccess
#endif
...
/* enterSystem */
#undef xdc_runtime_Gate_enterSystem
#define xdc_runtime_Gate_enterSystem xdc_runtime_Gate_enterSystem__F

/* leaveSystem */
#undef xdc_runtime_Gate_leaveSystem
#define xdc_runtime_Gate_leaveSystem xdc_runtime_Gate_leaveSystem__F

/* Module_startup */
#undef xdc_runtime_Gate_Module_startup
#define xdc_runtime_Gate_Module_startup xdc_runtime_Gate_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Gate_Instance_init
#define xdc_runtime_Gate_Instance_init xdc_runtime_Gate_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Gate_Instance_finalize
#define xdc_runtime_Gate_Instance_finalize xdc_runtime_Gate_Instance_finalize__F
...
#define Module__LOGFXN0 xdc_runtime_Gate_Module__loggerFxn0__C
#undef Module__LOGFXN1
#define Module__LOGFXN1 xdc_runtime_Gate_Module__loggerFxn1__C
#undef Module__LOGFXN2
#define Module__LOGFXN2 xdc_runtime_Gate_Module__loggerFxn2__C
...
#endif /* xdc_runtime_Gate__INTERNAL____ */
