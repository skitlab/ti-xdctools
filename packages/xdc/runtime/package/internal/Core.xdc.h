...
#define xdc_runtime_Core_Module_startup xdc_runtime_Core_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Core_Instance_init
#define xdc_runtime_Core_Instance_init xdc_runtime_Core_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Core_Instance_finalize
#define xdc_runtime_Core_Instance_finalize xdc_runtime_Core_Instance_finalize__F
