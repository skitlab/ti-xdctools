...
#define xdc_runtime_Memory_calloc xdc_runtime_Memory_calloc__F

/* free */
#undef xdc_runtime_Memory_free
#define xdc_runtime_Memory_free xdc_runtime_Memory_free__F

/* getStats */
#undef xdc_runtime_Memory_getStats
#define xdc_runtime_Memory_getStats xdc_runtime_Memory_getStats__F

/* query */
#undef xdc_runtime_Memory_query
#define xdc_runtime_Memory_query xdc_runtime_Memory_query__F

/* getMaxDefaultTypeAlign */
#undef xdc_runtime_Memory_getMaxDefaultTypeAlign
#define xdc_runtime_Memory_getMaxDefaultTypeAlign xdc_runtime_Memory_getMaxDefaultTypeAlign__F

/* valloc */
#undef xdc_runtime_Memory_valloc
#define xdc_runtime_Memory_valloc xdc_runtime_Memory_valloc__F

/* Module_startup */
#undef xdc_runtime_Memory_Module_startup
#define xdc_runtime_Memory_Module_startup xdc_runtime_Memory_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Memory_Instance_init
#define xdc_runtime_Memory_Instance_init xdc_runtime_Memory_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Memory_Instance_finalize
#define xdc_runtime_Memory_Instance_finalize xdc_runtime_Memory_Instance_finalize__F
