...
#define xdc_runtime_Memory_HeapProxy_alloc xdc_runtime_Memory_HeapProxy_alloc__F

/* free */
#undef xdc_runtime_Memory_HeapProxy_free
#define xdc_runtime_Memory_HeapProxy_free xdc_runtime_Memory_HeapProxy_free__F

/* isBlocking */
#undef xdc_runtime_Memory_HeapProxy_isBlocking
#define xdc_runtime_Memory_HeapProxy_isBlocking xdc_runtime_Memory_HeapProxy_isBlocking__F

/* getStats */
#undef xdc_runtime_Memory_HeapProxy_getStats
#define xdc_runtime_Memory_HeapProxy_getStats xdc_runtime_Memory_HeapProxy_getStats__F

/* Module_startup */
#undef xdc_runtime_Memory_HeapProxy_Module_startup
#define xdc_runtime_Memory_HeapProxy_Module_startup xdc_runtime_Memory_HeapProxy_Module_startup__F

/* Instance_init */
#undef xdc_runtime_Memory_HeapProxy_Instance_init
#define xdc_runtime_Memory_HeapProxy_Instance_init xdc_runtime_Memory_HeapProxy_Instance_init__F

/* Instance_finalize */
#undef xdc_runtime_Memory_HeapProxy_Instance_finalize
#define xdc_runtime_Memory_HeapProxy_Instance_finalize xdc_runtime_Memory_HeapProxy_Instance_finalize__F
