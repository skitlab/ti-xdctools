...
#define xdc_runtime_LoggerBuf_Module_GateProxy___VERS 150
...
__extern __FAR__ const CT__xdc_runtime_LoggerBuf_Module_GateProxy_Module__startupDoneFxn xdc_runtime_LoggerBuf_Module_GateProxy_Module__startupDoneFxn__C;
...
struct xdc_runtime_LoggerBuf_Module_GateProxy_Fxns__ {
    ...
    xdc_Void (*leave)(xdc_runtime_LoggerBuf_Module_GateProxy_Handle, xdc_IArg);
...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Handle__label__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Handle__label")
...
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Module__startupDone__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Module__startupDone")
__extern xdc_Bool xdc_runtime_LoggerBuf_Module_GateProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Object__create__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Object__create")
__extern xdc_Ptr xdc_runtime_LoggerBuf_Module_GateProxy_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar* __pa, xdc_SizeT __psz, xdc_runtime_Error_Block* __eb );

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Object__delete__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Object__delete")
__extern xdc_Void xdc_runtime_LoggerBuf_Module_GateProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Object__destruct__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Object__destruct")
__extern xdc_Void xdc_runtime_LoggerBuf_Module_GateProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Object__get__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Object__get")
__extern xdc_Ptr xdc_runtime_LoggerBuf_Module_GateProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Object__first__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Object__first")
__extern xdc_Ptr xdc_runtime_LoggerBuf_Module_GateProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Object__next__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Object__next")
__extern xdc_Ptr xdc_runtime_LoggerBuf_Module_GateProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Params__init__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Params__init")
__extern xdc_Void xdc_runtime_LoggerBuf_Module_GateProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__abstract__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__abstract")
__extern xdc_Bool xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__delegate__S, "xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__delegate")
__extern xdc_Ptr xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__delegate__S( void );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_query__R, "xdc_runtime_LoggerBuf_Module_GateProxy_query")
__extern xdc_Bool xdc_runtime_LoggerBuf_Module_GateProxy_query__R( xdc_Int qual );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_enter__R, "xdc_runtime_LoggerBuf_Module_GateProxy_enter")
__extern xdc_IArg xdc_runtime_LoggerBuf_Module_GateProxy_enter__R( xdc_runtime_LoggerBuf_Module_GateProxy_Handle __inst );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_Module_GateProxy_leave__R, "xdc_runtime_LoggerBuf_Module_GateProxy_leave")
__extern xdc_Void xdc_runtime_LoggerBuf_Module_GateProxy_leave__R( xdc_runtime_LoggerBuf_Module_GateProxy_Handle __inst, xdc_IArg key );
...
{
    return (xdc_runtime_LoggerBuf_Module_GateProxy_enter_FxnT)xdc_runtime_LoggerBuf_Module_GateProxy_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerBuf_Module_GateProxy_leave_FxnT)(void*, xdc_IArg);
static inline xdc_runtime_LoggerBuf_Module_GateProxy_leave_FxnT xdc_runtime_LoggerBuf_Module_GateProxy_leave_fxnP( void )
{
    return (xdc_runtime_LoggerBuf_Module_GateProxy_leave_FxnT)xdc_runtime_LoggerBuf_Module_GateProxy_leave; 
}
...
#define LoggerBuf_Module_GateProxy_enter_fxnP xdc_runtime_LoggerBuf_Module_GateProxy_enter_fxnP
#define LoggerBuf_Module_GateProxy_enter_FxnT xdc_runtime_LoggerBuf_Module_GateProxy_enter_FxnT
#define LoggerBuf_Module_GateProxy_leave xdc_runtime_LoggerBuf_Module_GateProxy_leave
#define LoggerBuf_Module_GateProxy_leave_fxnP xdc_runtime_LoggerBuf_Module_GateProxy_leave_fxnP
#define LoggerBuf_Module_GateProxy_leave_FxnT xdc_runtime_LoggerBuf_Module_GateProxy_leave_FxnT
