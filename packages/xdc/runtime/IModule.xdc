 ...
 *  @p
 *
 *  In the protypes below, `Mod` refers to the module being implemented, 
 ...
 *  be included in any file referencing these functions.  For a
 *  module named `Mod` in the package named `a.b.c`, the following statement
 *  includes this header.
 *  @p(code)
 *      #include <a/b/c/Mod.h>
 *  @p
 *
 *  In the protypes below, `IMod` referes to some interface, `Mod` refers to
...
interface IModule {
    ...
    /*! @_nodoc */
    @System Void Params__init(Ptr dst, Ptr src, SizeT psz, SizeT isz);
