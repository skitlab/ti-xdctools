...
#define xdc_runtime_IHeap___VERS 150
...
/* free_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IHeap_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
...
/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IHeap_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
