...
#define xdc_runtime_LoggerSys___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_LoggerSys_Instance_init__F, "xdc_runtime_LoggerSys_Instance_init")
__extern void xdc_runtime_LoggerSys_Instance_init__F( xdc_runtime_LoggerSys_Object*, const xdc_runtime_LoggerSys_Params* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_LoggerSys_Instance_init__R, "xdc_runtime_LoggerSys_Instance_init")
__extern void xdc_runtime_LoggerSys_Instance_init__R( xdc_runtime_LoggerSys_Object*, const xdc_runtime_LoggerSys_Params* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Handle__label__S, "xdc_runtime_LoggerSys_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_LoggerSys_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Module__startupDone__S, "xdc_runtime_LoggerSys_Module__startupDone")
__extern xdc_Bool xdc_runtime_LoggerSys_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Object__create__S, "xdc_runtime_LoggerSys_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Object__delete__S, "xdc_runtime_LoggerSys_Object__delete")
__extern xdc_Void xdc_runtime_LoggerSys_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Object__destruct__S, "xdc_runtime_LoggerSys_Object__destruct")
__extern xdc_Void xdc_runtime_LoggerSys_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Object__get__S, "xdc_runtime_LoggerSys_Object__get")
__extern xdc_Ptr xdc_runtime_LoggerSys_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Object__first__S, "xdc_runtime_LoggerSys_Object__first")
__extern xdc_Ptr xdc_runtime_LoggerSys_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Object__next__S, "xdc_runtime_LoggerSys_Object__next")
__extern xdc_Ptr xdc_runtime_LoggerSys_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Params__init__S, "xdc_runtime_LoggerSys_Params__init")
__extern xdc_Void xdc_runtime_LoggerSys_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_LoggerSys_enable__F, "xdc_runtime_LoggerSys_enable")
__extern xdc_Bool xdc_runtime_LoggerSys_enable__F( xdc_runtime_LoggerSys_Object* __inst );
__extern xdc_Bool xdc_runtime_LoggerSys_enable__R( xdc_runtime_LoggerSys_Handle __inst );
...
xdc__CODESECT(xdc_runtime_LoggerSys_disable__F, "xdc_runtime_LoggerSys_disable")
__extern xdc_Bool xdc_runtime_LoggerSys_disable__F( xdc_runtime_LoggerSys_Object* __inst );
__extern xdc_Bool xdc_runtime_LoggerSys_disable__R( xdc_runtime_LoggerSys_Handle __inst );
...
xdc__CODESECT(xdc_runtime_LoggerSys_write0__F, "xdc_runtime_LoggerSys_write0")
__extern xdc_Void xdc_runtime_LoggerSys_write0__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid );
__extern xdc_Void xdc_runtime_LoggerSys_write0__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid );
...
xdc__CODESECT(xdc_runtime_LoggerSys_write1__F, "xdc_runtime_LoggerSys_write1")
__extern xdc_Void xdc_runtime_LoggerSys_write1__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1 );
__extern xdc_Void xdc_runtime_LoggerSys_write1__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1 );
...
xdc__CODESECT(xdc_runtime_LoggerSys_write2__F, "xdc_runtime_LoggerSys_write2")
__extern xdc_Void xdc_runtime_LoggerSys_write2__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2 );
__extern xdc_Void xdc_runtime_LoggerSys_write2__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2 );
...
xdc__CODESECT(xdc_runtime_LoggerSys_write4__F, "xdc_runtime_LoggerSys_write4")
__extern xdc_Void xdc_runtime_LoggerSys_write4__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
__extern xdc_Void xdc_runtime_LoggerSys_write4__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
...
xdc__CODESECT(xdc_runtime_LoggerSys_write8__F, "xdc_runtime_LoggerSys_write8")
__extern xdc_Void xdc_runtime_LoggerSys_write8__F( xdc_runtime_LoggerSys_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
__extern xdc_Void xdc_runtime_LoggerSys_write8__R( xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
...
/* enable_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_LoggerSys_enable_FxnT)(void*);
static inline xdc_runtime_LoggerSys_enable_FxnT xdc_runtime_LoggerSys_enable_fxnP( void )
{
    return (xdc_runtime_LoggerSys_enable_FxnT)xdc_runtime_LoggerSys_enable; 
}

/* disable_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_LoggerSys_disable_FxnT)(void*);
static inline xdc_runtime_LoggerSys_disable_FxnT xdc_runtime_LoggerSys_disable_fxnP( void )
{
    return (xdc_runtime_LoggerSys_disable_FxnT)xdc_runtime_LoggerSys_disable; 
}

/* write0_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write0_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId);
static inline xdc_runtime_LoggerSys_write0_FxnT xdc_runtime_LoggerSys_write0_fxnP( void )
{
    return (xdc_runtime_LoggerSys_write0_FxnT)xdc_runtime_LoggerSys_write0; 
}

/* write1_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write1_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg);
static inline xdc_runtime_LoggerSys_write1_FxnT xdc_runtime_LoggerSys_write1_fxnP( void )
{
    return (xdc_runtime_LoggerSys_write1_FxnT)xdc_runtime_LoggerSys_write1; 
}

/* write2_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write2_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg);
static inline xdc_runtime_LoggerSys_write2_FxnT xdc_runtime_LoggerSys_write2_fxnP( void )
{
    return (xdc_runtime_LoggerSys_write2_FxnT)xdc_runtime_LoggerSys_write2; 
}

/* write4_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write4_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
static inline xdc_runtime_LoggerSys_write4_FxnT xdc_runtime_LoggerSys_write4_fxnP( void )
{
    return (xdc_runtime_LoggerSys_write4_FxnT)xdc_runtime_LoggerSys_write4; 
}

/* write8_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerSys_write8_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
static inline xdc_runtime_LoggerSys_write8_FxnT xdc_runtime_LoggerSys_write8_fxnP( void )
{
    return (xdc_runtime_LoggerSys_write8_FxnT)xdc_runtime_LoggerSys_write8; 
}
...
{
    if (dst) {
        xdc_runtime_LoggerSys_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_LoggerSys_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String xdc_runtime_LoggerSys_Handle_name( xdc_runtime_LoggerSys_Handle inst )
{
...
/* create */
static inline xdc_runtime_LoggerSys_Handle xdc_runtime_LoggerSys_create( const xdc_runtime_LoggerSys_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_LoggerSys_Handle)xdc_runtime_LoggerSys_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_LoggerSys_Params), __eb);
}

/* construct */
static inline void xdc_runtime_LoggerSys_construct( xdc_runtime_LoggerSys_Struct* __obj, const xdc_runtime_LoggerSys_Params* __prms )
{
    xdc_runtime_LoggerSys_Object__create__S(__obj, sizeof (xdc_runtime_LoggerSys_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_LoggerSys_Params), NULL);
}

/* delete */
static inline void xdc_runtime_LoggerSys_delete( xdc_runtime_LoggerSys_Handle* instp )
{
    xdc_runtime_LoggerSys_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_LoggerSys_destruct( xdc_runtime_LoggerSys_Struct* obj )
{
    xdc_runtime_LoggerSys_Object__destruct__S(obj);
}
...
#define LoggerSys_enable_fxnP xdc_runtime_LoggerSys_enable_fxnP
#define LoggerSys_enable_FxnT xdc_runtime_LoggerSys_enable_FxnT
#define LoggerSys_disable xdc_runtime_LoggerSys_disable
#define LoggerSys_disable_fxnP xdc_runtime_LoggerSys_disable_fxnP
#define LoggerSys_disable_FxnT xdc_runtime_LoggerSys_disable_FxnT
#define LoggerSys_write0 xdc_runtime_LoggerSys_write0
#define LoggerSys_write0_fxnP xdc_runtime_LoggerSys_write0_fxnP
#define LoggerSys_write0_FxnT xdc_runtime_LoggerSys_write0_FxnT
#define LoggerSys_write1 xdc_runtime_LoggerSys_write1
#define LoggerSys_write1_fxnP xdc_runtime_LoggerSys_write1_fxnP
#define LoggerSys_write1_FxnT xdc_runtime_LoggerSys_write1_FxnT
#define LoggerSys_write2 xdc_runtime_LoggerSys_write2
#define LoggerSys_write2_fxnP xdc_runtime_LoggerSys_write2_fxnP
#define LoggerSys_write2_FxnT xdc_runtime_LoggerSys_write2_FxnT
#define LoggerSys_write4 xdc_runtime_LoggerSys_write4
#define LoggerSys_write4_fxnP xdc_runtime_LoggerSys_write4_fxnP
#define LoggerSys_write4_FxnT xdc_runtime_LoggerSys_write4_FxnT
#define LoggerSys_write8 xdc_runtime_LoggerSys_write8
#define LoggerSys_write8_fxnP xdc_runtime_LoggerSys_write8_fxnP
#define LoggerSys_write8_FxnT xdc_runtime_LoggerSys_write8_FxnT
