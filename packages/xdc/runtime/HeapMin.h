...
#define xdc_runtime_HeapMin___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(xdc_runtime_HeapMin_Instance_init__F, "xdc_runtime_HeapMin_Instance_init")
__extern void xdc_runtime_HeapMin_Instance_init__F( xdc_runtime_HeapMin_Object*, const xdc_runtime_HeapMin_Params* );

/* Instance_init__R */
xdc__CODESECT(xdc_runtime_HeapMin_Instance_init__R, "xdc_runtime_HeapMin_Instance_init")
__extern void xdc_runtime_HeapMin_Instance_init__R( xdc_runtime_HeapMin_Object*, const xdc_runtime_HeapMin_Params* );

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_HeapMin_Handle__label__S, "xdc_runtime_HeapMin_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_HeapMin_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_HeapMin_Module__startupDone__S, "xdc_runtime_HeapMin_Module__startupDone")
__extern xdc_Bool xdc_runtime_HeapMin_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(xdc_runtime_HeapMin_Object__create__S, "xdc_runtime_HeapMin_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_HeapMin_Object__delete__S, "xdc_runtime_HeapMin_Object__delete")
__extern xdc_Void xdc_runtime_HeapMin_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_HeapMin_Object__destruct__S, "xdc_runtime_HeapMin_Object__destruct")
__extern xdc_Void xdc_runtime_HeapMin_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_HeapMin_Object__get__S, "xdc_runtime_HeapMin_Object__get")
__extern xdc_Ptr xdc_runtime_HeapMin_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_HeapMin_Object__first__S, "xdc_runtime_HeapMin_Object__first")
__extern xdc_Ptr xdc_runtime_HeapMin_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_HeapMin_Object__next__S, "xdc_runtime_HeapMin_Object__next")
__extern xdc_Ptr xdc_runtime_HeapMin_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_HeapMin_Params__init__S, "xdc_runtime_HeapMin_Params__init")
__extern xdc_Void xdc_runtime_HeapMin_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(xdc_runtime_HeapMin_getStats__F, "xdc_runtime_HeapMin_getStats")
__extern xdc_Void xdc_runtime_HeapMin_getStats__F( xdc_runtime_HeapMin_Object* __inst, xdc_runtime_Memory_Stats* stats );
__extern xdc_Void xdc_runtime_HeapMin_getStats__R( xdc_runtime_HeapMin_Handle __inst, xdc_runtime_Memory_Stats* stats );
...
xdc__CODESECT(xdc_runtime_HeapMin_alloc__F, "xdc_runtime_HeapMin_alloc")
__extern xdc_Ptr xdc_runtime_HeapMin_alloc__F( xdc_runtime_HeapMin_Object* __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
__extern xdc_Ptr xdc_runtime_HeapMin_alloc__R( xdc_runtime_HeapMin_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(xdc_runtime_HeapMin_free__F, "xdc_runtime_HeapMin_free")
__extern xdc_Void xdc_runtime_HeapMin_free__F( xdc_runtime_HeapMin_Object* __inst, xdc_Ptr block, xdc_SizeT size );
__extern xdc_Void xdc_runtime_HeapMin_free__R( xdc_runtime_HeapMin_Handle __inst, xdc_Ptr block, xdc_SizeT size );
...
xdc__CODESECT(xdc_runtime_HeapMin_isBlocking__F, "xdc_runtime_HeapMin_isBlocking")
__extern xdc_Bool xdc_runtime_HeapMin_isBlocking__F( xdc_runtime_HeapMin_Object* __inst );
__extern xdc_Bool xdc_runtime_HeapMin_isBlocking__R( xdc_runtime_HeapMin_Handle __inst );
...
/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_HeapMin_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline xdc_runtime_HeapMin_getStats_FxnT xdc_runtime_HeapMin_getStats_fxnP( void )
{
    return (xdc_runtime_HeapMin_getStats_FxnT)xdc_runtime_HeapMin_getStats; 
}

/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_HeapMin_alloc_FxnT)(void*, xdc_SizeT, xdc_SizeT, xdc_runtime_Error_Block*);
static inline xdc_runtime_HeapMin_alloc_FxnT xdc_runtime_HeapMin_alloc_fxnP( void )
{
    return (xdc_runtime_HeapMin_alloc_FxnT)xdc_runtime_HeapMin_alloc; 
}

/* free_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_HeapMin_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline xdc_runtime_HeapMin_free_FxnT xdc_runtime_HeapMin_free_fxnP( void )
{
    return (xdc_runtime_HeapMin_free_FxnT)xdc_runtime_HeapMin_free; 
}

/* isBlocking_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_HeapMin_isBlocking_FxnT)(void*);
static inline xdc_runtime_HeapMin_isBlocking_FxnT xdc_runtime_HeapMin_isBlocking_fxnP( void )
{
    return (xdc_runtime_HeapMin_isBlocking_FxnT)xdc_runtime_HeapMin_isBlocking; 
}
...
{
    if (dst) {
        xdc_runtime_HeapMin_Params__init__S(dst, (xdc_Ptr)src, sizeof(xdc_runtime_HeapMin_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String xdc_runtime_HeapMin_Handle_name( xdc_runtime_HeapMin_Handle inst )
{
...
/* create */
static inline xdc_runtime_HeapMin_Handle xdc_runtime_HeapMin_create( const xdc_runtime_HeapMin_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (xdc_runtime_HeapMin_Handle)xdc_runtime_HeapMin_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_HeapMin_Params), __eb);
}

/* construct */
static inline void xdc_runtime_HeapMin_construct( xdc_runtime_HeapMin_Struct* __obj, const xdc_runtime_HeapMin_Params* __prms )
{
    xdc_runtime_HeapMin_Object__create__S(__obj, sizeof (xdc_runtime_HeapMin_Struct), 0, (const xdc_UChar*)__prms, sizeof(xdc_runtime_HeapMin_Params), NULL);
}

/* delete */
static inline void xdc_runtime_HeapMin_delete( xdc_runtime_HeapMin_Handle* instp )
{
    xdc_runtime_HeapMin_Object__delete__S(instp);
}

/* destruct */
static inline void xdc_runtime_HeapMin_destruct( xdc_runtime_HeapMin_Struct* obj )
{
...
#define HeapMin_getStats_fxnP xdc_runtime_HeapMin_getStats_fxnP
#define HeapMin_getStats_FxnT xdc_runtime_HeapMin_getStats_FxnT
#define HeapMin_alloc xdc_runtime_HeapMin_alloc
#define HeapMin_alloc_fxnP xdc_runtime_HeapMin_alloc_fxnP
#define HeapMin_alloc_FxnT xdc_runtime_HeapMin_alloc_FxnT
#define HeapMin_free xdc_runtime_HeapMin_free
#define HeapMin_free_fxnP xdc_runtime_HeapMin_free_fxnP
#define HeapMin_free_FxnT xdc_runtime_HeapMin_free_FxnT
#define HeapMin_isBlocking xdc_runtime_HeapMin_isBlocking
#define HeapMin_isBlocking_fxnP xdc_runtime_HeapMin_isBlocking_fxnP
#define HeapMin_isBlocking_FxnT xdc_runtime_HeapMin_isBlocking_FxnT
