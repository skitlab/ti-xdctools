...
xdc__CODESECT(xdc_runtime_LoggerBuf_write0__F, "xdc_runtime_LoggerBuf_write0")
__extern xdc_Void xdc_runtime_LoggerBuf_write0__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid );
__extern xdc_Void xdc_runtime_LoggerBuf_write0__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_write1__F, "xdc_runtime_LoggerBuf_write1")
__extern xdc_Void xdc_runtime_LoggerBuf_write1__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1 );
__extern xdc_Void xdc_runtime_LoggerBuf_write1__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1 );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_write2__F, "xdc_runtime_LoggerBuf_write2")
__extern xdc_Void xdc_runtime_LoggerBuf_write2__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2 );
__extern xdc_Void xdc_runtime_LoggerBuf_write2__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2 );
...
__extern xdc_Void xdc_runtime_LoggerBuf_write4__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
__extern xdc_Void xdc_runtime_LoggerBuf_write4__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4 );
...
__extern xdc_Void xdc_runtime_LoggerBuf_write8__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
__extern xdc_Void xdc_runtime_LoggerBuf_write8__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_setFilterLevel__F, "xdc_runtime_LoggerBuf_setFilterLevel")
__extern xdc_Void xdc_runtime_LoggerBuf_setFilterLevel__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Diags_Mask mask, xdc_runtime_Diags_EventLevel filterLevel );
__extern xdc_Void xdc_runtime_LoggerBuf_setFilterLevel__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Diags_Mask mask, xdc_runtime_Diags_EventLevel filterLevel );
...
xdc__CODESECT(xdc_runtime_LoggerBuf_getFilterLevel__F, "xdc_runtime_LoggerBuf_getFilterLevel")
__extern xdc_runtime_Diags_Mask xdc_runtime_LoggerBuf_getFilterLevel__F( xdc_runtime_LoggerBuf_Object* __inst, xdc_runtime_Diags_EventLevel level );
__extern xdc_runtime_Diags_Mask xdc_runtime_LoggerBuf_getFilterLevel__R( xdc_runtime_LoggerBuf_Handle __inst, xdc_runtime_Diags_EventLevel level );
...
/* write0_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerBuf_write0_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId);
static inline xdc_runtime_LoggerBuf_write0_FxnT xdc_runtime_LoggerBuf_write0_fxnP( void )
{
    return (xdc_runtime_LoggerBuf_write0_FxnT)xdc_runtime_LoggerBuf_write0; 
}

/* write1_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerBuf_write1_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg);
static inline xdc_runtime_LoggerBuf_write1_FxnT xdc_runtime_LoggerBuf_write1_fxnP( void )
{
    return (xdc_runtime_LoggerBuf_write1_FxnT)xdc_runtime_LoggerBuf_write1; 
}

/* write2_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerBuf_write2_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg);
static inline xdc_runtime_LoggerBuf_write2_FxnT xdc_runtime_LoggerBuf_write2_fxnP( void )
{
    return (xdc_runtime_LoggerBuf_write2_FxnT)xdc_runtime_LoggerBuf_write2; 
}

/* write4_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerBuf_write4_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
/* write8_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_LoggerBuf_write8_FxnT)(void*, xdc_runtime_Log_Event, xdc_runtime_Types_ModuleId, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg, xdc_IArg);
...
typedef xdc_Void (*xdc_runtime_LoggerBuf_setFilterLevel_FxnT)(void*, xdc_runtime_Diags_Mask, xdc_runtime_Diags_EventLevel);
static inline xdc_runtime_LoggerBuf_setFilterLevel_FxnT xdc_runtime_LoggerBuf_setFilterLevel_fxnP( void )
{
    return (xdc_runtime_LoggerBuf_setFilterLevel_FxnT)xdc_runtime_LoggerBuf_setFilterLevel; 
}
...
{
    return (xdc_runtime_LoggerBuf_getFilterLevel_FxnT)xdc_runtime_LoggerBuf_getFilterLevel; 
}
...
#define LoggerBuf_write0_fxnP xdc_runtime_LoggerBuf_write0_fxnP
#define LoggerBuf_write0_FxnT xdc_runtime_LoggerBuf_write0_FxnT
#define LoggerBuf_write1 xdc_runtime_LoggerBuf_write1
#define LoggerBuf_write1_fxnP xdc_runtime_LoggerBuf_write1_fxnP
#define LoggerBuf_write1_FxnT xdc_runtime_LoggerBuf_write1_FxnT
#define LoggerBuf_write2 xdc_runtime_LoggerBuf_write2
#define LoggerBuf_write2_fxnP xdc_runtime_LoggerBuf_write2_fxnP
#define LoggerBuf_write2_FxnT xdc_runtime_LoggerBuf_write2_FxnT
...
#define LoggerBuf_setFilterLevel_fxnP xdc_runtime_LoggerBuf_setFilterLevel_fxnP
#define LoggerBuf_setFilterLevel_FxnT xdc_runtime_LoggerBuf_setFilterLevel_FxnT
#define LoggerBuf_getFilterLevel xdc_runtime_LoggerBuf_getFilterLevel
#define LoggerBuf_getFilterLevel_fxnP xdc_runtime_LoggerBuf_getFilterLevel_fxnP
#define LoggerBuf_getFilterLevel_FxnT xdc_runtime_LoggerBuf_getFilterLevel_FxnT
