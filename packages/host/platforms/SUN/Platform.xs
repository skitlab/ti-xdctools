...
{
    /* cache the platform instance name for the getExeContext method above. */
    this.$private.name = name;
}
/*
 *  @(#) host.platforms.SUN; 1, 0, 0, 1,402; 11-3-2012 15:18:53; /db/ztree/library/trees/xdc/xdc-y44x/src/packages/
 */
