...
public class host_platforms_arm
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("host.platforms.arm.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("host.platforms.arm.Platform$$create", new Proto.Fxn(om.findStrict("host.platforms.arm.Platform.Module", "host.platforms.arm"), om.findStrict("host.platforms.arm.Platform.Instance", "host.platforms.arm"), 3, 2, false));
        ...
        sb.append("host$platforms$arm$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("host.platforms.arm.Platform$$construct", new Proto.Fxn(om.findStrict("host.platforms.arm.Platform.Module", "host.platforms.arm"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("host.platforms.arm.Platform.Params", "host.platforms.arm"), Global.newObject());
        sb = new StringBuilder();
        sb.append("host$platforms$arm$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['host.platforms.arm.Platform'];\n");
