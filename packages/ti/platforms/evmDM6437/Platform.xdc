...
/*!
 *  ======== Platform ========
 *  Platform support for the evmDM6437
 *
...
instance:
    ...
    override readonly config xdc.platform.IPlatform.Memory
        externalMemoryMap[string] = [
            ...
            ["SRAM", {name: "SRAM", base: 0x42000000, len: 0x0200000}],
        ];
...
/*
 *  @(#) ti.platforms.evmDM6437; 1, 0, 0,348; 8-17-2012 22:15:22; /db/ztree/library/trees/platform/platform-n27x/src/
 */
