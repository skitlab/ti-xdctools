...
/*!
 *  ======== ti.platforms.evmDRA446 ========
 *  Platform package for the evmDRA446 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmDRA446 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDRA446.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDRA446 [1,0,0] {
    module Platform;
}
/*
