...
requires ti.catalog.arm.nda;
requires xdc.platform [1,0,1];

/*!
 *  ======== ti.platforms.simDucati ========
 *  Platform package for the simDucati platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the simDucati platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.simDucati.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.simDucati [1,0,1,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.simDucati; 1, 0, 1, 0,172; 8-17-2012 22:17:56; /db/ztree/library/trees/platform/platform-n27x/src/
 */
