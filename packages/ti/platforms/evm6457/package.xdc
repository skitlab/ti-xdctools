...
/*!
 *  ======== ti.platforms.evm6457 ========
 *  Platform package for the evm6457 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evm6457 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evm6457.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evm6457 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evm6457; 1, 0, 0,203; 8-17-2012 22:14:36; /db/ztree/library/trees/platform/platform-n27x/src/
 */
