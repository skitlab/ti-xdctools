 ...
 *  Platform package for the evmDM648 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmDM648 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDM648.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDM648 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmDM648; 1, 0, 0,346; 8-17-2012 22:15:31; /db/ztree/library/trees/platform/platform-n27x/src/
 */
