 ...
 *  Platform package for the DaVinci evmDM6446 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmDM6446 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDM6446.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDM6446 [1,0,0,1] {
    module Platform;
}
/*
