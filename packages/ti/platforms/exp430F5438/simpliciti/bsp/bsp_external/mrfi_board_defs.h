 ...
 * ------------------------------------------------------------------------------------------------
 */
#define __mrfi_GDO0_BIT__                     7
#define MRFI_CONFIG_GDO0_PIN_AS_INPUT()       st( P1DIR &= ~BV(__mrfi_GDO0_BIT__);) /* atomic operation */ 
...
#define MRFI_CONFIG_GDO2_PIN_AS_INPUT()       st( P1DIR &= ~BV(__mrfi_GDO2_BIT__);) /* atomic operation */ 
