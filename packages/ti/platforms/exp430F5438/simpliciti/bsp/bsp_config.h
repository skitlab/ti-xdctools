...
/*
 *  Custom clock configuration is available.  Provide values for FLLDx, N, and DCORSELx as
 ...
 *  #define BSP_CONFIG_MSP430_CUSTOM_DCORSEL    4
 */
 ...
 */
    ...
    (defined BSP_CONFIG_MSP430_CUSTOM_DCORSEL)
...
#define BSP_CONFIG_MSP430_FLLDx   FLLD_1
#define BSP_CONFIG_MSP430_N       91
#define BSP_CONFIG_MSP430_DCORSEL DCORSEL_4
#elif (BSP_CONFIG_CLOCK_MHZ_SELECT == 8)
#define BSP_CONFIG_CLOCK_MHZ      7.9954
#define BSP_CONFIG_MSP430_FLLDx   FLLD_1
#define BSP_CONFIG_MSP430_N       121
#define BSP_CONFIG_MSP430_DCORSEL DCORSEL_5
#elif (BSP_CONFIG_CLOCK_MHZ_SELECT == 10)
#define BSP_CONFIG_CLOCK_MHZ      10.093
#define BSP_CONFIG_MSP430_FLLDx   FLLD_2
#define BSP_CONFIG_MSP430_N       76
#define BSP_CONFIG_MSP430_DCORSEL DCORSEL_5
#elif (BSP_CONFIG_CLOCK_MHZ_SELECT == 12)
#define BSP_CONFIG_CLOCK_MHZ      12.0586
#define BSP_CONFIG_MSP430_FLLDx   FLLD_2
#define BSP_CONFIG_MSP430_N       91
#define BSP_CONFIG_MSP430_DCORSEL DCORSEL_6
#elif (BSP_CONFIG_CLOCK_MHZ_SELECT == 16)
#define BSP_CONFIG_CLOCK_MHZ      15.9908
#define BSP_CONFIG_MSP430_FLLDx   FLLD_2
#define BSP_CONFIG_MSP430_N       121
#define BSP_CONFIG_MSP430_DCORSEL DCORSEL_7
#else
