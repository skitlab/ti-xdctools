...
#define __bsp_BUTTON1_PORT__            P2IN
#define __bsp_BUTTON1_IS_ACTIVE_LOW__   1

// If button 1 is active low, then it needs to be pulled up internally
#if (1 == __bsp_BUTTON1_IS_ACTIVE_LOW__ )

  #define __bsp_BUTTON1_CONFIG_def__()    st(P2REN |= BV(__bsp_BUTTON1_BIT__); \
                                            P2OUT |= BV(__bsp_BUTTON1_BIT__);) 
#else   
  #define  __bsp_BUTTON1_CONFIG_def__()    /* nothing required */ 
#endif 
...
#define __bsp_BUTTON2_PORT__            P2IN
#define __bsp_BUTTON2_IS_ACTIVE_LOW__   1

// If button 1 is active low, then it needs to be pulled up internally
#if (1 == __bsp_BUTTON2_IS_ACTIVE_LOW__ )
  #define __bsp_BUTTON2_CONFIG_def__()    st(P2REN |= BV(__bsp_BUTTON2_BIT__); \
                                           P2OUT |= BV(__bsp_BUTTON2_BIT__);) 
#else   
  #define __bsp_BUTTON2_CONFIG_def__()    /* nothing required */ 
#endif 
