 ...
 *  Platform package for the dsk6455 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the dsk6455 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.dsk6455.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.dsk6455 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.dsk6455; 1, 0, 0,359; 8-17-2012 22:14:08; /db/ztree/library/trees/platform/platform-n27x/src/
 */
