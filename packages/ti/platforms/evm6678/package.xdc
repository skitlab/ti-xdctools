 ...
 *  Platform package for the 6678 EVM.
 *
 ...
 *  @p(dlist)                            
 *      -  `ti.platfoms.evm6678.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evm6678 [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evm6678; 1, 0, 0, 0,66; 8-17-2012 22:14:49; /db/ztree/library/trees/platform/platform-n27x/src/
 */
