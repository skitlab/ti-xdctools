...
/*!
 *  ======== ti.platforms.evmAM3517 ========
 *  Platform package for the evmAM3517 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmAM3517 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)
 *      -  `ti.platfoms.evmAM3517.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmAM3517 [1,0,0] {
    module Platform;
}
/*
