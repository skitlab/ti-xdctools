 ...
 *  Platform package for the evm6472 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evm6472 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evm6472.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evm6472 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evm6472; 1, 0, 0,112; 8-17-2012 22:14:39; /db/ztree/library/trees/platform/platform-n27x/src/
 */
