...
public class ti_platforms_simTesla
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.platforms.simTesla.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.simTesla.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.simTesla.Platform.Module", "ti.platforms.simTesla"), om.findStrict("ti.platforms.simTesla.Platform.Instance", "ti.platforms.simTesla"), 3, 2, false));
        ...
        sb.append("ti$platforms$simTesla$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.simTesla.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.simTesla.Platform.Module", "ti.platforms.simTesla"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.simTesla.Platform.Params", "ti.platforms.simTesla"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$simTesla$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.simTesla.Platform'];\n");
