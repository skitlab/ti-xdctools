...
function getExecCmd(prog)
{
    ...
    if (os == "Windows" || os == "Linux") {
        try {
            ...
            return("@$(ECHO) sim55xx platform package does not know how to " +
        ...
        command += " -t " + timeout + " -s -r -n :TMS320C5510 " + verbose;
        command += " -b " + this.ftpath + "/targetdb/Sim_C5510.xml";
        command += " -u 127.0.0.1";
...
/*
 *  @(#) ti.platforms.sim55xx; 1, 0, 1, 1,116; 8-17-2012 22:17:12; /db/ztree/library/trees/platform/platform-n27x/src/
 */
