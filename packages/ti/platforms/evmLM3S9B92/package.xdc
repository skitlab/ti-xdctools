...
/*!
 *  ======== ti.platforms.evmLM3S9B92 ========
 *  Platform package for the evmLM3S9B92 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmLM3S9B92 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmLM3S9B92.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmLM3S9B92 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmLM3S9B92; 1, 0, 0,134; 8-17-2012 22:15:48; /db/ztree/library/trees/platform/platform-n27x/src/
 */
