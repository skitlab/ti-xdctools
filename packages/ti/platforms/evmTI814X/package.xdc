 ...
 *  Platform package for the evmTI814X platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmTI814X platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)
 *      -  `ti.platfoms.evmTI814X.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmTI814X [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmTI814X; 1, 0, 0,63; 8-17-2012 22:16:07; /db/ztree/library/trees/platform/platform-n27x/src/
 */
