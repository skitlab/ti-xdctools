...
public class ti_platforms_evmTI814X
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.platforms.evmTI814X.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evmTI814X.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.evmTI814X.Platform.Module", "ti.platforms.evmTI814X"), om.findStrict("ti.platforms.evmTI814X.Platform.Instance", "ti.platforms.evmTI814X"), 3, 2, false));
        ...
        sb.append("ti$platforms$evmTI814X$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evmTI814X.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.evmTI814X.Platform.Module", "ti.platforms.evmTI814X"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.evmTI814X.Platform.Params", "ti.platforms.evmTI814X"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$evmTI814X$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.evmTI814X.Platform'];\n");
