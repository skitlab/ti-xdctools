 ...
 *  Platform package for the evmDA830 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmDA830 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDA830.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDA830 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmDA830; 1, 0, 0,175; 8-17-2012 22:15:07; /db/ztree/library/trees/platform/platform-n27x/src/
 */
