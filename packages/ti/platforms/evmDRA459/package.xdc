...
/*!
 *  ======== ti.platforms.evmDRA459 ========
 *  Platform package for the evmDRA459 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmDRA459 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDRA459.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDRA459 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmDRA459; 1, 0, 0,134; 8-17-2012 22:15:42; /db/ztree/library/trees/platform/platform-n27x/src/
 */
