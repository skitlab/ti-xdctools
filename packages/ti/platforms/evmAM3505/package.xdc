...
/*!
 *  ======== ti.platforms.evmAM3505 ========
 *  Platform package for the evmAM3505 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmAM3505 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)
 *      -  `ti.platfoms.evmAM3505.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmAM3505 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmAM3505; 1, 0, 0,19; 8-17-2012 22:14:57; /db/ztree/library/trees/platform/platform-n27x/src/
 */
