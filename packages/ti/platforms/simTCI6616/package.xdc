 ...
 *  Platform package for the TCI6616 simulator.
 *
 ...
 *  @p(dlist)                            
 *      -  `ti.platfoms.simTCI6616.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.simTCI6616 [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.simTCI6616; 1, 0, 0, 0,80; 8-17-2012 22:18:05; /db/ztree/library/trees/platform/platform-n27x/src/
 */
