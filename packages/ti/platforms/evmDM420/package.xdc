...
/*!
 *  ======== ti.platforms.evmDM420 ========
 *  Platform package for the DaVinci evmDM420 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmDM420 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDM420.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDM420 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmDM420; 1, 0, 0,358; 8-17-2012 22:15:19; /db/ztree/library/trees/platform/platform-n27x/src/
 */
