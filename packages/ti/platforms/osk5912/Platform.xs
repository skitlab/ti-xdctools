...
function getExeContext(prog)
{
    ...
    if (this.codeMemory == undefined) {
        if (this.$private.args.core == "GPP") {
            this.codeMemory = "SDRAM";
            this.dataMemory = "SRAM";
            this.stackMemory = "SRAM";
        }
        else {
            this.codeMemory = "SARAM";
            this.dataMemory = "DARAM";
            this.stackMemory = "DARAM";
        }
    }
...
/*
 *  @(#) ti.platforms.osk5912; 1, 0, 1, 0,368; 8-17-2012 22:16:47; /db/ztree/library/trees/platform/platform-n27x/src/
 */
