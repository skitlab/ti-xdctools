...
/*!
 *  ======== ti.platforms.expOMAPL138 ========
 *  Platform package for the expOMAPL138 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the expOMAPL138 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.expOMAPL138.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.expOMAPL138 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.expOMAPL138; 1, 0, 0,128; 8-17-2012 22:16:21; /db/ztree/library/trees/platform/platform-n27x/src/
 */
