...
package ti.platforms.expOMAPL138;

/*!
 *  ======== Platform ========
 *  Platform support for the expOMAPL138
 *
...
metaonly module Platform inherits xdc.platform.IPlatform
{
    readonly config xdc.platform.IPlatform.Board BOARD = {      
        id:             "0",
        boardName:      "expOMAPL138",
        boardFamily:    "expOMAPL138",
        boardRevision:  null,
    };
...
instance:
    ...
    /* 
     *  DDR is 64MByte but we need to share it with Arm.
