...
/*!
 *  ======== ti.platforms.evm6424 ========
 *  Platform package for the evm6424 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evm6424 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evm6424.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evm6424 [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evm6424; 1, 0, 0, 0,333; 8-17-2012 22:14:32; /db/ztree/library/trees/platform/platform-n27x/src/
 */
