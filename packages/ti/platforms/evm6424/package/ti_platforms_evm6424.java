...
public class ti_platforms_evm6424
{
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evm6424.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.evm6424.Platform.Module", "ti.platforms.evm6424"), om.findStrict("ti.platforms.evm6424.Platform.Instance", "ti.platforms.evm6424"), 3, 2, false));
        ...
        sb.append("ti$platforms$evm6424$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evm6424.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.evm6424.Platform.Module", "ti.platforms.evm6424"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.evm6424.Platform.Params", "ti.platforms.evm6424"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$evm6424$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.evm6424.Platform'];\n");
