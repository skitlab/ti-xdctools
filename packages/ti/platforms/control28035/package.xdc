...
/*!
 *  ======== ti.platforms.control28035 ========
 *  Platform package for the 28035 control card.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the 28035 controlCARD platform.
 */
package ti.platforms.control28035 [1,0,0] {
    module Platform;
}
/*
