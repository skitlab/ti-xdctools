...
/*!
 *  ======== ti.platforms.sim62xx ========
 *  Platform package for the sim62xx platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the sim62xx platform.
 */
package ti.platforms.sim62xx [1,0,0] {
    module Platform;
}
/*
