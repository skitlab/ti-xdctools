...
public class ti_platforms_evmTNETV107X
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.platforms.evmTNETV107X.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evmTNETV107X.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.evmTNETV107X.Platform.Module", "ti.platforms.evmTNETV107X"), om.findStrict("ti.platforms.evmTNETV107X.Platform.Instance", "ti.platforms.evmTNETV107X"), 3, 2, false));
        ...
        sb.append("ti$platforms$evmTNETV107X$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evmTNETV107X.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.evmTNETV107X.Platform.Module", "ti.platforms.evmTNETV107X"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.evmTNETV107X.Platform.Params", "ti.platforms.evmTNETV107X"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$evmTNETV107X$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.evmTNETV107X.Platform'];\n");
