...
public class ti_platforms_sim28xx
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.platforms.sim28xx.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.sim28xx.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.sim28xx.Platform.Module", "ti.platforms.sim28xx"), om.findStrict("ti.platforms.sim28xx.Platform.Instance", "ti.platforms.sim28xx"), 3, 2, false));
        ...
        sb.append("ti$platforms$sim28xx$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.sim28xx.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.sim28xx.Platform.Module", "ti.platforms.sim28xx"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.sim28xx.Platform.Params", "ti.platforms.sim28xx"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$sim28xx$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.sim28xx.Platform'];\n");
