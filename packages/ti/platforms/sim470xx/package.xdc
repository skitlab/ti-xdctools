 ...
 *  necessary to build and run executables on the sim470xx platform.
 *
 *  @a(Throws)
...
/*
 *  @(#) ti.platforms.sim470xx; 1, 0, 1, 1,116; 8-17-2012 22:17:06; /db/ztree/library/trees/platform/platform-n27x/src/
 */
