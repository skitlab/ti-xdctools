...
instance:
    ...
    override readonly config xdc.platform.IPlatform.Memory
        externalMemoryMap[string] = [
            ["SDRAM", {name: "SDRAM", base: 0x80000000, len: 0x08000000}],
        ];
...
/*
 *  @(#) ti.platforms.padk6727; 1, 0, 0,369; 8-17-2012 22:16:50; /db/ztree/library/trees/platform/platform-n27x/src/
 */
