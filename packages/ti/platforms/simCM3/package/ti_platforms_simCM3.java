...
public class ti_platforms_simCM3
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.platforms.simCM3.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.simCM3.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.simCM3.Platform.Module", "ti.platforms.simCM3"), om.findStrict("ti.platforms.simCM3.Platform.Instance", "ti.platforms.simCM3"), 3, 2, false));
        ...
        sb.append("ti$platforms$simCM3$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.simCM3.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.simCM3.Platform.Module", "ti.platforms.simCM3"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.simCM3.Platform.Params", "ti.platforms.simCM3"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$simCM3$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.simCM3.Platform'];\n");
