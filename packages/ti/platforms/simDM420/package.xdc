...
/*!
 *  ======== ti.platforms.simDM420 ========
 *  Platform package for the simDM420 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the simDM420 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.simDM420.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.simDM420 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.simDM420; 1, 0, 0,369; 8-17-2012 22:17:47; /db/ztree/library/trees/platform/platform-n27x/src/
 */
