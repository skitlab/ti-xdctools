 ...
 *  Platform package for the TCI6608 simulator.
 *
 ...
 *  @p(dlist)                            
 *      -  `ti.platfoms.simTCI6608.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.simTCI6608 [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.simTCI6608; 1, 0, 0, 0,76; 8-17-2012 22:18:01; /db/ztree/library/trees/platform/platform-n27x/src/
 */
