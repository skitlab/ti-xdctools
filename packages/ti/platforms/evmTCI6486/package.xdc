 ...
 *  Platform package for the evmTCI6486 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmTCI6486 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmTCI6486.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmTCI6486 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmTCI6486; 1, 0, 0,173; 8-17-2012 22:15:58; /db/ztree/library/trees/platform/platform-n27x/src/
 */
