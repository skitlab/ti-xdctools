...
/*!
 *  ======== ti.platforms.dskTCI6482 ========
 *  Platform package for the dskTCI6482 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the dskTCI6482 platform.
 *
 *  @a(Throws)
...
/*
 *  @(#) ti.platforms.dskTCI6482; 1, 0, 0,359; 8-17-2012 22:14:15; /db/ztree/library/trees/platform/platform-n27x/src/
 */
