...
/*!
 *  ======== ti.platforms.evmTCI6488 ========
 *  Platform package for the evmTCI6488 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmTCI6488 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmTCI6488.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmTCI6488 [1,0,0] {
    module Platform;
}
/*
