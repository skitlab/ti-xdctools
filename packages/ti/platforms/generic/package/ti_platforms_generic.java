...
public class ti_platforms_generic
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.platforms.generic.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.generic.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.generic.Platform.Module", "ti.platforms.generic"), om.findStrict("ti.platforms.generic.Platform.Instance", "ti.platforms.generic"), 3, 2, false));
        ...
        sb.append("ti$platforms$generic$Platform$$create = function( name, args, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.generic.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.generic.Platform.Module", "ti.platforms.generic"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.generic.Platform.Params", "ti.platforms.generic"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$generic$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.generic.Platform'];\n");
