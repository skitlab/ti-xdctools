 ...
 *  Platform package for the sdp2430 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the sdp2430 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.sdp2430.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.sdp2430 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.sdp2430; 1, 0, 0,354; 8-17-2012 22:16:53; /db/ztree/library/trees/platform/platform-n27x/src/
 */
