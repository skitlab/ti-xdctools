 ...
 *  Platform package for the OMAP5430 SDP.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the OMAP5430 SDP platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)
 *      -  `ti.platforms.sdp5430.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.sdp5430 [1,0,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.sdp5430; 1, 0, 0, 0,18; 8-17-2012 22:17:00; /db/ztree/library/trees/platform/platform-n27x/src/
 */
