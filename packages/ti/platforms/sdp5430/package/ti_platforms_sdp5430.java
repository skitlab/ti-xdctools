...
public class ti_platforms_sdp5430
{
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.sdp5430.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.sdp5430.Platform.Module", "ti.platforms.sdp5430"), om.findStrict("ti.platforms.sdp5430.Platform.Instance", "ti.platforms.sdp5430"), 3, 2, false));
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.sdp5430.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.sdp5430.Platform.Module", "ti.platforms.sdp5430"), null, 4, 2, false));
                ...
                fxn.addArg(3, "__params", (Proto)om.findStrict("ti.platforms.sdp5430.Platform.Params", "ti.platforms.sdp5430"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$sdp5430$Platform$$construct = function( __obj, name, args, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.sdp5430.Platform'];\n");
