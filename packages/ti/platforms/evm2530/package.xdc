 ...
 *  Platform package for the evm2530 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evm2530 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evm2530.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evm2530 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evm2530; 1, 0, 0,276; 8-17-2012 22:14:17; /db/ztree/library/trees/platform/platform-n27x/src/
 */
