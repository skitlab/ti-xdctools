...
function getExeContext(prog)
{
    ...
    if (prog.build.cpuArgs != null) {
        this.$module.$logWarning("The parameter 'cpuArgs' in xdc.bld.Executable"
            + " is not supported. Please, use corresponding platform instance"
            + " parameters to set the initial register settings.", this.$module,
            null);
    }
...
/*
 *  @(#) ti.platforms.evm6670; 1, 0, 0, 0,66; 8-17-2012 22:14:46; /db/ztree/library/trees/platform/platform-n27x/src/
 */
