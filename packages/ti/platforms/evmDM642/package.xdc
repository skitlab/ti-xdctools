...
/*!
 *  ======== ti.platforms.evmDM642 ========
 *  Platform package for the EVMDM642 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the EVMDM642 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmDM642.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmDM642 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmDM642; 1, 0, 0,373; 8-17-2012 22:15:21; /db/ztree/library/trees/platform/platform-n27x/src/
 */
