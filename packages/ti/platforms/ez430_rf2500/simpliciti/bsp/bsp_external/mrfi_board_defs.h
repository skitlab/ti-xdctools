 ...
 **************************************************************************************************
 */
#ifndef BSP_BOARD_EZ430RF
  #error "ERROR: Mismatch between specified board and MRFI configuration."
#endif
#ifndef MRFI_CC2500
/* either the user forgot to specify the radio or specified the wrong one */
  #error "ERROR: A CC2500 compatible radio must be specified for this board."
#endif
