 ...
 *  Platform package for the evmOMAPL137 platform.
 *
 *  This package implements the interfaces (xdc.platform.IPlatform)
 *  necessary to build and run executables on the evmOMAPL137 platform.
 *
 *  @a(Throws)
 *  `XDCException` exceptions are thrown for fatal errors. The following error
 *  codes are reported in the exception message:
 *  @p(dlist)                            
 *      -  `ti.platfoms.evmOMAPL137.LINK_TEMPLATE_ERROR`
 ...
 *  @p
 */
package ti.platforms.evmOMAPL137 [1,0,0] {
    module Platform;
}
/*
 *  @(#) ti.platforms.evmOMAPL137; 1, 0, 0,161; 8-17-2012 22:15:52; /db/ztree/library/trees/platform/platform-n27x/src/
 */
