...
public class ti_targets_rts6000
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/ti.targets.rts6000.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            sb.append("['lib/boot.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.a67P', {target: 'ti.targets.C67P', suffix: '67P'}],\n");
            sb.append("['lib/boot.a67P', {target: 'ti.targets.C67P', suffix: '67P'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.a64T', {target: 'ti.targets.C64T', suffix: '64T'}],\n");
            sb.append("['lib/boot.a64T', {target: 'ti.targets.C64T', suffix: '64T'}],\n");
            sb.append("['lib/ti.targets.rts6000.a64Te', {target: 'ti.targets.C64T_big_endian', suffix: '64Te'}],\n");
            sb.append("['lib/boot.a64Te', {target: 'ti.targets.C64T_big_endian', suffix: '64Te'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            sb.append("['lib/boot.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.ae64Te', {target: 'ti.targets.elf.C64T_big_endian', suffix: 'e64Te'}],\n");
            sb.append("['lib/boot.ae64Te', {target: 'ti.targets.elf.C64T_big_endian', suffix: 'e64Te'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.ae67P', {target: 'ti.targets.elf.C67P', suffix: 'e67P'}],\n");
            sb.append("['lib/boot.ae67P', {target: 'ti.targets.elf.C67P', suffix: 'e67P'}],\n");
