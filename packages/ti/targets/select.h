...
#  if defined(__TMS320C55X_PLUS_WORD__)
#    define xdc_target_name__ C55P_word
#  elif defined(__TMS320C55X_PLUS_BYTE__)
#    warn byte mode C55 not supported
#  elif defined(__LARGE_MODEL__)
     /* Expands to 1 when the -ml compiler option is specified */
#    define xdc_target_name__ C55_large
#  elif defined(__HUGE_MODEL__)
     /* Expands to 1 when the --memory_model=huge option is specified */
#    define xdc_target_name__ C55_huge
#  else
#    define xdc_target_name__ C55
#  endif
#  define xdc_target_types__ ti/targets/std.h
 ...
 *  C54 support
 */
#elif defined(__TMS320C5XX__)
#  if defined(_FAR_MODE)
#    define xdc_target_name__ C54_far
#  else
#    define xdc_target_name__ C54
#  endif
#  define xdc_target_types__ ti/targets/std.h
