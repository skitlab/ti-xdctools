...
metaonly module C66_big_endian inherits ITarget {
    ...
    override readonly config string suffix               = "66e";
     ...
     *  ======== compatibleSuffixes ========
     */
    override config String compatibleSuffixes[] = ["674e", "64Pe"];
    ...
    override config xdc.bld.ITarget2.Options lnkOpts = {
        ...
        suffix: "-c -m $(XDCCFGDIR)/$@.map -l $(rootDir)/lib/rts6600e_coff.lib"
    };
