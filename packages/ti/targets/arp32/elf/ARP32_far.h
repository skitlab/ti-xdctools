 ...
 */
#define xdc_target__isaCompatible_arp32  1

/*
 *  ======== xdc_target__isa_arp32 ========
 *  This macro identifies the specific target ISA for which we are being
 *  compiled.
 */
#define xdc_target__isa_arp32  1
