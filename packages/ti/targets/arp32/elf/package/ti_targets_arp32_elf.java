...
public class ti_targets_arp32_elf
{
    ...
    void ARP32$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "ti/targets/arp32/elf/ARP32.xs");
        om.bind("ti.targets.arp32.elf.ARP32$$capsule", cap);
        po = (Proto.Obj)om.findStrict("ti.targets.arp32.elf.ARP32.Module", "ti.targets.arp32.elf");
        po.init("ti.targets.arp32.elf.ARP32.Module", om.findStrict("ti.targets.ITarget.Module", "ti.targets.arp32.elf"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("name", $$T_Str, "ARP32", "rh");
        po.addFld("suffix", $$T_Str, "earp32", "rh");
        po.addFld("isa", $$T_Str, "arp32", "rh");
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "ti.targets.arp32.elf"), Global.newObject("endian", "little", "shortEnums", true), "rh");
        ...
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.arp32.elf"), Global.newObject("cmd", "cl-arp32 -c --gen_func_subsections", "opts", "--silicon_version=v210"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.arp32.elf"), Global.newObject("cmd", "cl-arp32 -c --gen_func_subsections", "opts", "--silicon_version=v210"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.arp32.elf"), Global.newObject("cmd", "lnk-arp32", "opts", ""), "rh");
        ...
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.arp32.elf"), Global.newObject("prefix", "-w -q -u _c_int00", "suffix", "-c -m $(XDCCFGDIR)/$@.map -l $(rootDir)/lib/rtsarp32_v200.lib"), "wh");
        ...
        if (fxn != null) om.bind("ti.targets.arp32.elf.ARP32$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("ti.targets.arp32.elf.ARP32$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("ti.targets.arp32.elf.ARP32$$module$validate", true);
    ...
    void ARP32_far$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "ti/targets/arp32/elf/ARP32_far.xs");
        om.bind("ti.targets.arp32.elf.ARP32_far$$capsule", cap);
        po = (Proto.Obj)om.findStrict("ti.targets.arp32.elf.ARP32_far.Module", "ti.targets.arp32.elf");
        po.init("ti.targets.arp32.elf.ARP32_far.Module", om.findStrict("ti.targets.ITarget.Module", "ti.targets.arp32.elf"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        ...
        po.addFld("binaryParser", $$T_Str, "ti.targets.omf.elf.Elf32", "wh");
        fxn = Global.get(cap, "module$use");
        if (fxn != null) om.bind("ti.targets.arp32.elf.ARP32_far$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("ti.targets.arp32.elf.ARP32_far$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("ti.targets.arp32.elf.ARP32_far$$module$validate", true);
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                fxn = Global.get(cap, "archive");
                if (fxn != null) po.addFxn("archive", (Proto.Fxn)om.findStrict("xdc.bld.ITarget$$archive", "ti.targets.arp32.elf"), fxn);
                fxn = Global.get(cap, "compile");
    ...
    void ARP32$$SINGLETONS()
    {
        ...
        vo.bind("$capsule", om.findStrict("ti.targets.arp32.elf.ARP32$$capsule", "ti.targets.arp32.elf"));
    ...
    void ARP32_far$$SINGLETONS()
    {
        ...
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.findStrict("ti.targets.arp32.elf.ARP32_far$$capsule", "ti.targets.arp32.elf"));
        vo.bind("$package", om.findStrict("ti.targets.arp32.elf", "ti.targets.arp32.elf"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
