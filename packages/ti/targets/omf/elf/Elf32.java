...
public class Elf32 implements xdc.rta.IOFReader, xdc.rov.ISymbolTable
{
    ...
    static public class SymbolTableEntry {
        ...
        /*
         * st_info types as defined by the elf documentation. We're not interested
         * in symbols of these types.
         */
         ...
         *  
         *  TODO - 17 appears to be the value for data symbols, but I have not found
         *  this in documentation. 18 appears to be the value for program symbols.
         */
        private static final char LINKER_SYMBOL = 16;
        private static final char DATA_SYMBOL = 17;
        private static final char PROGRAM_SYMBOL = 18;
    }
     ...
     */
    public void parseSymbols() throws java.io.IOException
    {
        ...
        */
        ...
        for (int i = 0; i < numSymbols; i++) {
            ...
            if ((entry.st_info == SymbolTableEntry.LINKER_SYMBOL) ||
                (entry.st_info == SymbolTableEntry.DATA_SYMBOL) || 
                (entry.st_info == SymbolTableEntry.PROGRAM_SYMBOL)) {
                ...
                if (entry.st_info == SymbolTableEntry.DATA_SYMBOL) {
                    symsByVal = dataSymsByVal;
                }
                else if (entry.st_info == SymbolTableEntry.PROGRAM_SYMBOL) {
     ...
     *  ByteBuffer.
     */
    private ByteBuffer readSectionBytes(SectHeader hdr) throws java.io.IOException
    {        
    ...
    public static void main(String args[])
    {
        ...
        try {
            for (int i = 0; i < args.length - 1; i += 2) {
                ...
                /* Lookup a symbol. */
                long val = elf.getSymbolValue("xdc_runtime_Memory_Module__state__V");
                System.out.println("Looking up 'xdc_runtime_Memory_Module__state__V': 0x" + 
                                    Long.toHexString(val));
                val = elf.getSymbolValue("__stack");
                System.out.println("Looking up '__stack': 0x" + 
                                    Long.toHexString(val));
