...
public class ti_targets_omf_cof
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/cof_ti.a86U', {target: 'gnu.targets.Linux86', suffix: '86U'}],\n");
            sb.append("['lib/cof_ti.a5', {target: 'gnu.targets.Sparc', suffix: '5'}],\n");
            sb.append("['lib/cof_ti.a470MV', {target: 'gnu.targets.arm.MVArm9', suffix: '470MV'}],\n");
            sb.append("['lib/debug/cof_ti.lib', {target: 'microsoft.targets.VC98', suffix: '86'}],\n");
            sb.append("['lib/release/cof_ti.lib', {target: 'microsoft.targets.VC98', suffix: '86'}],\n");
        sb.append("];\n");
