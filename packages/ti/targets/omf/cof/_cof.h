...
#    define _COF_SECTHDRSIZE01 ((Uns)&(((COF_SectHdr01*)NULL)->pageNum) \
             + sizeof(((COF_SectHdr01*)NULL)->pageNum))

#    define _COF_SECTHDRSIZE2 ((Uns)&(((COF_SectHdr*)NULL)->pageNum) \
...
#    define _COF_SECTHDRSIZE01 ((Uns)&(((COF_SectHdr01*)NULL)->flags) \
             + sizeof(((COF_SectHdr01*)NULL)->flags))

#    define _COF_SECTHDRSIZE2 ((Uns)&(((COF_SectHdr*)NULL)->flags) \
...
#define _COF_FILEHDRSIZE ((Uns)&(((COF_FileHdr*)NULL)->magic) \
