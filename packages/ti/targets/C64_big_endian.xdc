 ...
 *  TI C64 big endian 
 */
metaonly module C64_big_endian inherits ti.targets.ITarget {
    override readonly config string name                 = "C64_big_endian";
    override readonly config string suffix               = "64e";
    ...
    override config xdc.bld.ITarget2.Options lnkOpts = {
        ...
        suffix: "-c -m $(XDCCFGDIR)/$@.map -l $(rootDir)/lib/rts6400e.lib"
    };
