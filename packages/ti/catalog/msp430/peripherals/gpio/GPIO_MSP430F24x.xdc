 ...
 */
metaonly module GPIO_MSP430F24x inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of this peripheral. Use a customized
     *  init function so that we can get access to the ADC12,
     *  Comparator_A, and SVS, and BCS+ instances.
     */
    create(ADC12.Instance adc12, Comparator.Instance comparator, SVS.Instance svs,
...
instance:
     ...
     *  MSP430F24x device, there are 6 x 8 = 48 pins total.
     */
