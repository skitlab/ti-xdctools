...
/*!
 *  ======== GPIO for MSP430G2x53 ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430G2x53 inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of this peripheral. Use a customized
     *  init function so that we can get access to the ADC10 and comparator
     *  instances.
     */
    create(ADC10.Instance adc10, Comparator.Instance comparator);
...
instance:
    ...
    *  MSP430G2x53 device, there are 3 x 8 = 24 pins total.
    */
