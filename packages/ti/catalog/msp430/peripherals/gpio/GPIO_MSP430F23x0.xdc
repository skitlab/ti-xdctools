...
/*!
 *  ======== GPIO for MSP430F23x0 ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430F23x0 inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of this peripheral. Use a customized
     *  init function so that we can get access to the Comparator_A
     *  and BCS+ instances.
     */
    create(Comparator.Instance comparator, BCSplus.Instance clock);
...
instance:
     ...
     *  MSP430F23x0 device, there are 4 x 8 = 32 pins total.
     */
    ...
    config DevicePin_t devicePins[4][8];
