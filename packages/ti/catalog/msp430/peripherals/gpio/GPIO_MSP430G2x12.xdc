...
/*!
 *  ======== GPIO for MSP430G2x12 ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430G2x12 inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of these peripherals.
     */
    create(USI.Instance usi, Comparator.Instance comparator);
...
instance:
    ...
    *  MSP430G2x12 device, there are 8 + 8 = 16 pins total.
    */
