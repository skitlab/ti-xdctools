...
/*!
 *  ======== GPIO for MSP430G2x52 ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430G2x52 inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of these peripherals.
     */
    create(USI.Instance usi, Comparator.Instance comparator, ADC10.Instance adc10);
...
instance:
    ...
    *  MSP430G2x52 device, there are 8 + 8 = 16 pins total.
    */
    ...
    config DevicePin_t devicePins[2][8];
    ...
    config GpioBits8PxSel2_t P1SEL2 = {
        Bit0        : BIT0_OFF,
        Bit1        : BIT1_OFF,
        Bit2        : BIT2_OFF,
        Bit3        : BIT3_OFF,
