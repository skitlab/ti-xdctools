...
/*!
 *  ======== GPIO for MSP430G2x32 ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430G2x32 inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of this peripheral.
     */
    create(USI.Instance usi, ADC10.Instance adc10);
...
instance:
    ...
    *  MSP430G2x32 device, there are 8 + 8 = 16 pins total.
    */
