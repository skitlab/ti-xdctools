...
/*!
 *  ======== GPIO for MSP430F24x1 ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430F24x1 inherits IGPIO {
    /*!
     *  ======== create ========
     *  Create an instance of this peripheral. Use a customized
     *  init function so that we can get access to the
     *  Comparator_A, SVS, and BCS+ instances.
     */
    create(Comparator.Instance comparator, SVS.Instance svs, BCSplus.Instance clock);
...
instance:
     ...
     *  MSP430F24x1 device, there are 6 x 8 = 48 pins total.
     */
    ...
    config DevicePin_t devicePins[6][8];

    /*! Implementation of Device Pin Functional Configuration */
    override config DevicePinFunctionSetting_t devicePinSetting[6][8];
