...
public class ti_catalog_msp430_peripherals_clock
{
    ...
    void CS$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.clock.CS.Object", new Proto.Str(po, true));
    ...
    void CS_A$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.clock.CS_A.Object", new Proto.Str(po, true));
    ...
    void UCS$$TYPES()
    {
        ...
        po.addFld("baseAddress", $$T_Str, "__MSP430_BASEADDRESS_UCS__", "wh");
        po.addFld("VLOCLKHz", Proto.Elm.newCNum("(xdc_Float)"), 12000L, "wh");
        po.addFld("WATCHCRYSTALCLKHz", Proto.Elm.newCNum("(xdc_Float)"), 32768L, "wh");
