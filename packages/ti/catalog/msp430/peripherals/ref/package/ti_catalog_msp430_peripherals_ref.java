...
public class ti_catalog_msp430_peripherals_ref
{
    ...
    void IREF$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.ref.IREF.Object", new Proto.Str(po, true));
    ...
    void REF$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.ref.REF.Object", new Proto.Str(po, true));
