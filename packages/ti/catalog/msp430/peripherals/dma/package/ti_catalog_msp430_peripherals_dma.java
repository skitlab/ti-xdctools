...
public class ti_catalog_msp430_peripherals_dma
{
    ...
    void IDMA$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.dma.IDMA.Object", new Proto.Str(po, true));
    ...
    void DMA$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.dma.DMA.Object", new Proto.Str(po, true));
