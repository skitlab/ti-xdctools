...
public class ti_catalog_msp430_peripherals_frctl
{
    ...
    void IFRCTL$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.frctl.IFRCTL.Object", new Proto.Str(po, true));
    ...
    void FRCTL$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.frctl.FRCTL.Object", new Proto.Str(po, true));
