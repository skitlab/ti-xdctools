...
public class ti_catalog_msp430_peripherals_memory
{
    ...
    void IFlash$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.memory.IFlash.Object", new Proto.Str(po, true));
    ...
    void Flash_2xx$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.msp430.peripherals.memory.Flash_2xx.Object", new Proto.Str(po, true));
