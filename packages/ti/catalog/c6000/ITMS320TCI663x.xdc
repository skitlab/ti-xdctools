...
metaonly interface ITMS320TCI663x inherits ti.catalog.ICpuDataSheet
{
    /* These are the available sizes for L1 caches */
    ...
    /* These are the available sizes for L2 cche */
    ...
    /* This is used by platform wizard for setting default cache sizes */
