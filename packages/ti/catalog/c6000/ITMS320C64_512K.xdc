...
/*!
 *  ======== ITMS320C64_512K ========
 *  An interface implemented by all TMS320C64xx devices with 512KB of internal
 *  memory.
 *
 *  This interface is defined to factor common data about this family into
 *  a single place; all TMS320C64xx devices with 512KB of internal
 *  memory extend this interface.
 */
metaonly interface ITMS320C64_512K inherits ti.catalog.ICpuDataSheet
{
