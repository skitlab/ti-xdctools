 ...
 *
 *  This interface is defined to factor common data about all TI813X
 *  type devices into a single place; they all have the same internal memory.
 */
...
/*
 *  @(#) ti.catalog.arm.cortexm3; 1, 0, 0,155; 8-17-2012 22:13:11; /db/ztree/library/trees/platform/platform-n27x/src/
 */
