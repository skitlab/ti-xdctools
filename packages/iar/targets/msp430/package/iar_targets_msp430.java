...
public class iar_targets_msp430
{
    ...
    void ITarget$$TYPES()
    {
        ...
        po.init("iar.targets.msp430.ITarget.Module", om.findStrict("xdc.bld.ITarget2.Module", "iar.targets.msp430"));
    ...
    void MSP430$$TYPES()
    {
        ...
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "iar.targets.msp430"), Global.newObject("endian", "little", "codeModel", "small", "dataModel", "small"), "rh");
        ...
        po.addFld("asm", (Proto)om.findStrict("iar.targets.msp430.MSP430.Command", "iar.targets.msp430"), Global.newObject("cmd", "a430", "opts", ""), "rh");
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "iar.targets.msp430")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-r --dlib_config $(rootDir)/lib/dlib/dl430fn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430fn.r43")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-Om --dlib_config $(rootDir)/lib/dlib/dl430fn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430fn.r43")}), Global.newArray(new Object[]{"debug_full", Global.newObject("compileOpts", Global.newObject("copts", "-r --dlib_config $(rootDir)/lib/dlib/dl430ff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430ff.r43")}), Global.newArray(new Object[]{"release_full", Global.newObject("compileOpts", Global.newObject("copts", "-Om --dlib_config $(rootDir)/lib/dlib/dl430ff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430ff.r43")})}), "wh");
    ...
    void MSP430X_large$$TYPES()
    {
        ...
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "iar.targets.msp430"), Global.newObject("endian", "little", "codeModel", "large", "dataModel", "large"), "rh");
        ...
        po.addFld("asm", (Proto)om.findStrict("iar.targets.msp430.MSP430X_large.Command", "iar.targets.msp430"), Global.newObject("cmd", "a430", "opts", "-v1 -D__LARGE_DATA_MODEL__"), "rh");
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "iar.targets.msp430")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-r --dlib_config $(rootDir)/lib/dlib/dl430xlfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlfn.r43")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-Om --dlib_config $(rootDir)/lib/dlib/dl430xlfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlfn.r43")}), Global.newArray(new Object[]{"debug_full", Global.newObject("compileOpts", Global.newObject("copts", "-r --dlib_config $(rootDir)/lib/dlib/dl430xlff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlff.r43")}), Global.newArray(new Object[]{"release_full", Global.newObject("compileOpts", Global.newObject("copts", "-Om --dlib_config $(rootDir)/lib/dlib/dl430xlff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlff.r43")})}), "wh");
    ...
    void MSP430X_small$$TYPES()
    {
        ...
        po.addFld("isa", $$T_Str, "430X", "rh");
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "iar.targets.msp430"), Global.newObject("endian", "little", "codeModel", "large", "dataModel", "small"), "rh");
        ...
        po.addFld("asm", (Proto)om.findStrict("iar.targets.msp430.MSP430X_small.Command", "iar.targets.msp430"), Global.newObject("cmd", "a430", "opts", "-v1 -D__SMALL_DATA_MODEL__"), "rh");
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "iar.targets.msp430")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-r --dlib_config $(rootDir)/lib/dlib/dl430xsfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsfn.r43")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-Om --dlib_config $(rootDir)/lib/dlib/dl430xsfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsfn.r43")}), Global.newArray(new Object[]{"debug_full", Global.newObject("compileOpts", Global.newObject("copts", "-r --dlib_config $(rootDir)/lib/dlib/dl430xsff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsff.r43")}), Global.newArray(new Object[]{"release_full", Global.newObject("compileOpts", Global.newObject("copts", "-Om --dlib_config $(rootDir)/lib/dlib/dl430xsff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsff.r43")})}), "wh");
