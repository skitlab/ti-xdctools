...
metaonly module MSP430 inherits ITarget
{
    ...
    override config xdc.bld.ITarget.OptionSet profiles[string] = [
        ["debug", {
            compileOpts: {
                copts: "-r --dlib_config $(rootDir)/lib/dlib/dl430fn.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430fn.r43",
        }],
        ["release", {
            compileOpts: {
                copts: "-Om --dlib_config $(rootDir)/lib/dlib/dl430fn.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430fn.r43",
        }],
        ["debug_full", {
            compileOpts: {
                copts: "-r --dlib_config $(rootDir)/lib/dlib/dl430ff.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430ff.r43",
        }],
        ["release_full", {
            compileOpts: {
                copts: "-Om --dlib_config $(rootDir)/lib/dlib/dl430ff.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430ff.r43",
        }],
    ];
