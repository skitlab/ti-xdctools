...
metaonly module MSP430X_small inherits ITarget
{
    ...
    override config xdc.bld.ITarget.OptionSet profiles[string] = [
        ["debug", {
            compileOpts: {
                copts: "-r --dlib_config $(rootDir)/lib/dlib/dl430xsfn.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xsfn.r43",
        }],
        ["release", {
            compileOpts: {
                copts: "-Om --dlib_config $(rootDir)/lib/dlib/dl430xsfn.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xsfn.r43",
        }],
        ["debug_full", {
            compileOpts: {
                copts: "-r --dlib_config $(rootDir)/lib/dlib/dl430xsff.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xsff.r43",
        }],
        ["release_full", {
            compileOpts: {
                copts: "-Om --dlib_config $(rootDir)/lib/dlib/dl430xsff.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xsff.r43",
        }],
    ];
