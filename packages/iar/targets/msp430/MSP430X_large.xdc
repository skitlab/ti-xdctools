...
metaonly module MSP430X_large inherits ITarget
{
    ...
    override config xdc.bld.ITarget.OptionSet profiles[string] = [
        ["debug", {
            compileOpts: {
                copts: "-r --dlib_config $(rootDir)/lib/dlib/dl430xlfn.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xlfn.r43",
        }],
        ["release", {
            compileOpts: {
                copts: "-Om --dlib_config $(rootDir)/lib/dlib/dl430xlfn.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xlfn.r43",
        }],
        ["debug_full", {
            compileOpts: {
                copts: "-r --dlib_config $(rootDir)/lib/dlib/dl430xlff.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xlff.r43",
        }],
        ["release_full", {
            compileOpts: {
                copts: "-Om --dlib_config $(rootDir)/lib/dlib/dl430xlff.h",
            },
            linkOpts: "$(rootDir)/lib/dlib/dl430xlff.r43",
        }],
